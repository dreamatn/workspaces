...
public class AIZBSU30 {
    ...
    AIRBSP30 AIRBSP30 = new AIRBSP30();
    SCCGWA SCCGWA;
    ...
    public void MP(SCCGWA SCCGWA, SCCRWBSP SCCRWBSP) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "AIZBSU30 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        AIRLSP30 = (PSRBSP01) SCCRWBSP.INFO.PTR;
        GWA_BP_AREA = (SCCGBPA_BP_AREA) SCCGWA.BP_AREA_PTR;
        GWA_SC_AREA = (SCCGSCA_SC_AREA) SCCGWA.SC_AREA_PTR;
        IBS.init(SCCGWA, AIRBSP30);
        IBS.CLONE(SCCGWA, AIRLSP30, AIRBSP30);
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        IBS.CLONE(SCCGWA, AIRBSP30, AIRLSP30);
    }
    ...
    public void T000_READ_BSP() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, AIRBSP30.KEY);
        CEP.TRC(SCCGWA, AIRBSP30.KEY.AP_TYPE);
        CEP.TRC(SCCGWA, AIRBSP30.KEY.AP_BATNO);
        CEP.TRC(SCCGWA, AIRBSP30.KEY.BAT_NO);
        CEP.TRC(SCCGWA, AIRBSP30.STATUS);
        CEP.TRC(SCCGWA, AIRBSP30.RT_CODE);
        AITBSP30_RD = new DBParm();
        AITBSP30_RD.TableName = "AITBSP30";
        IBS.READ(SCCGWA, AIRBSP30, AITBSP30_RD);
        CEP.TRC(SCCGWA, "AFTER READ BSP30");
    ...
    public void T000_WRITE_BSP() throws IOException,SQLException,Exception {
        ...
        AITBSP30_RD = new DBParm();
        AITBSP30_RD.TableName = "AITBSP30";
        AITBSP30_RD.errhdl = true;
        IBS.WRITE(SCCGWA, AIRBSP30, AITBSP30_RD);
        CEP.TRC(SCCGWA, "AFTER WRITE BSP30");
        CEP.TRC(SCCGWA, AIRBSP30.STATUS);
        CEP.TRC(SCCGWA, AIRBSP30.RT_CODE);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRWBSP.RETURN_INFO = 'F';
    ...
    public void T000_READ_BSP_UPD() throws IOException,SQLException,Exception {
        ...
        AITBSP30_RD = new DBParm();
        AITBSP30_RD.TableName = "AITBSP30";
        AITBSP30_RD.upd = true;
        IBS.READ(SCCGWA, AIRBSP30, AITBSP30_RD);
        CEP.TRC(SCCGWA, "AFTER READ BSP30 UPDATE");
        CEP.TRC(SCCGWA, AIRBSP30.STATUS);
        CEP.TRC(SCCGWA, AIRBSP30.RT_CODE);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRWBSP.RETURN_INFO = 'F';
    ...
    public void T000_REWRITE_BSP() throws IOException,SQLException,Exception {
        ...
        AITBSP30_RD = new DBParm();
        AITBSP30_RD.TableName = "AITBSP30";
        IBS.REWRITE(SCCGWA, AIRBSP30, AITBSP30_RD);
        CEP.TRC(SCCGWA, "AFTER REWRITE BSP30");
        CEP.TRC(SCCGWA, AIRBSP30.STATUS);
        CEP.TRC(SCCGWA, AIRBSP30.RT_CODE);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRWBSP.RETURN_INFO = 'F';
    ...
    public void T000_DELETE_BSP() throws IOException,SQLException,Exception {
        ...
        AITBSP30_RD = new DBParm();
        AITBSP30_RD.TableName = "AITBSP30";
        IBS.DELETE(SCCGWA, AIRBSP30, AITBSP30_RD);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRWBSP.RETURN_INFO = 'F';
        } else if (SCCGWA.COMM_AREA.DBIO_FLG == '1') {
            SCCRWBSP.RETURN_INFO = 'N';
