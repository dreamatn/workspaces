...
public class AIOT8541 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROCESS();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "AIOT8541 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    ...
    public void S000_CALL_AIZSXBAL() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, "BB55");
        IBS.CALLCPN(SCCGWA, "AI-SVR-AIZSXBAL", AICSXBAL);
