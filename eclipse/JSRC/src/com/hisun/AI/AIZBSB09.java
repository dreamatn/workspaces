...
public class AIZBSB09 {
    brParm AITBSP09_BR = new brParm();
    DBParm AITBSP09_RD;
    ...
    AIRBSP09 AIRBSP09 = new AIRBSP09();
    SCCGWA SCCGWA;
    ...
    public void MP(SCCGWA SCCGWA, SCCRBBSP SCCRBBSP) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "AIZBSB09 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        AIRLSP09 = (PSRBSP01) SCCRBBSP.INFO.PTR;
        GWA_BP_AREA = (SCCGBPA_BP_AREA) SCCGWA.BP_AREA_PTR;
        GWA_SC_AREA = (SCCGSCA_SC_AREA) SCCGWA.SC_AREA_PTR;
        IBS.init(SCCGWA, AIRBSP09);
        IBS.CLONE(SCCGWA, AIRLSP09, AIRBSP09);
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        IBS.CLONE(SCCGWA, AIRBSP09, AIRLSP09);
    }
    public void T000_STARTBR_BSP() throws IOException,SQLException,Exception {
        AITBSP09_BR.rp = new DBParm();
        AITBSP09_BR.rp.TableName = "AITBSP09";
        AITBSP09_BR.rp.upd = true;
        IBS.STARTBR(SCCGWA, AIRBSP09, AITBSP09_BR);
    ...
    public void T000_READNEXT_BSP() throws IOException,SQLException,Exception {
        IBS.READNEXT(SCCGWA, AIRBSP09, this, AITBSP09_BR);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRBBSP.RETURN_INFO = 'F';
        } else if (SCCGWA.COMM_AREA.DBIO_FLG == '1') {
            SCCRBBSP.RETURN_INFO = 'N';
    ...
    public void T000_ENDBR_BSP() throws IOException,SQLException,Exception {
        IBS.ENDBR(SCCGWA, AITBSP09_BR);
    }
    public void T000_REWRITE_BSP() throws IOException,SQLException,Exception {
        AITBSP09_RD = new DBParm();
        AITBSP09_RD.TableName = "AITBSP09";
        IBS.REWRITE(SCCGWA, AIRBSP09, AITBSP09_RD);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRBBSP.RETURN_INFO = 'F';
        } else {
            IBS.CPY2CLS(SCCGWA, AICMSG_ERROR_MSG.AI_SYS_ERR, SCCRBBSP.RC);
