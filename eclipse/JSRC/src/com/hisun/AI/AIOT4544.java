...
public class AIOT4544 {
    String CPN_S_RPNG_MAINT = "AI-R-RPNG-MAINT ";
    String WS_ERR_MSG = " ";
    short WS_FLD_NO = 0;
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "AIOT4544 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        B020_INQ_RPTD_REC_PROC();
    }
    public void B020_INQ_RPTD_REC_PROC() throws IOException,SQLException,Exception {
