...
public class AIOIP05 {
    ...
    short WS_IDX = 0;
    short WS_FLD_NO = 0;
    AIOIP05_WS_T_CTL WS_T_CTL = new AIOIP05_WS_T_CTL();
    AIOIP05_WS_ITM_46_NO WS_ITM_46_NO = new AIOIP05_WS_ITM_46_NO();
    AIOIP05_WS_ITM_64_NO WS_ITM_64_NO = new AIOIP05_WS_ITM_64_NO();
    AIOIP05_WS_ITM_424_NO WS_ITM_424_NO = new AIOIP05_WS_ITM_424_NO();
    char WS_ITM_FST_NO = ' ';
    char WS_REC_FLG = ' ';
    char WS_END_FLG = ' ';
    ...
    public void B00_CHECK_PROC() throws IOException,SQLException,Exception {
        ...
        } else if (AIB0005_AWA_0005.COA_NO.trim().length() == 0 
