...
public class AIOT4543 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "AIOT4543 return!");
        Z_RET();
    }
    ...
    public void B020_DEL_REC_PROC() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, AICSRPNG.I_FUNC);
        CEP.TRC(SCCGWA, AIB4530_AWA_4530.RPT_ID);
        CEP.TRC(SCCGWA, AIB4530_AWA_4530.GL_ITEM);
        for (WS_CNT = 1; WS_CNT <= 60; WS_CNT += 1) {
            CEP.TRC(SCCGWA, AIB4530_AWA_4530.TIMS[WS_CNT-1].STR1);
            ...
            CEP.TRC(SCCGWA, AIB4530_AWA_4530.TIMS[WS_CNT-1].STR1.substring(11 - 1, 11 + 20 - 1));
            AICSRPNG.INFO.CNT[WS_CNT-1].SEQ_NO = WS_CNT;
            CEP.TRC(SCCGWA, AICSRPNG.INFO.CNT[WS_CNT-1].SEQ_NO);
            CEP.TRC(SCCGWA, AIB4530_AWA_4530.TIMS[WS_CNT-1].STR1);
            if (AIB4530_AWA_4530.TIMS[WS_CNT-1].STR1 == null) AIB4530_AWA_4530.TIMS[WS_CNT-1].STR1 = "";
            JIBS_tmp_int = AIB4530_AWA_4530.TIMS[WS_CNT-1].STR1.length();
            for (int i=0;i<34-JIBS_tmp_int;i++) AIB4530_AWA_4530.TIMS[WS_CNT-1].STR1 += " ";
            CEP.TRC(SCCGWA, AIB4530_AWA_4530.TIMS[WS_CNT-1].STR1.substring(0, 10));
            if (AIB4530_AWA_4530.TIMS[WS_CNT-1].STR1 == null) AIB4530_AWA_4530.TIMS[WS_CNT-1].STR1 = "";
            JIBS_tmp_int = AIB4530_AWA_4530.TIMS[WS_CNT-1].STR1.length();
            for (int i=0;i<34-JIBS_tmp_int;i++) AIB4530_AWA_4530.TIMS[WS_CNT-1].STR1 += " ";
