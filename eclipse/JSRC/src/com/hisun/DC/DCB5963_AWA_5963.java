...
public class DCB5963_AWA_5963 {
    ...
    public DCB5963_PERM_INF[] PERM_INF = new DCB5963_PERM_INF[5];
    public char TRIG_TMS = ' ';
    public short TRIG_TMS_NO = 0;
    public DCB5963_TRIG_INF[] TRIG_INF = new DCB5963_TRIG_INF[5];
    public DCB5963_INT_INFO[] INT_INFO = new DCB5963_INT_INFO[5];
    ...
    public DCB5963_DD_INFO[] DD_INFO = new DCB5963_DD_INFO[10];
    public DCB5963_TD_INFO[] TD_INFO = new DCB5963_TD_INFO[10];
    public DCB5963_AWA_5963() {
        for (int i=0;i<5;i++) PERM_INF[i] = new DCB5963_PERM_INF();
        for (int i=0;i<5;i++) TRIG_INF[i] = new DCB5963_TRIG_INF();
        for (int i=0;i<5;i++) INT_INFO[i] = new DCB5963_INT_INFO();
        for (int i=0;i<10;i++) DD_INFO[i] = new DCB5963_DD_INFO();
        for (int i=0;i<10;i++) TD_INFO[i] = new DCB5963_TD_INFO();
    }
}
