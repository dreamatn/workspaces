...
public class DCCUMATP_IO_AREA {
    ...
    public DCCUMATP_LNK_INFO[] LNK_INFO = new DCCUMATP_LNK_INFO[5];
    public DCCUMATP_IO_AREA() {
        for (int i=0;i<5;i++) LNK_INFO[i] = new DCCUMATP_LNK_INFO();
    }
}
