...
public class DCB5412_AWA_5412 {
    ...
    public DCB5412_LNK_INFO[] LNK_INFO = new DCB5412_LNK_INFO[5];
    public DCB5412_AWA_5412() {
        for (int i=0;i<5;i++) LNK_INFO[i] = new DCB5412_LNK_INFO();
    }
}
