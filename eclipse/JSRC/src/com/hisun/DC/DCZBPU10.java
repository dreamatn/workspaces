...
public class DCZBPU10 {
    ...
    DCRBSP10 DCRBSP10 = new DCRBSP10();
    SCCGWA SCCGWA;
    ...
    public void MP(SCCGWA SCCGWA, SCCRWBSP SCCRWBSP) throws IOException,SQLException,Exception {
        ...
        B00_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "DCZBPU10 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    public void A00_INIT_PROC() throws IOException,SQLException,Exception {
        DCRBSPX = (PSRBSP01) SCCRWBSP.INFO.PTR;
        GWA_BP_AREA = (SCCGBPA_BP_AREA) SCCGWA.BP_AREA_PTR;
        GWA_SC_AREA = (SCCGSCA_SC_AREA) SCCGWA.SC_AREA_PTR;
        IBS.init(SCCGWA, DCRBSP10);
        JIBS_tmp_str[0] = IBS.CLS2CPY(SCCGWA, DCRBSPX);
        JIBS_tmp_str[1] = JIBS_tmp_str[0];
        IBS.CLONE(SCCGWA, DCRBSPX, DCRBSP10);
    ...
    public void B00_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        JIBS_tmp_str[0] = IBS.CLS2CPY(SCCGWA, DCRBSP10);
        JIBS_tmp_str[1] = JIBS_tmp_str[0];
        IBS.CLONE(SCCGWA, DCRBSP10, DCRBSPX);
        JIBS_tmp_str[0] = IBS.CLS2CPY(SCCGWA, DCRBSP10);
    ...
    public void T000_READ_BSP() throws IOException,SQLException,Exception {
        DCTBSP10_RD = new DBParm();
        DCTBSP10_RD.TableName = "DCTBSP10";
        IBS.READ(SCCGWA, DCRBSP10, DCTBSP10_RD);
    ...
    public void T000_WRITE_BSP() throws IOException,SQLException,Exception {
        DCTBSP10_RD = new DBParm();
        DCTBSP10_RD.TableName = "DCTBSP10";
        DCTBSP10_RD.errhdl = true;
        IBS.WRITE(SCCGWA, DCRBSP10, DCTBSP10_RD);
        CEP.TRC(SCCGWA, SCCGWA.COMM_AREA.DBIO_FLG);
        CEP.TRC(SCCGWA, DCRBSP10.BLOB_TR_DATA);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRWBSP.RETURN_INFO = 'F';
    ...
    public void T000_READ_BSP_UPD() throws IOException,SQLException,Exception {
        DCTBSP10_RD = new DBParm();
        DCTBSP10_RD.TableName = "DCTBSP10";
        DCTBSP10_RD.col = "STATUS ,RT_CODE ,OUT_JRN ,OUT_VCH_NO , OUT_DATA";
        DCTBSP10_RD.upd = true;
        IBS.READ(SCCGWA, DCRBSP10, DCTBSP10_RD);
        CEP.TRC(SCCGWA, SCCGWA.COMM_AREA.DBIO_FLG);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRWBSP.RETURN_INFO = 'F';
    ...
    public void T000_REWRITE_BSP() throws IOException,SQLException,Exception {
        DCTBSP10_RD = new DBParm();
        DCTBSP10_RD.TableName = "DCTBSP10";
        IBS.REWRITE(SCCGWA, DCRBSP10, DCTBSP10_RD);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRWBSP.RETURN_INFO = 'F';
        } else {
        }
    ...
    public void T000_DELETE_BSP() throws IOException,SQLException,Exception {
        DCTBSP10_RD = new DBParm();
        DCTBSP10_RD.TableName = "DCTBSP10";
        IBS.DELETE(SCCGWA, DCRBSP10, DCTBSP10_RD);
        CEP.TRC(SCCGWA, SCCGWA.COMM_AREA.DBIO_FLG);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRWBSP.RETURN_INFO = 'F';
        } else if (SCCGWA.COMM_AREA.DBIO_FLG == '1') {
