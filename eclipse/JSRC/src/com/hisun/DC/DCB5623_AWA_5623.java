...
public class DCB5623_AWA_5623 {
    ...
    public DCB5623_LNK_INFO[] LNK_INFO = new DCB5623_LNK_INFO[5];
    public String SMR = " ";
    public short SMR_NO = 0;
    public DCB5623_AWA_5623() {
        for (int i=0;i<5;i++) LNK_INFO[i] = new DCB5623_LNK_INFO();
    }
}
