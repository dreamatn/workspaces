...
public class DDOT2200 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROCESS();
        B000_MAIN_PROCESS();
        CEP.TRC(SCCGWA, "DDOT2200 return!");
        Z_RET();
    }
    ...
    public void B100_CHECK_INPUT_DATA() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, DDB2200_AWA_2200.VS_SPFLG);
        ...
        if (DDB2200_AWA_2200.VS_SPFLG != ' ') {
            if ((DDB2200_AWA_2200.VS_SPFLG != '1') 
                && (DDB2200_AWA_2200.VS_SPFLG != '2')) {
