...
public class DDB5124_AWA_5124 {
    ...
    public DDB5124_TIR_INF[] TIR_INF = new DDB5124_TIR_INF[5];
    public DDB5124_AWA_5124() {
        for (int i=0;i<5;i++) TIR_INF[i] = new DDB5124_TIR_INF();
    }
}
