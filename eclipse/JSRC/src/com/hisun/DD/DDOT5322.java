...
public class DDOT5322 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROCESS();
        B000_MAIN_PROCESS();
        CEP.TRC(SCCGWA, "DDOT5322 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT_DATA() throws IOException,SQLException,Exception {
        ...
        if (DDB5320_AWA_5320.ADD_DATE == 0) {
            ...
            WS_FLD_NO = (short) DDB5320_AWA_5320.ADD_DATE;
            S000_ERR_MSG_PROC_CONTINUE();
        }
        if (DDB5320_AWA_5320.ORI_DATE == 0) {
            WS_ERR_MSG = DDCMSG_ERROR_MSG.DD_EFF_DT_M_INPUT;
            WS_FLD_NO = (short) DDB5320_AWA_5320.ORI_DATE;
            S000_ERR_MSG_PROC_CONTINUE();
        }
        if (DDB5320_AWA_5320.END_DATE == 0) {
            WS_ERR_MSG = DDCMSG_ERROR_MSG.DD_EXP_DT_M_INPUT;
            WS_FLD_NO = (short) DDB5320_AWA_5320.ORI_DATE;
            S000_ERR_MSG_PROC_CONTINUE();
        }
