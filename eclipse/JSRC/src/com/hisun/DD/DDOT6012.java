...
public class DDOT6012 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROCESS();
        B000_MAIN_PROCESS();
        CEP.TRC(SCCGWA, "DDOT6012 return!");
        Z_RET();
    }
    ...
    public void B030_TRANS_DATA_PROC() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, DDB6010_AWA_6010.OVR_NO);
        ...
        DDCSCVTR.OVR_NO = DDB6010_AWA_6010.OVR_NO;
        ...
        CEP.TRC(SCCGWA, DDCSCVTR.OVR_NO);
        S000_CALL_DDZSCVTR();
    }
