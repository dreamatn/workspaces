...
public class DDB5470_AWA_5470 {
    ...
    public DDB5470_TIER_IR[] TIER_IR = new DDB5470_TIER_IR[5];
    public DDB5470_AWA_5470() {
        for (int i=0;i<5;i++) TIER_IR[i] = new DDB5470_TIER_IR();
    }
}
