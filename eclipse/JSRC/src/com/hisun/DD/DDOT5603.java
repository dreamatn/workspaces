...
public class DDOT5603 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "DDOT5603 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT_DATA() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, DDB5603_AWA_5603.TYPE);
        CEP.TRC(SCCGWA, DDB5603_AWA_5603.REF_NO);
        if (DDB5603_AWA_5603.REF_NO.trim().length() == 0) {
