...
public class DDZSFLDR {
    ...
    char WS_HLDR_FLG = ' ';
    String WS_CARD_NO = " ";
    DDZSFLDR_WS_OUTPUT_HIS_HLD WS_OUTPUT_HIS_HLD = new DDZSFLDR_WS_OUTPUT_HIS_HLD();
    ...
    public void MP(SCCGWA SCCGWA, DCCSHLDR DCCSHLDR) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "DDZSFLDR return!");
        Z_RET();
        if (pgmRtn) return;
        JIBS_RETURN();
    }
    ...
    public void B070_OUTPUT_HIS_HLD_PROC() throws IOException,SQLException,Exception {
        ...
        WS_OUTPUT_HIS_HLD.WS_AC_DATE = DDRHLDR.UPDTBL_DATE;
