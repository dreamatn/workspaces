...
public class DDB1520_AWA_1520 {
    ...
    public DDB1520_AC_LIST[] AC_LIST = new DDB1520_AC_LIST[6];
    public int BV_CNT = 0;
    public short BV_CNT_NO = 0;
    public DDB1520_BV_LIST[] BV_LIST = new DDB1520_BV_LIST[20];
    public DDB1520_AWA_1520() {
        for (int i=0;i<6;i++) AC_LIST[i] = new DDB1520_AC_LIST();
        for (int i=0;i<20;i++) BV_LIST[i] = new DDB1520_BV_LIST();
    }
}
