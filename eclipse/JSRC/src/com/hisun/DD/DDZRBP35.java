...
public class DDZRBP35 {
    ...
    DDRBSP35 DDRBSP35 = new DDRBSP35();
    SCCGWA SCCGWA;
    SCCRWBSP SCCRWBSP;
    DDRBSP35 DDRBSP1;
    public void MP(SCCGWA SCCGWA, SCCRWBSP SCCRWBSP) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "DDZRBP35 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        ...
        IBS.CLONE(SCCGWA, DDRBSP1, DDRBSP35);
        CEP.TRC(SCCGWA, "DD");
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, DDRBSP35.KEY.AP_TYPE);
        CEP.TRC(SCCGWA, DDRBSP35.KEY.AP_BATNO);
        CEP.TRC(SCCGWA, DDRBSP35.KEY.BAT_NO);
        ...
        JIBS_tmp_str[0] = IBS.CLS2CPY(SCCGWA, DDRBSP35);
        JIBS_tmp_str[1] = JIBS_tmp_str[0];
        IBS.CLONE(SCCGWA, DDRBSP35, DDRBSP1);
    }
    ...
    public void T000_READ_BSP() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, DDRBSP35.KEY.AP_BATNO);
        CEP.TRC(SCCGWA, DDRBSP35.KEY.BAT_NO);
        DDTBSP35_RD = new DBParm();
        DDTBSP35_RD.TableName = "DDTBSP35";
        IBS.READ(SCCGWA, DDRBSP35, DDTBSP35_RD);
    ...
    public void T000_WRITE_BSP() throws IOException,SQLException,Exception {
        DDTBSP35_RD = new DBParm();
        DDTBSP35_RD.TableName = "DDTBSP35";
        IBS.WRITE(SCCGWA, DDRBSP35, DDTBSP35_RD);
    }
    public void T000_READ_BSP_UPD() throws IOException,SQLException,Exception {
        DDTBSP35_RD = new DBParm();
        DDTBSP35_RD.TableName = "DDTBSP35";
        DDTBSP35_RD.col = "STATUS ,RT_CODE ,OUT_JRN ,OUT_VCH_NO";
        DDTBSP35_RD.upd = true;
        IBS.READ(SCCGWA, DDRBSP35, DDTBSP35_RD);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '1') {
            IBS.CPY2CLS(SCCGWA, DDCMSG_ERROR_MSG.DD_BSP_REC_NOTFND, SCCRWBSP.RC);
            SCCRWBSP.RETURN_INFO = 'N';
    ...
    public void T000_REWRITE_BSP() throws IOException,SQLException,Exception {
        DDTBSP35_RD = new DBParm();
        DDTBSP35_RD.TableName = "DDTBSP35";
        IBS.REWRITE(SCCGWA, DDRBSP35, DDTBSP35_RD);
    }
    public void T000_DELETE_BSP() throws IOException,SQLException,Exception {
        DDTBSP35_RD = new DBParm();
        DDTBSP35_RD.TableName = "DDTBSP35";
        IBS.DELETE(SCCGWA, DDRBSP35, DDTBSP35_RD);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '1') {
            IBS.CPY2CLS(SCCGWA, DDCMSG_ERROR_MSG.DD_BSP_REC_NOTFND, SCCRWBSP.RC);
            SCCRWBSP.RETURN_INFO = 'N';
            Z_RET();
