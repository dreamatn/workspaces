...
public class VTOT2010 {
    String WS_ERR_MSG = " ";
    short WS_FLD_NO = 0;
    int WS_CNT = 0;
    VTOT2010_WS_OUT_DATA WS_OUT_DATA = new VTOT2010_WS_OUT_DATA();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "VTOT2010 return!");
        Z_RET();
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        GWA_BP_AREA = (SCCGBPA_BP_AREA) SCCGWA.BP_AREA_PTR;
        GWA_SC_AREA = (SCCGSCA_SC_AREA) SCCGWA.SC_AREA_PTR;
        VTCI2010 = new VTCI2010();
        IBS.init(SCCGWA, VTCI2010);
        IBS.CPY2CLS(SCCGWA, GWA_SC_AREA.INP_OUTP_AREA.INP_AREA_PTR, VTCI2010);
    }
    ...
    public void B020_BROWSE_REC_PROC() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, VTCI2010.JM_CODE);
        IBS.init(SCCGWA, VTRJMCD);
        IBS.init(SCCGWA, VTCSJMCD);
        VTCSJMCD.CODE = VTCI2010.JM_CODE;
        VTCSJMCD.FUNC = 'B';
        S000_CALL_VTZSJMCD();
    }
