...
public class VTOT2051 {
    String WS_ERR_MSG = " ";
    short WS_FLD_NO = 0;
    int WS_CNT = 0;
    VTOT2051_WS_OUT_DATA WS_OUT_DATA = new VTOT2051_WS_OUT_DATA();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "VTOT2051 return!");
        Z_RET();
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        GWA_BP_AREA = (SCCGBPA_BP_AREA) SCCGWA.BP_AREA_PTR;
        GWA_SC_AREA = (SCCGSCA_SC_AREA) SCCGWA.SC_AREA_PTR;
        VTCI2051 = new VTCI2051();
        IBS.init(SCCGWA, VTCI2051);
        IBS.CPY2CLS(SCCGWA, GWA_SC_AREA.INP_OUTP_AREA.INP_AREA_PTR, VTCI2051);
    }
    ...
    public void B020_BROW_REC_PROC() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, VTCI2051.AGR_NO);
        CEP.TRC(SCCGWA, VTCI2051.AC_NO);
        IBS.init(SCCGWA, VTCSJMAC);
        VTCSJMAC.FUNC = 'Q';
        VTCSJMAC.AC_NO = VTCI2051.AC_NO;
        S000_CALL_VTZSJMAC();
    }
