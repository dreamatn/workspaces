...
public class VTOT2014 {
    String WS_ERR_MSG = " ";
    short WS_FLD_NO = 0;
    int WS_CNT = 0;
    VTOT2014_WS_OUT_DATA WS_OUT_DATA = new VTOT2014_WS_OUT_DATA();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "VTOT2014 return!");
        Z_RET();
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        GWA_BP_AREA = (SCCGBPA_BP_AREA) SCCGWA.BP_AREA_PTR;
        GWA_SC_AREA = (SCCGSCA_SC_AREA) SCCGWA.SC_AREA_PTR;
        VTCI2014 = new VTCI2014();
        IBS.init(SCCGWA, VTCI2014);
        IBS.CPY2CLS(SCCGWA, GWA_SC_AREA.INP_OUTP_AREA.INP_AREA_PTR, VTCI2014);
    }
    ...
    public void B020_ADD_REC_PROC() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, VTCI2014.JM_CODE);
        IBS.init(SCCGWA, VTRJMCD);
        IBS.init(SCCGWA, VTCSJMCD);
        VTCSJMCD.CODE = VTCI2014.JM_CODE;
        VTCSJMCD.FUNC = 'Q';
        S000_CALL_VTZSJMCD();
    }
