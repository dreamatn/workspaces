...
public class PSB8100_AWA_8100 {
    public int EXG_B_DT = 0;
    public short EXG_B_DT_NO = 0;
    public int EXG_E_DT = 0;
    public short EXG_E_DT_NO = 0;
    ...
    public String OUR_NO = " ";
    public short OUR_NO_NO = 0;
    public String CERT_NO = " ";
    public short CERT_NO_NO = 0;
    public String OTH_NO = " ";
    public short OTH_NO_NO = 0;
