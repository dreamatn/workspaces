...
public class BAOT2170 {
    String K_OUTPUT_FMT = "BAZ01";
    BAOT2170_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new BAOT2170_WS_TEMP_VARIABLE();
    BAOT2170_WS_OUT_DATA WS_OUT_DATA = new BAOT2170_WS_OUT_DATA();
    ...
    BACUAI01 BACUAI01 = new BACUAI01();
    SCCGWA SCCGWA;
    ...
    public void MP(SCCGWA SCCGWA, BAB2170_AWA_2170 BAB2170_AWA_2170) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROCESS();
        B000_MAIN_PROCESS();
        CEP.TRC(SCCGWA, "BAOT2170 return!");
        Z_RET();
    }
    ...
    public void B100_MAIN_PROCESS() throws IOException,SQLException,Exception {
        ...
        if (BAB2170_AWA_2170.FUN_CD == 'G') {
            ...
            BACUAI01.DATA.BILL_NO = BAB2170_AWA_2170.BILL_NO;
            BACUAI01.DATA.FUN_CD = BAB2170_AWA_2170.FUN_CD;
            S000_CALL_BAZUAI01();
        } else {
        }
    }
    ...
    public void B210_TRANS_DATA_TO_OUT_FMT() throws IOException,SQLException,Exception {
        ...
        if (BAB2170_AWA_2170.FUN_CD == 'G') {
            WS_OUT_DATA.WS_OUT_REA_AMT = BACUGD01.DATA.TRXAMT;
        } else if (BAB2170_AWA_2170.FUN_CD == 'D') {
            WS_OUT_DATA.WS_OUT_REA_AMT = BACUDD01.DATA.TRXAMT;
        } else if (BAB2170_AWA_2170.FUN_CD == 'A') {
            WS_OUT_DATA.WS_OUT_REA_AMT = BACUAI01.DATA.TRXAMT;
        } else {
        }
    }
    ...
    public void S000_CALL_BAZUAI01() throws IOException,SQLException,Exception {
        IBS.CALLCPN(SCCGWA, "BA-U-BAMT-AI01", BACUAI01);
        if (BACUAI01.RC.RC_CODE != 0) {
            WS_TEMP_VARIABLE.WS_ERR_MSG = IBS.CLS2CPY(SCCGWA, BACUAI01.RC);
            S000_ERR_MSG_PROC();
        }
    }
