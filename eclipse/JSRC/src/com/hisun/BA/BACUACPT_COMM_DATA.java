...
public class BACUACPT_COMM_DATA {
    ...
    public int PRT_BR = 0;
    public String GB_FEE_TYP = " ";
    public double GB_FEE_AMT = 0;
    public String GB_SXF_RMK = " ";
    ...
    public BACUACPT_FEE_ARRAY[] FEE_ARRAY = new BACUACPT_FEE_ARRAY[5];
    ...
    public String ENCR = " ";
    public BACUACPT_COMM_DATA() {
        for (int i=0;i<5;i++) FEE_ARRAY[i] = new BACUACPT_FEE_ARRAY();
    }
}
