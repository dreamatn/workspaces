...
public class LNOT7222 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROCESS();
        B000_MAIN_PROCESS();
        CEP.TRC(SCCGWA, "LNOT7222 return!");
        Z_RET();
    }
    public void A000_INIT_PROCESS() throws IOException,SQLException,Exception {
        ...
        WS_FUNC_FLG = LNB7220_AWA_7220.FUNC;
    }
    ...
    public void B100_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        LNCCLOAN.COMM_DATA.CHECK_TYP = K_INQUIRY;
    ...
    public void B200_SET_NXT_TXN() throws IOException,SQLException,Exception {
        if (WS_FUNC_FLG == 'A') {
            ...
            SCCSUBS.AP_CODE = 13;
            SCCSUBS.TR_CODE = 7225;
            S000_SET_SUBS_TRN();
        } else if (WS_FUNC_FLG == 'U') {
            IBS.init(SCCGWA, SCCSUBS);
            SCCSUBS.AP_CODE = 13;
            SCCSUBS.TR_CODE = 7223;
            S000_SET_SUBS_TRN();
        } else if (WS_FUNC_FLG == 'Q') {
            IBS.init(SCCGWA, SCCSUBS);
            SCCSUBS.AP_CODE = 13;
            SCCSUBS.TR_CODE = 7226;
            S000_SET_SUBS_TRN();
        } else if (WS_FUNC_FLG == 'D') {
            IBS.init(SCCGWA, SCCSUBS);
            SCCSUBS.AP_CODE = 13;
            SCCSUBS.TR_CODE = 7224;
            S000_SET_SUBS_TRN();
        } else {
            IBS.CPY2CLS(SCCGWA, LNCMSG_ERROR_MSG.LN_ERR_MUST_INPUT, WS_ERR_MSG);
            WS_FLD_NO = LNB7220_AWA_7220.FUNC_NO;
            S000_ERR_MSG_PROC();
        }
    }
    public void S000_SET_SUBS_TRN() throws IOException,SQLException,Exception {
        ...
        SCCCALL.ERR_FLDNO = LNB7220_AWA_7220.FUNC_NO;
