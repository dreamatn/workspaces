...
public class LNCO2100 {
    ...
    public LNCO2100_PHS_INF[] PHS_INF = new LNCO2100_PHS_INF[5];
    ...
    public LNCO2100_FEE_INF[] FEE_INF = new LNCO2100_FEE_INF[5];
    ...
    public char SYN_TYP = ' ';
    public LNCO2100_PART_INF[] PART_INF = new LNCO2100_PART_INF[10];
    public LNCO2100() {
        for (int i=0;i<5;i++) PHS_INF[i] = new LNCO2100_PHS_INF();
        for (int i=0;i<5;i++) FEE_INF[i] = new LNCO2100_FEE_INF();
        for (int i=0;i<10;i++) PART_INF[i] = new LNCO2100_PART_INF();
    }
}
