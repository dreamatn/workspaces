...
public class LNB2000_AWA_2000 {
    ...
    public char W_I_FLG = ' ';
    public short W_I_FLG_NO = 0;
    public char W_I_PERU = ' ';
    public short W_I_PERU_NO = 0;
    public short W_I_PERD = 0;
    public short W_I_PERD_NO = 0;
    ...
    public LNB2000_PHS_INF[] PHS_INF = new LNB2000_PHS_INF[5];
    ...
    public LNB2000_FEE_INF[] FEE_INF = new LNB2000_FEE_INF[5];
    ...
    public LNB2000_AWA_2000() {
        for (int i=0;i<5;i++) PHS_INF[i] = new LNB2000_PHS_INF();
        for (int i=0;i<5;i++) FEE_INF[i] = new LNB2000_FEE_INF();
    }
}
