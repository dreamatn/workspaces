...
public class LNCSRPO_COMM_DATA {
    ...
    public LNCSRPO_ACAMT[] ACAMT = new LNCSRPO_ACAMT[5];
    public LNCSRPO_PART_DATA[] PART_DATA = new LNCSRPO_PART_DATA[10];
    public String CCY_TYPE = " ";
    public LNCSRPO_COMM_DATA() {
        for (int i=0;i<5;i++) ACAMT[i] = new LNCSRPO_ACAMT();
        for (int i=0;i<10;i++) PART_DATA[i] = new LNCSRPO_PART_DATA();
    }
}
