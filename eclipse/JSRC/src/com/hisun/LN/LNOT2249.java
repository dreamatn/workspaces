...
public class LNOT2249 {
    String JIBS_tmp_str[] = new String[10];
    LNOT2249_WS_ERR_MSG WS_ERR_MSG = new LNOT2249_WS_ERR_MSG();
    short WS_FLD_NO = 0;
    LNOT2249_WS_OUT_PUT WS_OUT_PUT = new LNOT2249_WS_OUT_PUT();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "LNOT2249 return!");
        Z_RET();
    }
