...
public class LNCI2000 {
    ...
    public LNCI2000_PHS_INF[] PHS_INF = new LNCI2000_PHS_INF[5];
    ...
    public LNCI2000_FEE_INF[] FEE_INF = new LNCI2000_FEE_INF[5];
    ...
    public LNCI2000() {
        for (int i=0;i<5;i++) PHS_INF[i] = new LNCI2000_PHS_INF();
        for (int i=0;i<5;i++) FEE_INF[i] = new LNCI2000_FEE_INF();
    }
}
