...
public class LNOT6110 {
    int JIBS_tmp_int;
    String JIBS_tmp_str[] = new String[10];
    DBParm LNTCONT_RD;
    DBParm LNTBALZ_RD;
    boolean pgmRtn = false;
    String K_HIS_RMKS = "CANCEL NON-ACCRUAL STATUS";
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "LNOT6110 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, LNCICTLM.REC_DATA.CTL_STSW.substring(16 - 1, 16 + 1 - 1));
        if (LNCICTLM.REC_DATA.CTL_STSW == null) LNCICTLM.REC_DATA.CTL_STSW = "";
        JIBS_tmp_int = LNCICTLM.REC_DATA.CTL_STSW.length();
        for (int i=0;i<128-JIBS_tmp_int;i++) LNCICTLM.REC_DATA.CTL_STSW += " ";
        if (!LNCICTLM.REC_DATA.CTL_STSW.substring(16 - 1, 16 + 1 - 1).equalsIgnoreCase("2")) {
            CEP.TRC(SCCGWA, "1111111");
            WS_ERR_MSG = LNCMSG_ERROR_MSG.LN_ERR_LN1691;
            S000_ERR_MSG_PROC();
            if (pgmRtn) return;
        }
        if (LNCICTLM.REC_DATA.CTL_STSW == null) LNCICTLM.REC_DATA.CTL_STSW = "";
        ...
        JIBS_tmp_int = LNCICTLM.REC_DATA.CTL_STSW.length();
        for (int i=0;i<128-JIBS_tmp_int;i++) LNCICTLM.REC_DATA.CTL_STSW += " ";
        CEP.TRC(SCCGWA, LNCICTLM.REC_DATA.CTL_STSW.substring(9 - 1, 9 + 1 - 1));
        if (LNCICTLM.REC_DATA.CTL_STSW == null) LNCICTLM.REC_DATA.CTL_STSW = "";
        JIBS_tmp_int = LNCICTLM.REC_DATA.CTL_STSW.length();
        for (int i=0;i<128-JIBS_tmp_int;i++) LNCICTLM.REC_DATA.CTL_STSW += " ";
        CEP.TRC(SCCGWA, LNCICTLM.REC_DATA.CTL_STSW.substring(10 - 1, 10 + 1 - 1));
        if (LNCICTLM.REC_DATA.CTL_STSW == null) LNCICTLM.REC_DATA.CTL_STSW = "";
        JIBS_tmp_int = LNCICTLM.REC_DATA.CTL_STSW.length();
        for (int i=0;i<128-JIBS_tmp_int;i++) LNCICTLM.REC_DATA.CTL_STSW += " ";
        ...
        JIBS_tmp_int = LNCICTLM.REC_DATA.CTL_STSW.length();
        for (int i=0;i<128-JIBS_tmp_int;i++) LNCICTLM.REC_DATA.CTL_STSW += " ";
        CEP.TRC(SCCGWA, LNCICTLM.REC_DATA.CTL_STSW.substring(47 - 1, 47 + 1 - 1));
        if (LNCICTLM.REC_DATA.CTL_STSW == null) LNCICTLM.REC_DATA.CTL_STSW = "";
        JIBS_tmp_int = LNCICTLM.REC_DATA.CTL_STSW.length();
        for (int i=0;i<128-JIBS_tmp_int;i++) LNCICTLM.REC_DATA.CTL_STSW += " ";
        CEP.TRC(SCCGWA, LNCICTLM.REC_DATA.CTL_STSW.substring(57 - 1, 57 + 1 - 1));
        if (LNCICTLM.REC_DATA.CTL_STSW == null) LNCICTLM.REC_DATA.CTL_STSW = "";
        JIBS_tmp_int = LNCICTLM.REC_DATA.CTL_STSW.length();
        for (int i=0;i<128-JIBS_tmp_int;i++) LNCICTLM.REC_DATA.CTL_STSW += " ";
        CEP.TRC(SCCGWA, LNCICTLM.REC_DATA.CTL_STSW.substring(59 - 1, 59 + 1 - 1));
        if (LNCICTLM.REC_DATA.CTL_STSW == null) LNCICTLM.REC_DATA.CTL_STSW = "";
        JIBS_tmp_int = LNCICTLM.REC_DATA.CTL_STSW.length();
        for (int i=0;i<128-JIBS_tmp_int;i++) LNCICTLM.REC_DATA.CTL_STSW += " ";
        CEP.TRC(SCCGWA, LNCICTLM.REC_DATA.CTL_STSW.substring(62 - 1, 62 + 1 - 1));
        if (LNCICTLM.REC_DATA.CTL_STSW == null) LNCICTLM.REC_DATA.CTL_STSW = "";
        JIBS_tmp_int = LNCICTLM.REC_DATA.CTL_STSW.length();
        for (int i=0;i<128-JIBS_tmp_int;i++) LNCICTLM.REC_DATA.CTL_STSW += " ";
        CEP.TRC(SCCGWA, LNCICTLM.REC_DATA.CTL_STSW.substring(63 - 1, 63 + 1 - 1));
        if (LNCICTLM.REC_DATA.CTL_STSW == null) LNCICTLM.REC_DATA.CTL_STSW = "";
        JIBS_tmp_int = LNCICTLM.REC_DATA.CTL_STSW.length();
        for (int i=0;i<128-JIBS_tmp_int;i++) LNCICTLM.REC_DATA.CTL_STSW += " ";
        CEP.TRC(SCCGWA, LNCICTLM.REC_DATA.CTL_STSW.substring(16 - 1, 16 + 1 - 1));
        ...
        if (WS_LSTS_FLG == 'Y') {
            ...
            if (LNCICTLM.REC_DATA.CTL_STSW.substring(11 - 1, 11 + 1 - 1).equalsIgnoreCase("1") 
                ...
                && LNCICTLM.REC_DATA.CTL_STSW.substring(9 - 1, 9 + 1 - 1).equalsIgnoreCase("0") 
                && LNCICTLM.REC_DATA.CTL_STSW.substring(10 - 1, 10 + 1 - 1).equalsIgnoreCase("0") 
                && LNCICTLM.REC_DATA.CTL_STSW.substring(19 - 1, 19 + 1 - 1).equalsIgnoreCase("0") 
                && LNCICTLM.REC_DATA.CTL_STSW.substring(31 - 1, 31 + 1 - 1).equalsIgnoreCase("1") 
                && LNCICTLM.REC_DATA.CTL_STSW.substring(47 - 1, 47 + 1 - 1).equalsIgnoreCase("0") 
                && LNCICTLM.REC_DATA.CTL_STSW.substring(57 - 1, 57 + 1 - 1).equalsIgnoreCase("0") 
                && LNCICTLM.REC_DATA.CTL_STSW.substring(59 - 1, 59 + 1 - 1).equalsIgnoreCase("0") 
                && LNCICTLM.REC_DATA.CTL_STSW.substring(62 - 1, 62 + 1 - 1).equalsIgnoreCase("0") 
                && LNCICTLM.REC_DATA.CTL_STSW.substring(63 - 1, 63 + 1 - 1).equalsIgnoreCase("0") 
                && LNCICTLM.REC_DATA.CTL_STSW.substring(16 - 1, 16 + 1 - 1).equalsIgnoreCase("2") 
                && LNCICTLM.REC_DATA.CTL_STSW.substring(4 - 1, 4 + 1 - 1).equalsIgnoreCase("0")) {
            } else {
        ...
        LNRBALZ.KEY.CONTRACT_NO = LNB6100_AWA_6100.CTA_NO;
        if ("0".trim().length() == 0) LNRBALZ.KEY.SUB_CTA_NO = 0;
        else LNRBALZ.KEY.SUB_CTA_NO = Integer.parseInt("0");
        T000_READ_LNTBALZ();
        if (pgmRtn) return;
        if (LNRBALZ.LOAN_BALL22 > 0 
            || LNRBALZ.LOAN_BALL42 > 0 
            || LNRBALZ.LOAN_BALL52 > 0) {
            WS_ERR_MSG = LNCMSG_ERROR_MSG.LN_ERR_LN1691;
            S000_ERR_MSG_PROC();
            if (pgmRtn) return;
        }
    ...
    public void B020_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        LNCICTLM.REC_DATA.CTL_STSW = LNCICTLM.REC_DATA.CTL_STSW.substring(0, 11 - 1) + JIBS_tmp_str[0] + LNCICTLM.REC_DATA.CTL_STSW.substring(11 + 1 - 1);
        if (LNCICTLM.REC_DATA.CTL_STSW == null) LNCICTLM.REC_DATA.CTL_STSW = "";
        JIBS_tmp_int = LNCICTLM.REC_DATA.CTL_STSW.length();
        for (int i=0;i<128-JIBS_tmp_int;i++) LNCICTLM.REC_DATA.CTL_STSW += " ";
        LNCICTLM.REC_DATA.CTL_STSW = LNCICTLM.REC_DATA.CTL_STSW.substring(0, 16 - 1) + "1" + LNCICTLM.REC_DATA.CTL_STSW.substring(16 + 1 - 1);
        S000_CALL_LNZICTLM();
        if (pgmRtn) return;
