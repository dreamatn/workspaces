...
public class LNCSSYND_DATA {
    ...
    public LNCSSYND_PHS_INF[] PHS_INF = new LNCSSYND_PHS_INF[5];
    ...
    public LNCSSYND_FEE_INF[] FEE_INF = new LNCSSYND_FEE_INF[5];
    ...
    public char SYN_TYP = ' ';
    public LNCSSYND_PART_INF[] PART_INF = new LNCSSYND_PART_INF[10];
    public LNCSSYND_DATA() {
        for (int i=0;i<5;i++) PHS_INF[i] = new LNCSSYND_PHS_INF();
        for (int i=0;i<5;i++) FEE_INF[i] = new LNCSSYND_FEE_INF();
        for (int i=0;i<10;i++) PART_INF[i] = new LNCSSYND_PART_INF();
    }
}
