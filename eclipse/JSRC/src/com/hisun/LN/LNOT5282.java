...
public class LNOT5282 {
    String WS_ERR_MSG = " ";
    LNOT5282_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new LNOT5282_WS_TEMP_VARIABLE();
    LNOT5282_WS_MSG_INFO WS_MSG_INFO = new LNOT5282_WS_MSG_INFO();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROCESS();
        B000_MAIN_PROCESS();
        CEP.TRC(SCCGWA, "LNOT5282 return!");
        Z_RET();
    }
