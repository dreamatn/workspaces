...
public class LNOT5214 {
    char K_PRINCIINT = 'I';
    String WS_ERR_MSG = " ";
    LNOT5214_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new LNOT5214_WS_TEMP_VARIABLE();
    LNOT5214_WS_MSG_INFO WS_MSG_INFO = new LNOT5214_WS_MSG_INFO();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROCESS();
        B000_MAIN_PROCESS();
        CEP.TRC(SCCGWA, "LNOT5214 return!");
        Z_RET();
    }
