...
public class LNCSPADD_COMM_DATA {
    ...
    public LNCSPADD_FEE_DATA[] FEE_DATA = new LNCSPADD_FEE_DATA[5];
    ...
    public LNCSPADD_COMM_DATA() {
        for (int i=0;i<5;i++) FEE_DATA[i] = new LNCSPADD_FEE_DATA();
    }
}
