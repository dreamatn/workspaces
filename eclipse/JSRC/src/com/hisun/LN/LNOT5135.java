...
public class LNOT5135 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "LNOT5135 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[1-1].S_AC_FLG);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[1-1].S_AC_NM);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[2-1].S_ACTYP);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[2-1].S_AC);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[2-1].S_AC_FLG);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[2-1].S_AC_NM);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[3-1].S_ACTYP);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[3-1].S_AC);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[3-1].S_AC_FLG);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[3-1].S_AC_NM);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[4-1].S_ACTYP);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[4-1].S_AC);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[4-1].S_AC_FLG);
        CEP.TRC(SCCGWA, LNB5132_AWA_5132.AC_DATA[4-1].S_AC_NM);
    ...
    public void B020_GET_AC_TYPE() throws IOException,SQLException,Exception {
        if (LNB5132_AWA_5132.AC_NO.trim().length() > 0) {
    ...
    public void B030_TRANCHE_MAIN_PROC() throws IOException,SQLException,Exception {
    ...
    public void R_GET_AC_TYPE() throws IOException,SQLException,Exception {
        ...
        if (LNB5132_AWA_5132.AC_TYP.equalsIgnoreCase("06")) {
            if (DCCPACTY.OUTPUT.AC_TYPE != 'K') {
                WS_MSGID = LNCMSG_ERROR_MSG.LN_AC_TYP_NOT_MATCH;
                S000_ERR_MSG_PROC();
            }
