...
public class LNOT4400 {
    ...
    double WS_AMT_1 = 0;
    String WS_AC_TYP = " ";
    LNOT4400_WS_OUT WS_OUT = new LNOT4400_WS_OUT();
    ...
    SCCGWA SCCGWA;
    LNB4400_AWA_4400 LNB4400_AWA_4400;
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "LNOT4400 return!");
        Z_RET();
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        GWA_BP_AREA = (SCCGBPA_BP_AREA) SCCGWA.BP_AREA_PTR;
        GWA_SC_AREA = (SCCGSCA_SC_AREA) SCCGWA.SC_AREA_PTR;
        SCCGWA.COMM_AREA.AWA_AREA_PTR = SCCGWA.COMM_AREA.AWA_AREA_PTR.replaceAll("BODY>", "LNB4400_AWA_4400>");
        LNB4400_AWA_4400 = (LNB4400_AWA_4400) XStreamUtil.xmlToBean(SCCGWA.COMM_AREA.AWA_AREA_PTR);
    ...
    public void B000_CHECK_INPUT() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, LNB4400_AWA_4400.PAPER_NO);
        CEP.TRC(SCCGWA, LNB4400_AWA_4400.AC);
        if (LNB4400_AWA_4400.PAPER_NO.trim().length() == 0 
            || LNB4400_AWA_4400.AC.trim().length() == 0 
            || LNB4400_AWA_4400.CI_NAME.trim().length() == 0) {
            WS_ERR_MSG = LNCMSG_ERROR_MSG.LN_ERR_MUST_INPUT;
            S000_ERR_MSG_PROC();
        }
        if (LNB4400_AWA_4400.AMT_S + LNB4400_AWA_4400.INT <= 0) {
            WS_ERR_MSG = LNCMSG_ERROR_MSG.LN_AMT_NOT_LAR_ZERO;
            S000_ERR_MSG_PROC();
        }
        if (LNB4400_AWA_4400.FLG_1 != '1' 
            && LNB4400_AWA_4400.FLG_1 != '2') {
            WS_ERR_MSG = LNCMSG_ERROR_MSG.LN_ERR_ALL_PAY_FLG;
            S000_ERR_MSG_PROC();
        }
        if (LNB4400_AWA_4400.FLG_2 != '1' 
            && LNB4400_AWA_4400.FLG_2 != '2') {
    ...
    public void B100_FUNC_MAIN() throws IOException,SQLException,Exception {
        ...
        B140_INQ_BAL();
        WS_AMT_Y = LNB4400_AWA_4400.AMT_S + LNB4400_AWA_4400.INT;
        ...
        if (DDCIQBAL.DATA.AVL_BAL < LNB4400_AWA_4400.INT) {
            WS_OUT.WS_INT = DDCIQBAL.DATA.AVL_BAL;
        } else {
            WS_OUT.WS_INT = LNB4400_AWA_4400.INT;
            WS_AMT_1 = DDCIQBAL.DATA.AVL_BAL - WS_OUT.WS_INT;
            if (WS_AMT_1 < LNB4400_AWA_4400.AMT_S) {
                WS_OUT.WS_AMT_S = WS_AMT_1;
            } else {
                WS_OUT.WS_AMT_S = LNB4400_AWA_4400.AMT_S;
            }
        }
        ...
        LNCSFPAY.DATA.REPAY_FLG = LNB4400_AWA_4400.FLG_2;
        LNCSFPAY.DATA.P_AMT = LNB4400_AWA_4400.AMT_S;
        LNCSFPAY.DATA.I_AMT = LNB4400_AWA_4400.INT;
        ...
        LNCSFPAY.DATA.ACAMT.REC_AC = LNB4400_AWA_4400.AC;
    ...
    public void B110_GET_CONT_NO() throws IOException,SQLException,Exception {
        ...
        LNRAGRE.DRAW_NO = LNB4400_AWA_4400.PAPER_NO;
        T000_READ_LNTAGRE();
    ...
    public void B120_CHECK_CONT_INFO() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, LNB4400_AWA_4400.CI_NAME);
        if (!CICQACAC.O_DATA.O_ACR_DATA.O_AC_CNM.equalsIgnoreCase(LNB4400_AWA_4400.CI_NAME)) {
    ...
    public void B130_CHECK_REPAY_AC_INFO() throws IOException,SQLException,Exception {
        ...
        IBS.init(SCCGWA, CICQACAC);
        CICQACAC.FUNC = 'R';
        CICQACAC.DATA.AGR_NO = LNB4400_AWA_4400.AC;
        S000_CALL_CIZQACAC();
        B101_GET_AC_TYPE();
        CEP.TRC(SCCGWA, WS_AC_TYP);
        if (WS_AC_TYP.equalsIgnoreCase(K_DC_AC)) {
            IBS.init(SCCGWA, DCCPCDCK);
            if (LNB4400_AWA_4400.PSW.trim().length() > 0) {
                if (LNB4400_AWA_4400.TRK2_DAT.trim().length() == 0) {
            ...
            DCCPCDCK.CARD_NO = LNB4400_AWA_4400.AC;
            DCCPCDCK.CARD_PSW = LNB4400_AWA_4400.PSW;
            DCCPCDCK.TRK2_DAT = LNB4400_AWA_4400.TRK2_DAT;
            DCCPCDCK.TRK3_DAT = LNB4400_AWA_4400.TRK3_DAT;
            S000_CALL_DCZPCDCK();
        }
    ...
    public void B140_INQ_BAL() throws IOException,SQLException,Exception {
        ...
        DDCIQBAL.DATA.AC = LNB4400_AWA_4400.AC;
    ...
    public void B201_PUTOUT_DATA_PREPARE() throws IOException,SQLException,Exception {
        ...
        WS_OUT.WS_APREF_NO = LNB4400_AWA_4400.PAPER_NO;
        WS_OUT.WS_CI_NAME = LNB4400_AWA_4400.CI_NAME;
