...
public class LNZRBP62 {
    DBParm LNTBSP62_RD;
    brParm LNTBSP62_BR = new brParm();
    boolean pgmRtn = false;
    String WS_BSPNAME = " ";
    char WS_TBL_FARM_FLAG = ' ';
    LNCMSG_ERROR_MSG LNCMSG_ERROR_MSG = new LNCMSG_ERROR_MSG();
    SCCEXCP SCCEXCP = new SCCEXCP();
    LNRBSP62 LNRBSP62 = new LNRBSP62();
    SCCGWA SCCGWA;
    ...
    public void MP(SCCGWA SCCGWA, SCCRWBSP SCCRWBSP) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "LNZRBP62 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        LNRBSP62A = (PSRBSP01) SCCRWBSP.INFO.PTR;
        GWA_BP_AREA = (SCCGBPA_BP_AREA) SCCGWA.BP_AREA_PTR;
        GWA_SC_AREA = (SCCGSCA_SC_AREA) SCCGWA.SC_AREA_PTR;
        IBS.CLONE(SCCGWA, LNRBSP62A, LNRBSP62);
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        IBS.CLONE(SCCGWA, LNRBSP62, LNRBSP62A);
    }
    ...
    public void T000_READ_BSP() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, LNRBSP62.KEY.AP_TYPE);
        CEP.TRC(SCCGWA, LNRBSP62.KEY.AP_BATNO);
        CEP.TRC(SCCGWA, LNRBSP62.KEY.BAT_NO);
        LNTBSP62_RD = new DBParm();
        LNTBSP62_RD.TableName = "LNTBSP62";
        IBS.READ(SCCGWA, LNRBSP62, LNTBSP62_RD);
    ...
    public void T000_WRITE_BSP() throws IOException,SQLException,Exception {
        LNRBSP62.CRT_DATE = SCCGWA.COMM_AREA.AC_DATE;
        LNRBSP62.CRT_TLR = SCCGWA.COMM_AREA.TL_ID;
        LNRBSP62.UPDTBL_DATE = SCCGWA.COMM_AREA.AC_DATE;
        LNRBSP62.UPDTBL_TLR = SCCGWA.COMM_AREA.TL_ID;
        LNTBSP62_RD = new DBParm();
        LNTBSP62_RD.TableName = "LNTBSP62";
        LNTBSP62_RD.errhdl = true;
        IBS.WRITE(SCCGWA, LNRBSP62, LNTBSP62_RD);
    ...
    public void T000_REWRITE_BSP() throws IOException,SQLException,Exception {
        ...
        LNTBSP62_RD = new DBParm();
        LNTBSP62_RD.TableName = "LNTBSP62";
        IBS.REWRITE(SCCGWA, LNRBSP62, LNTBSP62_RD);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRWBSP.RETURN_INFO = 'F';
        } else {
        }
    ...
    public void T000_DELETE_BSP() throws IOException,SQLException,Exception {
        LNTBSP62_RD = new DBParm();
        LNTBSP62_RD.TableName = "LNTBSP62";
        IBS.DELETE(SCCGWA, LNRBSP62, LNTBSP62_RD);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRWBSP.RETURN_INFO = 'F';
        } else if (SCCGWA.COMM_AREA.DBIO_FLG == '1') {
            SCCRWBSP.RETURN_INFO = 'N';
    ...
    public void T000_STARTBR_BSP() throws IOException,SQLException,Exception {
        LNTBSP62_BR.rp = new DBParm();
        LNTBSP62_BR.rp.TableName = "LNTBSP62";
        IBS.STARTBR(SCCGWA, LNRBSP62, LNTBSP62_BR);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRWBSP.RETURN_INFO = 'F';
        } else if (SCCGWA.COMM_AREA.DBIO_FLG == '1') {
            SCCRWBSP.RETURN_INFO = 'N';
    ...
    public void T000_READNEXT_BSP() throws IOException,SQLException,Exception {
        IBS.READNEXT(SCCGWA, LNRBSP62, this, LNTBSP62_BR);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRWBSP.RETURN_INFO = 'F';
        } else if (SCCGWA.COMM_AREA.DBIO_FLG == '1') {
            SCCRWBSP.RETURN_INFO = 'N';
