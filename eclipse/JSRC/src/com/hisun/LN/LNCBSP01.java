...
public class LNCBSP01 {
    ...
    public LNCBSP01_PHS_INF[] PHS_INF = new LNCBSP01_PHS_INF[5];
    ...
    public LNCBSP01_FEE_INF[] FEE_INF = new LNCBSP01_FEE_INF[5];
    ...
    public LNCBSP01() {
        for (int i=0;i<5;i++) PHS_INF[i] = new LNCBSP01_PHS_INF();
        for (int i=0;i<5;i++) FEE_INF[i] = new LNCBSP01_FEE_INF();
    }
}
