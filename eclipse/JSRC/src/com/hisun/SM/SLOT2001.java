...
public class SLOT2001 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "SLOT2001 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (WS_PROP_TYP == '2') {
            CEP.TRC(SCCGWA, SLB0001_AWA_0001.CI_NO);
            ...
            CEP.TRC(SCCGWA, SLB0001_AWA_0001.PROP_CD);
    ...
    public void B011_CHK_ITM_VALID() throws IOException,SQLException,Exception {
