...
public class SMOT1850 {
    boolean pgmRtn = false;
    SMOT1850_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new SMOT1850_WS_TEMP_VARIABLE();
    String WS_TSQ_REC = " ";
    SMOT1850_WS_TS_CNTL WS_TS_CNTL = new SMOT1850_WS_TS_CNTL();
    SMOT1850_WS_SPE_OUT WS_SPE_OUT = new SMOT1850_WS_SPE_OUT();
    SMOT1850_WS_REC_OUT WS_REC_OUT = new SMOT1850_WS_REC_OUT();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "SMOT1850 return!");
        Z_RET();
        if (pgmRtn) return;
        JIBS_RETURN();
    }
