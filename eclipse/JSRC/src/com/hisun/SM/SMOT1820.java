...
public class SMOT1820 {
    boolean pgmRtn = false;
    String WS_TSQ_NM = "SMOT1820";
    SMOT1820_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new SMOT1820_WS_TEMP_VARIABLE();
    String WS_TSQ_REC = " ";
    String WS_TSQ_REC1 = " ";
    SMOT1820_WS_TS_CNTL WS_TS_CNTL = new SMOT1820_WS_TS_CNTL();
    SMOT1820_WS_SPE_OUT WS_SPE_OUT = new SMOT1820_WS_SPE_OUT();
    SMOT1820_WS_REC_OUT WS_REC_OUT = new SMOT1820_WS_REC_OUT();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "SMOT1820 return!");
        Z_RET();
        if (pgmRtn) return;
        JIBS_RETURN();
    }
