...
public class SMOT1471 {
    String JIBS_tmp_str[] = new String[10];
    SMOT1471_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new SMOT1471_WS_TEMP_VARIABLE();
    SMCMSG_ERROR_MSG SMCMSG_ERROR_MSG = new SMCMSG_ERROR_MSG();
    SCCMSG SCCMSG = new SCCMSG();
    SCCCALL SCCCALL = new SCCCALL();
    SMCSDWF SMCSDWF = new SMCSDWF();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "SMOT1471 return!");
        Z_RET();
    }
    ...
    public void B005_ADD_RECORD() throws IOException,SQLException,Exception {
        IBS.init(SCCGWA, SMCSDWF);
        SMCSDWF.CODE = SMB1450_AWA_1450.CODE;
        S000_CALL_SMZSDWF();
    }
    public void S000_CALL_SMZSDWF() throws IOException,SQLException,Exception {
        IBS.CALLCPN(SCCGWA, "SM-S-DEL-WF", SMCSDWF);
        if (SMCSDWF.RC.RC_CODE != 0) {
            JIBS_tmp_str[0] = IBS.CLS2CPY(SCCGWA, SMCSDWF.RC);
