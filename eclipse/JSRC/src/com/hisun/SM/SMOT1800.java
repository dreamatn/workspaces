...
public class SMOT1800 {
    boolean pgmRtn = false;
    SMOT1800_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new SMOT1800_WS_TEMP_VARIABLE();
    String WS_TSQ_REC = " ";
    SMOT1800_WS_TS_CNTL WS_TS_CNTL = new SMOT1800_WS_TS_CNTL();
    SMOT1800_WS_SPE_OUT WS_SPE_OUT = new SMOT1800_WS_SPE_OUT();
    SMOT1800_WS_REC_OUT WS_REC_OUT = new SMOT1800_WS_REC_OUT();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "SMOT1800 return!");
        Z_RET();
        if (pgmRtn) return;
        JIBS_RETURN();
    }
