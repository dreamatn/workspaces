...
public class SMOT1478 {
    String JIBS_tmp_str[] = new String[10];
    SMOT1478_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new SMOT1478_WS_TEMP_VARIABLE();
    SMCMSG_ERROR_MSG SMCMSG_ERROR_MSG = new SMCMSG_ERROR_MSG();
    SCCMSG SCCMSG = new SCCMSG();
    SCCCALL SCCCALL = new SCCCALL();
    SMCSDWFB SMCSDWFB = new SMCSDWFB();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "SMOT1478 return!");
        Z_RET();
    }
    ...
    public void B005_ADD_RECORD() throws IOException,SQLException,Exception {
        IBS.init(SCCGWA, SMCSDWFB);
        SMCSDWFB.TR_CODE = SMB1450_AWA_1450.DATA[1-1].TRCODE;
        S000_CALL_SMZSDWFB();
    }
    public void S000_CALL_SMZSDWFB() throws IOException,SQLException,Exception {
        IBS.CALLCPN(SCCGWA, "SM-S-DEL-WFB", SMCSDWFB);
        if (SMCSDWFB.RC.RC_CODE != 0) {
            JIBS_tmp_str[0] = IBS.CLS2CPY(SCCGWA, SMCSDWFB.RC);
