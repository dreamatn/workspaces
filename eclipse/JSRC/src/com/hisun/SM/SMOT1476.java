...
public class SMOT1476 {
    String JIBS_tmp_str[] = new String[10];
    SMOT1476_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new SMOT1476_WS_TEMP_VARIABLE();
    SMCMSG_ERROR_MSG SMCMSG_ERROR_MSG = new SMCMSG_ERROR_MSG();
    SCCMSG SCCMSG = new SCCMSG();
    SCCCALL SCCCALL = new SCCCALL();
    SMCSDWFW SMCSDWFW = new SMCSDWFW();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "SMOT1476 return!");
        Z_RET();
    }
    ...
    public void B005_ADD_RECORD() throws IOException,SQLException,Exception {
        IBS.init(SCCGWA, SMCSDWFW);
        SMCSDWFW.CODE = SMB1450_AWA_1450.CODE;
        SMCSDWFW.Q_STS = SMB1450_AWA_1450.Q_STS;
        S000_CALL_SMZSDWFW();
    }
    public void S000_CALL_SMZSDWFW() throws IOException,SQLException,Exception {
        IBS.CALLCPN(SCCGWA, "SM-S-DEL-WFW", SMCSDWFW);
        if (SMCSDWFW.RC.RC_CODE != 0) {
            JIBS_tmp_str[0] = IBS.CLS2CPY(SCCGWA, SMCSDWFW.RC);
