...
public class SMZSBBSP {
    String JIBS_tmp_str[] = new String[10];
    boolean pgmRtn = false;
    SMZSBBSP_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new SMZSBBSP_WS_TEMP_VARIABLE();
    char WS_SEQ_FLG = ' ';
    ...
    public void MP(SCCGWA SCCGWA, SMCSQBSP SMCSQBSP) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "SMZSBBSP return!");
        Z_RET();
        if (pgmRtn) return;
    }
    ...
    public void S000_CALL_SMZUBBSP() throws IOException,SQLException,Exception {
        IBS.CALLCPN(SCCGWA, "SM-U-BRW-BSP-CTL", SMCUQBSP);
