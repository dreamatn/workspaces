...
public class SMOT2002 {
    String JIBS_tmp_str[] = new String[10];
    SMOT2002_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new SMOT2002_WS_TEMP_VARIABLE();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "SMOT2002 return!");
        Z_RET();
    }
    ...
    public void B005_UPD_RECORD() throws IOException,SQLException,Exception {
    ...
    public void S000_CALL_SMZSUBSP() throws IOException,SQLException,Exception {
        IBS.CALLCPN(SCCGWA, "SM-S-UPD-BSP-CTL", SMCSQBSP);
