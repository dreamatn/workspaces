...
public class BPB1137_AWA_1137 {
    ...
    public BPB1137_REB_INFO[] REB_INFO = new BPB1137_REB_INFO[5];
    public BPB1137_AWA_1137() {
        for (int i=0;i<5;i++) REB_INFO[i] = new BPB1137_REB_INFO();
    }
}
