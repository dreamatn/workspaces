...
public class BPOT9152 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT9152 return!");
        Z_RET();
    }
    ...
    public void B020_BRW_REC_PROC() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB9152_AWA_9152);
        CEP.TRC(SCCGWA, BPB9152_AWA_9152.CTRT_NO);
        CEP.TRC(SCCGWA, BPB9152_AWA_9152.VAL_DT);
        CEP.TRC(SCCGWA, BPB9152_AWA_9152.PRC_MTH);
        CEP.TRC(SCCGWA, BPB9152_AWA_9152.INT_BAS);
        CEP.TRC(SCCGWA, BPB9152_AWA_9152.AGGR_TYP);
        CEP.TRC(SCCGWA, BPB9152_AWA_9152.REF_CCY);
        CEP.TRC(SCCGWA, BPB9152_AWA_9152.REF_MTH);
        ...
        for (WS_IDX = 1; WS_IDX <= 5; WS_IDX += 1) {
            ...
            CEP.TRC(SCCGWA, BPCFCPHM.RATE_TBL[WS_IDX-1].UP_AMT);
        }
