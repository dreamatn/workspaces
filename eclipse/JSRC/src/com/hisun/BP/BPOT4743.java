...
public class BPOT4743 {
    String JIBS_tmp_str[] = new String[10];
    String K_CMP_AGC_MAINTAIN = "BP-S-MAINT-AUTOGEN";
    String PGM_SCSSCKDT = "SCSSCKDT";
    BPOT4743_WS_ERR_MSG WS_ERR_MSG = new BPOT4743_WS_ERR_MSG();
    short WS_FLD_NO = 0;
    int WS_DATE = 0;
    short WS_DATE_NO = 0;
    int WS_AC_DATE = 0;
    BPOT4743_REDEFINES8 REDEFINES8 = new BPOT4743_REDEFINES8();
    short WS_I = 0;
    short WS_II = 0;
    short WS_III = 0;
    BPOT4743_WS_MON WS_MON = new BPOT4743_WS_MON();
    char WS_DT_TYP_FLG = ' ';
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4743 return!");
        Z_RET();
    }
    ...
    public void B200_MAIN_PROCESS() throws IOException,SQLException,Exception {
        ...
        for (WS_I = 1; WS_I <= 12; WS_I += 1) {
            IBS.CPY2CLS(SCCGWA, BPB4730_AWA_4730.MONTH[WS_I-1].MON, BPCSAGCA.CAL_DETAIL.MONTH[WS_I-1]);
        }
        S000_CALL_BPZSAGCA();
    }
