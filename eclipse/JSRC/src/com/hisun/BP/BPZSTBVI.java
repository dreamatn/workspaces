...
public class BPZSTBVI {
    ...
    int WS_COPY_NUM = 0;
    BPZSTBVI_WS_TBVB_HEAD WS_TBVB_HEAD = new BPZSTBVI_WS_TBVB_HEAD();
    BPZSTBVI_WS_TBVD_DETAIL WS_TBVD_DETAIL = new BPZSTBVI_WS_TBVD_DETAIL();
    BPZSTBVI_WS_TEMP_DETAIL WS_TEMP_DETAIL = new BPZSTBVI_WS_TEMP_DETAIL();
    BPZSTBVI_WS_BPRD_KEY WS_BPRD_KEY = new BPZSTBVI_WS_BPRD_KEY();
    ...
    public void MP(SCCGWA SCCGWA, BPCSTBDB BPCSTBDB) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "BPZSTBVI return!");
        Z_RET();
        if (pgmRtn) return;
    }
    ...
    public void B010_04_OUTPUT_DETAIL() throws IOException,SQLException,Exception {
        B011_SEARCH_BVNM();
        if (pgmRtn) return;
        WS_TBVD_DETAIL.WS_TBVD_BR = BPRTBVD.KEY.BR;
        if (BPCSTBDB.TLR.trim().length() > 0) {
            WS_TBVD_DETAIL.WS_TBVD_PB_NO = WS_TEMP_PLBOX_NO;
            WS_TBVD_DETAIL.WS_TBVD_TLR = BPRVHPB.CUR_TLR;
            WS_TBVD_DETAIL.WS_TBVD_VB_FLG = BPRVHPB.POLL_BOX_IND;
        } else {
            WS_TBVD_DETAIL.WS_TBVD_PB_NO = WS_TEMP_DETAIL.WS_PL_BOX_NO;
        ...
        WS_TBVD_DETAIL.WS_TBVD_STS = WS_TEMP_DETAIL.WS_TEMP_STS;
        WS_TBVD_DETAIL.WS_TBVD_BV_CODE = WS_TEMP_DETAIL.WS_TEMP_CODE;
        WS_TBVD_DETAIL.WS_TBVD_BLL_CNM = BPCFBVQU.TX_DATA.BV_CNM;
        WS_TBVD_DETAIL.WS_TBVD_HEAD_NO = WS_TEMP_DETAIL.WS_TEMP_HEAD_NO;
        CEP.TRC(SCCGWA, "11");
        CEP.TRC(SCCGWA, WS_TEMP_DETAIL.WS_TEMP_CODE);
        ...
        if (BPCFBVQU.TX_DATA.CNT_UT != 0) {
            ...
            WS_TBVD_DETAIL.WS_TBVD_NUM = WS_TEMP_DETAIL.WS_NUM - BPCFBVQU.TX_DATA.CNT_UT * WS_COPY_NUM;
            WS_TBVD_DETAIL.WS_TBVD_COPY_NUM = WS_COPY_NUM;
        } else {
            WS_TBVD_DETAIL.WS_TBVD_COPY_NUM = 0;
            WS_TBVD_DETAIL.WS_TBVD_NUM = WS_TEMP_DETAIL.WS_NUM;
        }
        CEP.TRC(SCCGWA, "22");
        CEP.TRC(SCCGWA, BPCFBVQU.TX_DATA.CNT_UT);
        CEP.TRC(SCCGWA, WS_TBVD_DETAIL.WS_TBVD_COPY_NUM);
        CEP.TRC(SCCGWA, WS_TBVD_DETAIL.WS_TBVD_NUM);
        IBS.init(SCCGWA, SCCMPAG);
        SCCMPAG.FUNC = 'D';
        SCCMPAG.DATA_PTR = IBS.CLS2CPY(SCCGWA, WS_TBVD_DETAIL);
        SCCMPAG.DATA_LEN = 260;
        B_MPAG();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, WS_TBVD_DETAIL);
    }
    public void B010_03_OUTPUT_DETAIL() throws IOException,SQLException,Exception {
        IBS.init(SCCGWA, WS_TBVD_DETAIL);
        WS_TBVD_DETAIL.WS_TBVD_BR = BPRTBVD.KEY.BR;
        if (BPCSTBDB.TLR.trim().length() > 0) {
            WS_TBVD_DETAIL.WS_TBVD_PB_NO = WS_TEMP_PLBOX_NO;
            WS_TBVD_DETAIL.WS_TBVD_TLR = BPRVHPB.CUR_TLR;
            ...
            WS_TBVD_DETAIL.WS_TBVD_PB_NO = BPRTBVD.KEY.PL_BOX_NO;
        ...
        WS_TBVD_DETAIL.WS_TBVD_TLR = BPRVHPB.CUR_TLR;
        WS_TBVD_DETAIL.WS_TBVD_VB_FLG = BPRVHPB.POLL_BOX_IND;
        WS_TBVD_DETAIL.WS_TBVD_STS = BPRTBVD.KEY.STS;
        WS_TBVD_DETAIL.WS_TBVD_BV_CODE = BPRTBVD.KEY.BV_CODE;
        WS_TBVD_DETAIL.WS_TBVD_BLL_CNM = BPCFBVQU.TX_DATA.BV_CNM;
        WS_TBVD_DETAIL.WS_TBVD_HEAD_NO = BPRTBVD.KEY.HEAD_NO;
        WS_TBVD_DETAIL.WS_TBVD_BEG_NO = BPRTBVD.BEG_NO;
        WS_TBVD_DETAIL.WS_TBVD_END_NO = BPRTBVD.KEY.END_NO;
        WS_COPY_NUM = 0;
        WS_TBVD_DETAIL.WS_VIL_TYP = BPRTBVD.VIL_TYP;
        CEP.TRC(SCCGWA, "33");
        CEP.TRC(SCCGWA, BPRTBVD.KEY.BV_CODE);
        CEP.TRC(SCCGWA, BPCFBVQU.TX_DATA.CNT_UT);
        ...
        if (BPCFBVQU.TX_DATA.CNT_UT == 0) {
            WS_TBVD_DETAIL.WS_TBVD_COPY_NUM = 0;
            WS_TBVD_DETAIL.WS_TBVD_NUM = BPRTBVD.NUM;
        } else {
            WS_COPY_NUM = (int) ((BPRTBVD.NUM - BPRTBVD.NUM % BPCFBVQU.TX_DATA.CNT_UT) / BPCFBVQU.TX_DATA.CNT_UT);
            WS_TBVD_DETAIL.WS_TBVD_NUM = BPRTBVD.NUM - BPCFBVQU.TX_DATA.CNT_UT * WS_COPY_NUM;
            WS_TBVD_DETAIL.WS_TBVD_COPY_NUM = WS_COPY_NUM;
            CEP.TRC(SCCGWA, "44");
            CEP.TRC(SCCGWA, WS_TBVD_DETAIL.WS_TBVD_NUM);
            CEP.TRC(SCCGWA, BPCFBVQU.TX_DATA.CNT_UT);
