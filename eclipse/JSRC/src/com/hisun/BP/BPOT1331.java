...
public class BPOT1331 {
    String JIBS_tmp_str[] = new String[10];
    BPOT1331_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new BPOT1331_WS_TEMP_VARIABLE();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT1331 return!");
        Z_RET();
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        ...
        BPC1331 = new BPC1331();
        IBS.init(SCCGWA, BPC1331);
        IBS.CPY2CLS(SCCGWA, GWA_SC_AREA.INP_OUTP_AREA.INP_AREA_PTR, BPC1331);
    ...
    public void B002_QRY_PTR_PROC() throws IOException,SQLException,Exception {
        ...
        BPCSQSEQ.SEQ_TYPE = BPC1331.SEQ_TYPE;
        BPCSQSEQ.SEQ_CODE = BPC1331.SEQ_NAME;
        BPCSQSEQ.FUNC = 'S';
        S000_CALL_BPZSQSEQ();
    }
