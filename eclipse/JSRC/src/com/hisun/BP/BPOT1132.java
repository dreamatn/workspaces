...
public class BPOT1132 {
    ...
    short WS_FLD_NO = 0;
    short WS_CNT1 = 0;
    BPOT1132_WS_MMDD WS_MMDD = new BPOT1132_WS_MMDD();
    String WS_TXT = " ";
    String WS_QUEUE = " ";
    long WS_RESP = 0;
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "BPOT1132 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    ...
    public void B020_QUERY_AMO_RATE() throws IOException,SQLException,Exception {
        BPCOFAMO.FUNC = 'I';
