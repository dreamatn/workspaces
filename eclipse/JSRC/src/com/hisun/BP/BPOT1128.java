...
public class BPOT1128 {
    ...
    short WS_FLD_NO = 0;
    short WS_CNT1 = 0;
    BPOT1128_WS_DATE WS_DATE = new BPOT1128_WS_DATE();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT1128 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        B010_CHECK_INPUT();
        B020_CREATE_AMO_RATE();
    }
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, BPB1127_AWA_1127.AMORT_CD);
        ...
        CEP.TRC(SCCGWA, "CALL-BF");
        CEP.TRC(SCCGWA, CPN_FAMO_MAINTAIN);
        ...
        CEP.TRC(SCCGWA, BPB1127_AWA_1127.AMO_MTH);
        ...
        CEP.TRC(SCCGWA, BPB1127_AWA_1127.AMO_TMS);
        CEP.TRC(SCCGWA, BPB1127_AWA_1127.AMO_MTH);
        ...
        CEP.TRC(SCCGWA, BPB1127_AWA_1127.AMO_CYCL);
        ...
        CEP.TRC(SCCGWA, BPB1127_AWA_1127.AMO_CNT);
        ...
        CEP.TRC(SCCGWA, BPB1127_AWA_1127.MIN_AMT);
        ...
        CEP.TRC(SCCGWA, BPB1127_AWA_1127.MAX_AMT);
        ...
        CEP.TRC(SCCGWA, BPB1127_AWA_1127.AMO_CCY);
    ...
    public void B020_CREATE_AMO_RATE() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, "B020");
        CEP.TRC(SCCGWA, CPN_FAMO_MAINTAIN);
