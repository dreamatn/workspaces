...
public class BPB1122_AWA_1122 {
    ...
    public BPB1122_RAT_INFO[] RAT_INFO = new BPB1122_RAT_INFO[10];
    public BPB1122_AWA_1122() {
        for (int i=0;i<10;i++) RAT_INFO[i] = new BPB1122_RAT_INFO();
    }
}
