...
public class BPB9124_AWA_9124 {
    ...
    public BPB9124_REF_FEED[] REF_FEED = new BPB9124_REF_FEED[5];
    ...
    public BPB9124_TXN_OICD[] TXN_OICD = new BPB9124_TXN_OICD[5];
    public char CT_STS = ' ';
    ...
    public BPB9124_AWA_9124() {
        for (int i=0;i<5;i++) REF_FEED[i] = new BPB9124_REF_FEED();
        for (int i=0;i<5;i++) TXN_OICD[i] = new BPB9124_TXN_OICD();
    }
}
