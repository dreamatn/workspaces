...
public class BPOT2020 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT2020 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB2020_AWA_2020.R_FLG);
        CEP.TRC(SCCGWA, BPB2020_AWA_2020.SDT);
        CEP.TRC(SCCGWA, BPB2020_AWA_2020.EXP_DATE);
        CEP.TRC(SCCGWA, BPB2020_AWA_2020.DESC);
        CEP.TRC(SCCGWA, BPB2020_AWA_2020.CDESC);
        CEP.TRC(SCCGWA, BPB2020_AWA_2020.UPT_DT);
        CEP.TRC(SCCGWA, BPB2020_AWA_2020.UPT_TLR);
        B010_CHECK_INPUT();
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (BPB2020_AWA_2020.EXP_DATE < SCCGWA.COMM_AREA.AC_DATE) {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_LESS_ACDATE;
            WS_FLD_NO = BPB2020_AWA_2020.EXP_DATE_NO;
            S000_ERR_MSG_PROC_CONTINUE();
        }
    }
