...
public class BPOT5152 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT5152 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        for (WS_I = 1; WS_I <= 20; WS_I += 1) {
            ...
            if (BPB5150_AWA_5150.RULE_DAT[WS_I-1].EXR_TYPE.trim().length() == 0 
                || BPB5150_AWA_5150.RULE_DAT[WS_I-1].BASE_RAT.trim().length() == 0) {
                WS_DATA_FLG = 'E';
            } else {
                if (WS_DATA_FLG == 'E' 
    ...
    public void B020_UPD_PROC() throws IOException,SQLException,Exception {
        ...
        for (WS_I = 1; WS_I <= 20 
            ...
            CEP.TRC(SCCGWA, BPB5150_AWA_5150.RULE_DAT[WS_I-1].EXR_TYPE);
