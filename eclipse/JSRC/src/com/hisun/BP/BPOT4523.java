...
public class BPOT4523 {
    ...
    short WS_FLD_NO = 0;
    char WS_LVL = ' ';
    BPOT4523_WS_ORGM_KEY WS_ORGM_KEY = new BPOT4523_WS_ORGM_KEY();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4523 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB4520_AWA_4520.TRA_TYP);
        CEP.TRC(SCCGWA, BPB4520_AWA_4520.VIL_TYP);
        CEP.TRC(SCCGWA, BPB4520_AWA_4520.AREA_CD);
        CEP.TRC(SCCGWA, BPB4520_AWA_4520.INT_FLG);
        CEP.TRC(SCCGWA, BPB4520_AWA_4520.BRCH_BR);
        CEP.TRC(SCCGWA, BPB4520_AWA_4520.TRA_FLG);
        CEP.TRC(SCCGWA, BPB4520_AWA_4520.LIC_NO);
        B010_CHECK_INPUT();
        B020_UPDATE_ORG_RECORD();
    }
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, BPB4520_AWA_4520.BNK);
        CEP.TRC(SCCGWA, BPB4520_AWA_4520.BR);
        CEP.TRC(SCCGWA, SCCGWA.COMM_AREA.TL_ID);
        if (SCCGWA.COMM_AREA.TL_ID.equalsIgnoreCase("HDCPT62") 
            || SCCGWA.COMM_AREA.TL_ID.equalsIgnoreCase("5328001")) {
            IBS.init(SCCGWA, BPCFCGRL);
            BPCFCGRL.DATA_BR = BPB4520_AWA_4520.BR;
            BPCFCGRL.OPT_TYP = 'M';
            S000_CALL_BPZFCGRL();
        }
        ...
        if (BPB4520_AWA_4520.SUPR_BR != BPB4520_AWA_4520.BR) {
            ...
            CEP.TRC(SCCGWA, "AWA-SUPR-BR TO PQORG-BR");
            CEP.TRC(SCCGWA, BPB4520_AWA_4520.LVL);
            ...
            if (BPB4520_AWA_4520.SUPR_BR != BPCPQORG.SUPR_BR) {
                ...
                CEP.TRC(SCCGWA, BPCPQORG.LVL);
                CEP.TRC(SCCGWA, WS_LVL);
            }
            CEP.TRC(SCCGWA, BPB4520_AWA_4520.LVL);
        } else {
            IBS.init(SCCGWA, BPCPQORG);
            BPCPQORG.BNK = BPB4520_AWA_4520.BNK;
            BPCPQORG.BR = BPB4520_AWA_4520.BR;
            S000_CALL_BPZPQORG();
            if (BPCPQORG.RC.RC_CODE != 0) {
                WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_ORG_NOTFND;
                WS_FLD_NO = BPB4520_AWA_4520.BR_NO;
        ...
        if (BPB4520_AWA_4520.TYP.equalsIgnoreCase(K_HEAD_BR)) {
            ...
            while (BPCRORGM.RETURN_INFO != 'N') {
                if (BPRPORGM.TYPE.equalsIgnoreCase(K_HEAD_BR) 
                    && BPRPORGM.KEY.BR != BPB4520_AWA_4520.BR) {
    ...
    public void B020_UPDATE_ORG_RECORD() throws IOException,SQLException,Exception {
    ...
    public void S000_CALL_BPZFCGRL() throws IOException,SQLException,Exception {
        IBS.CALLCPN(SCCGWA, "BP-F-CORG-ATH-CTRL", BPCFCGRL);
        CEP.TRC(SCCGWA, BPCFCGRL.RC);
        if (BPCFCGRL.RC.RC_CODE != 0) {
            WS_ERR_MSG = IBS.CLS2CPY(SCCGWA, BPCFCGRL.RC);
            S000_ERR_MSG_PROC();
        }
    }
