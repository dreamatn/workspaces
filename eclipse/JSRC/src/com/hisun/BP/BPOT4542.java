...
public class BPOT4542 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4542 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        B010_CHECK_INPUT();
        B020_DELETE_ORG_REL_INFO();
    }
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, BPB4540_AWA_4540.BNK);
        CEP.TRC(SCCGWA, BPB4540_AWA_4540.TYP);
    ...
    public void B020_DELETE_ORG_REL_INFO() throws IOException,SQLException,Exception {
