...
public class BPOT6224 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT6224 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        B010_CHECK_INPUT();
        B020_ADD_HOL_PROCESS();
    }
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        if (SCCGWA.COMM_AREA.AC_DATE > BPB6220_AWA_6220.EFF_DT) {
    ...
    public void B020_ADD_HOL_PROCESS() throws IOException,SQLException,Exception {
        WS_I = 0;
        ...
        CEP.TRC(SCCGWA, BPCSTHOL.KEY.CAL_CD);
        CEP.TRC(SCCGWA, BPCSTHOL.KEY.EFF_DT);
        CEP.TRC(SCCGWA, BPCSTHOL.LAST_DATE);
        CEP.TRC(SCCGWA, BPCSTHOL.LAST_TELLER);
        for (WS_I = 1; WS_I <= 50; WS_I += 1) {
            BPCSTHOL.HOL_DATA[WS_I-1].HOL_DT = BPB6220_AWA_6220.HOL_DATA[WS_I-1].HOL_DT;
            CEP.TRC(SCCGWA, BPB6220_AWA_6220.HOL_DATA[WS_I-1].HOL_DT);
            ...
            BPCSTHOL.HOL_DATA[WS_I-1].HOL_TPY = BPB6220_AWA_6220.HOL_DATA[WS_I-1].HOL_TPY;
            if (BPB6220_AWA_6220.HOL_DATA[WS_I-1].HOL_DT != 0) {
                BPCSTHOL.HOL_DATA[WS_I-1].HOL_OPT = 'A';
            }
        }
        BPCSTHOL.FUNC = 'A';
