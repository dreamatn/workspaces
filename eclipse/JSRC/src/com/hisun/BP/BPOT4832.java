...
public class BPOT4832 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4832 return!");
        Z_RET();
    }
    ...
    public void B020_UPD_REC_PROC() throws IOException,SQLException,Exception {
        ...
        BPCSMTRO.EFF_DATE = BPB4830_AWA_4830.EFF_DT;
        BPCSMTRO.EXP_DATE = BPB4830_AWA_4830.EXP_DT;
        BPCSMTRO.UPD_DATE = SCCGWA.COMM_AREA.AC_DATE;
        BPCSMTRO.UPD_TLR = SCCGWA.COMM_AREA.TL_ID;
        S00_CALL_BPZSMTRO();
    }
