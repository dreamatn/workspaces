...
public class BPOT4962 {
    ...
    char K_ERROR = 'E';
    BPOT4962_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new BPOT4962_WS_TEMP_VARIABLE();
    int WS_EFF_DATE = 0;
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROCESS();
        B000_MAIN_PROCESS();
        CEP.TRC(SCCGWA, "BPOT4962 return!");
        Z_RET();
    }
    ...
    public void B100_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (BPB4960_AWA_4960.EFF_DATE < SCCGWA.COMM_AREA.AC_DATE) {
            WS_EFF_DATE = SCCGWA.COMM_AREA.AC_DATE;
        } else {
            WS_EFF_DATE = BPB4960_AWA_4960.EFF_DATE;
        }
        ...
        if (BPB4960_AWA_4960.EXP_DATE <= WS_EFF_DATE) {
