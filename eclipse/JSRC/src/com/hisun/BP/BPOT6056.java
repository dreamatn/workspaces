...
public class BPOT6056 {
    ...
    BPOT6056_WS_HIS_REF_NO WS_HIS_REF_NO = new BPOT6056_WS_HIS_REF_NO();
    BPOT6056_WS_HIS_REF_RTID WS_HIS_REF_RTID = new BPOT6056_WS_HIS_REF_RTID();
    String WS_TMP_CCY = " ";
    String WS_TMP_TENOR = " ";
    int WS_TMP_EFF_DT = 0;
    ...
    BPOT6056_WS_IHIT_RECORDS[] WS_IHIT_RECORDS = new BPOT6056_WS_IHIT_RECORDS[50];
    BPOT6056_WS_RTBK_INFO WS_RTBK_INFO = new BPOT6056_WS_RTBK_INFO();
    BPOT6056_WS_BASE_RT_HD WS_BASE_RT_HD = new BPOT6056_WS_BASE_RT_HD();
    BPOT6056_WS_OUTPUT_DATA WS_OUTPUT_DATA = new BPOT6056_WS_OUTPUT_DATA();
    char WS_OUTPUT_FLG = ' ';
    char WS_FILE_NAME = ' ';
    char WS_HIS_FLG = ' ';
    char WS_IHIT_FLG = ' ';
    ...
    public BPOT6056() {
        for (int i=0;i<50;i++) WS_IHIT_RECORDS[i] = new BPOT6056_WS_IHIT_RECORDS();
    }
    public void MP(SCCGWA SCCGWA, BPCSMMRT BPCSMMRT) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "BPOT6056 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    ...
    public void B100_02_CHK_DAYS_BTW_ONDT() throws IOException,SQLException,Exception {
        ...
        BPCOCLWD.DATE1 = BPCSMMRT.UPD_DATA[1-1].OEFF_DT;
        BPCOCLWD.DATE2 = BPCSMMRT.UPD_DATA[1-1].NEFF_DT;
    ...
    public void B060_BRW_BTH_INTR_PROCESS() throws IOException,SQLException,Exception {
        ...
        if (pgmRtn) return;
        if (BPCSMMRT.BRW_BTH_OPT == 'M') {
            R000_OUTPUT_BTH_MARKET_PROC();
            if (pgmRtn) return;
        } else {
            R000_OUTPUT_BTH_BASE_PROC();
            if (pgmRtn) return;
        }
    }
    ...
    public void R000_OUTPUT_BASIC_PROC() throws IOException,SQLException,Exception {
        IBS.init(SCCGWA, BPCO306);
    ...
    public void R000_OUTPUT_MOD_PROC() throws IOException,SQLException,Exception {
    ...
    public void R000_OUTPUT_BTH_MARKET_PROC() throws IOException,SQLException,Exception {
    ...
    public void R000_OUTPUT_BTH_BASE_PROC() throws IOException,SQLException,Exception {
    ...
    public void R010_01_GET_RATEID() throws IOException,SQLException,Exception {
    ...
    public void S010_TXN_HIS_RTID_PROC() throws IOException,SQLException,Exception {
        IBS.init(SCCGWA, BPCPNHIS);
        BPCPNHIS.INFO.TX_TYP = 'A';
        BPCPNHIS.INFO.JRNNO = SCCGWA.COMM_AREA.JRN_NO;
