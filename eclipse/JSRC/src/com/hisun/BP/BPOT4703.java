...
public class BPOT4703 {
    String JIBS_tmp_str[] = new String[10];
    String K_CMP_CAL_MAINTAIN = "BP-MAINT-CALENDER";
    String PGM_SCSSCKDT = "SCSSCKDT";
    BPOT4703_WS_ERR_MSG WS_ERR_MSG = new BPOT4703_WS_ERR_MSG();
    short WS_FLD_NO = 0;
    int WS_DATE = 0;
    short WS_DATE_NO = 0;
    int WS_AC_DATE = 0;
    BPOT4703_REDEFINES8 REDEFINES8 = new BPOT4703_REDEFINES8();
    short WS_I = 0;
    short WS_II = 0;
    short WS_III = 0;
    char WS_DT_TYP_FLG = ' ';
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4703 return!");
        Z_RET();
    }
    ...
    public void B100_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (BPB4700_AWA_4700.EXP_DATE <= SCCGWA.COMM_AREA.AC_DATE) {
            IBS.CPY2CLS(SCCGWA, BPCMSG_ERROR_MSG.BP_EXP_DATE_ERROR, WS_ERR_MSG);
            WS_FLD_NO = BPB4700_AWA_4700.EXP_DATE_NO;
            S000_ERR_MSG_PROC_CONTINUE();
        }
        ...
        if (BPB4700_AWA_4700.MONTH > 12) {
            IBS.CPY2CLS(SCCGWA, BPCMSG_ERROR_MSG.BP_MONTH_ERROR, WS_ERR_MSG);
            WS_FLD_NO = BPB4700_AWA_4700.MONTH_NO;
            S000_ERR_MSG_PROC_CONTINUE();
        }
        for (WS_I = 1; WS_I <= 42; WS_I += 1) {
            if ((BPB4700_AWA_4700.MONTH_1[WS_I-1].DT_NO_1 == 0 
                && BPB4700_AWA_4700.MONTH_1[WS_I-1].DT_TP_1 != ' ') 
                || (BPB4700_AWA_4700.MONTH_1[WS_I-1].DT_NO_1 != 0 
                && BPB4700_AWA_4700.MONTH_1[WS_I-1].DT_TP_1 == ' ')) {
    ...
    public void B200_MAIN_PROCESS() throws IOException,SQLException,Exception {
        ...
        BPCSMCAL.MON_NO = BPB4700_AWA_4700.MONTH;
        ...
        for (WS_I = 1; WS_I <= 42; WS_I += 1) {
            if (BPB4700_AWA_4700.MONTH_1[WS_I-1].DT_NO_1 != 0) {
                BPCSMCAL.CAL_DETAIL.MONTH[WS_III-1].DAY_TYP[WS_II-1] = BPB4700_AWA_4700.MONTH_1[WS_I-1].DT_TP_1;
                WS_II += 1;
            }
        }
        S000_CALL_BPZSMCAL();
