...
public class BPOT3954 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT3954 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (WS_FUNC_FLG != 'B') {
            ...
            if (BPB3950_AWA_3950.FUNC == ' ') WS_FLD_NO = 0;
            else WS_FLD_NO = Short.parseShort(""+BPB3950_AWA_3950.FUNC);
            S000_ERR_MSG_PROC();
        }
    }
    public void B020_BROWSE_BPTBVLT() throws IOException,SQLException,Exception {
    ...
    public void S000_CALL_BPZSBVLT() throws IOException,SQLException,Exception {
        ...
        SCCCALL.ERR_FLDNO = BPB3950_AWA_3950.FUNC;
