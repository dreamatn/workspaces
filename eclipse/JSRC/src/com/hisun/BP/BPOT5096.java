...
public class BPOT5096 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT5096 return!");
        Z_RET();
    }
    ...
    public void B020_PRE_INQ_REC_PROC() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB5090_AWA_5090);
        CEP.TRC(SCCGWA, BPB5090_AWA_5090.EXRA_CD);
        CEP.TRC(SCCGWA, BPB5090_AWA_5090.CCY);
        CEP.TRC(SCCGWA, BPB5090_AWA_5090.TENOR);
        CEP.TRC(SCCGWA, BPB5090_AWA_5090.CMP_FLG);
        CEP.TRC(SCCGWA, BPCMEDA.INP_DATA.EXR_TYP);
        CEP.TRC(SCCGWA, BPCMEDA.INP_DATA.CCY);
        CEP.TRC(SCCGWA, BPCMEDA.INP_DATA.TENOR);
        CEP.TRC(SCCGWA, BPCMEDA.INP_DATA.CMP_FLG);
