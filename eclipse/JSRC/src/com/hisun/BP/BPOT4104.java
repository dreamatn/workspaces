...
public class BPOT4104 {
    char K_ERROR = 'E';
    String K_OUTPUT_FMT = "BP244";
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4104 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        B010_CHECK_INPUT();
        S000_QUERY_PROC_CONTINUE();
    }
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        R000_CHECK_RESULT_PROC();
    }
    public void S000_QUERY_PROC_CONTINUE() throws IOException,SQLException,Exception {
