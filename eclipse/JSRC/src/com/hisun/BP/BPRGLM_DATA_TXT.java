...
public class BPRGLM_DATA_TXT {
    ...
    public BPRGLM_REL_ITMS[] REL_ITMS = new BPRGLM_REL_ITMS[60];
    public String UPD_TLR = " ";
    public int UPD_DATE = 0;
    public int UPD_TIME = 0;
    public String SUP_TEL1 = " ";
    public String SUP_TEL2 = " ";
    public BPRGLM_DATA_TXT() {
        for (int i=0;i<60;i++) REL_ITMS[i] = new BPRGLM_REL_ITMS();
    }
}
