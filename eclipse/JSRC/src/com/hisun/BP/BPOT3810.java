...
public class BPOT3810 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT3810 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (BPB3810_AWA_3810.BEG_NO.trim().length() > 0) {
            ...
            for (WS_I = 1; WS_I <= 20 
                && IBS.isNumeric(BPB3810_AWA_3810.BEG_NO.substring(WS_I - 1, WS_I + 1 - 1)); WS_I += 1) {
            }
        ...
        if (BPB3810_AWA_3810.END_NO.trim().length() > 0) {
            ...
            for (WS_I = 1; WS_I <= 20 
                && IBS.isNumeric(BPB3810_AWA_3810.END_NO.substring(WS_I - 1, WS_I + 1 - 1)); WS_I += 1) {
            }
            if (BPCFBVQU.TX_DATA.NO_LENGTH != WS_I - 1) {
                CEP.TRC(SCCGWA, BPCFBVQU.TX_DATA.NO_LENGTH);
                CEP.TRC(SCCGWA, WS_I);
    ...
    public void B020_BROWSE_BV_HISTORY() throws IOException,SQLException,Exception {
        ...
        BPCSBVBQ.BV_CNM = BPCFBVQU.TX_DATA.BV_CNM;
        ...
        BPCSBVBQ.STS = BPB3810_AWA_3810.STS;
        BPCSBVBQ.TX_DT = BPB3810_AWA_3810.TX_DT;
        BPCSBVBQ.BEG_DT = BPB3810_AWA_3810.BEG_DT;
        BPCSBVBQ.END_DT = BPB3810_AWA_3810.END_DT;
        BPCSBVBQ.TLR = BPB3810_AWA_3810.TLR;
        S00_CALL_BPZSBVBQ();
        CEP.TRC(SCCGWA, BPB3810_AWA_3810.BEG_DT);
        CEP.TRC(SCCGWA, BPB3810_AWA_3810.END_DT);
        CEP.TRC(SCCGWA, BPCFBVQU.TX_DATA.BV_CNM);
        CEP.TRC(SCCGWA, BPB3810_AWA_3810.HEAD_NO);
        CEP.TRC(SCCGWA, BPB3810_AWA_3810.BEG_NO);
        CEP.TRC(SCCGWA, BPB3810_AWA_3810.END_NO);
        CEP.TRC(SCCGWA, BPCSBVBQ.BV_CNM);
        CEP.TRC(SCCGWA, BPCSBVBQ.HEAD_NO);
