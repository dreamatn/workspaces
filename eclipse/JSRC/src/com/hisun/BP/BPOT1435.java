...
public class BPOT1435 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT1435 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, BPB1435_AWA_1435.ORGI_TYP);
        CEP.TRC(SCCGWA, BPB1435_AWA_1435.TX_TOOL);
    ...
    public void B020_BROWSE_ORGMRG_RECORD() throws IOException,SQLException,Exception {
        ...
        BPCPORLB.ORGI_TYP = BPB1435_AWA_1435.ORGI_TYP;
        BPCPORLB.TX_TOOL = BPB1435_AWA_1435.TX_TOOL;
