...
public class BPOT3803 {
    String JIBS_tmp_str[] = new String[10];
    String CPN_S_TLR_BL_INQ = "BP-S-TLR-BL-INQ ";
    ...
    BPCSTBLI BPCSTBLI = new BPCSTBLI();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT3803 return!");
        Z_RET();
    }
    ...
    public void B020_BROWSE_TBVD_RECORD() throws IOException,SQLException,Exception {
        ...
        IBS.init(SCCGWA, BPCSTBLI);
        BPCSTBLI.FUNC = BPB3800_AWA_3800.INQ_TYP;
        BPCSTBLI.BR = BPB3800_AWA_3800.BR;
        BPCSTBLI.TLR = BPB3800_AWA_3800.TLR;
        BPCSTBLI.VB_FLG = BPB3800_AWA_3800.VB_FLG;
        BPCSTBLI.VALUE = BPB3800_AWA_3800.VALUE;
        BPCSTBLI.BV_CODE = BPB3800_AWA_3800.BV_CODE;
        CEP.TRC(SCCGWA, BPCSTBLI.FUNC);
        CEP.TRC(SCCGWA, BPCSTBLI.BR);
        if (BPCSTBLI.FUNC == '0') {
            BPCSTBLI.FUNC = '0';
        } else {
            BPCSTBLI.FUNC = '1';
    ...
    public void S000_CALL_BPZSTBLI() throws IOException,SQLException,Exception {
        IBS.CALLCPN(SCCGWA, CPN_S_TLR_BL_INQ, BPCSTBLI);
    }
