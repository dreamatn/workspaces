...
public class BPOT3801 {
    String JIBS_tmp_str[] = new String[10];
    String CPN_S_TLR_BV_INQ = "BP-S-TLR-BV-INQ ";
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT3801 return!");
        Z_RET();
    }
    ...
    public void B020_BROWSE_TBVD_RECORD() throws IOException,SQLException,Exception {
        ...
        IBS.init(SCCGWA, BPCSTBDB);
        BPCSTBDB.FUNC = BPB3800_AWA_3800.INQ_TYP;
        BPCSTBDB.BR = BPB3800_AWA_3800.BR;
        BPCSTBDB.TLR = BPB3800_AWA_3800.TLR;
        BPCSTBDB.VB_FLG = BPB3800_AWA_3800.VB_FLG;
        BPCSTBDB.STS = BPB3800_AWA_3800.STS;
        BPCSTBDB.BV_CODE = BPB3800_AWA_3800.BV_CODE;
        BPCSTBDB.TYPE = BPB3800_AWA_3800.TYPE;
    ...
    public void S000_CALL_BPZSTBVI() throws IOException,SQLException,Exception {
        IBS.CALLCPN(SCCGWA, CPN_S_TLR_BV_INQ, BPCSTBDB);
    }
