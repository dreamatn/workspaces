...
public class BPOT1103 {
    ...
    SCCGWA SCCGWA;
    BPB1103_AWA_1103 BPB1103_AWA_1103;
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        this.SCCGWA = SCCGWA;
        CEP.TRC(SCCGWA);
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT1103 return!");
        Z_RET();
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        SCCGWA.COMM_AREA.AWA_AREA_PTR = SCCGWA.COMM_AREA.AWA_AREA_PTR.replaceAll("BODY>", "BPB1103_AWA_1103>");
        BPB1103_AWA_1103 = (BPB1103_AWA_1103) XStreamUtil.xmlToBean(SCCGWA.COMM_AREA.AWA_AREA_PTR);
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, BPB1103_AWA_1103.CHG_TYPE);
        if (BPB1103_AWA_1103.CHG_TYPE != '0' 
            && BPB1103_AWA_1103.CHG_TYPE != '1') {
            WS_FLD_NO = BPB1103_AWA_1103.CHG_TYPE_NO;
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_FEE_CHG_MTH_ERR;
            S000_ERR_MSG_PROC();
        }
        CEP.TRC(SCCGWA, BPB1103_AWA_1103.AMOT_FLG);
        if (BPB1103_AWA_1103.AMOT_FLG != '0' 
            && BPB1103_AWA_1103.AMOT_FLG != '1') {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_AMOT_FLG_INPUT_ERR;
            WS_FLD_NO = BPB1103_AWA_1103.AMOT_FLG_NO;
            S000_ERR_MSG_PROC();
        }
        CEP.TRC(SCCGWA, BPB1103_AWA_1103.DEBT_MTH);
        if (BPB1103_AWA_1103.DEBT_MTH != '0' 
            && BPB1103_AWA_1103.DEBT_MTH != '1' 
            && BPB1103_AWA_1103.DEBT_MTH != '2' 
            && BPB1103_AWA_1103.DEBT_MTH != '3') {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_DEBT_MTH_ERROR;
            WS_FLD_NO = BPB1103_AWA_1103.DEBT_MTH_NO;
            S000_ERR_MSG_PROC();
        }
        CEP.TRC(SCCGWA, BPB1103_AWA_1103.RECH_MTH);
        if (BPB1103_AWA_1103.RECH_MTH != '0' 
            && BPB1103_AWA_1103.RECH_MTH != '1' 
            && BPB1103_AWA_1103.RECH_MTH != '2') {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_RECH_MTH_ERROR;
            WS_FLD_NO = BPB1103_AWA_1103.RECH_MTH_NO;
            S000_ERR_MSG_PROC();
        }
        CEP.TRC(SCCGWA, BPB1103_AWA_1103.STR_DATE);
        CEP.TRC(SCCGWA, BPB1103_AWA_1103.END_DATE);
        CEP.TRC(SCCGWA, SCCGWA.COMM_AREA.AC_DATE);
        WS_DATE1 = BPB1103_AWA_1103.STR_DATE;
        WS_DATE2 = BPB1103_AWA_1103.END_DATE;
        if (BPB1103_AWA_1103.STR_DATE != 0 
            && WS_DATE1 < SCCGWA.COMM_AREA.AC_DATE 
            && WS_FUNC_FLG == 'A') {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_FEE_EFFDT_LT_ACDT;
            WS_FLD_NO = BPB1103_AWA_1103.STR_DATE_NO;
            S000_ERR_MSG_PROC();
        }
        if (BPB1103_AWA_1103.STR_DATE != 0 
            && BPB1103_AWA_1103.END_DATE != 0 
            && (WS_DATE2 < WS_DATE1 
            || WS_DATE2 == WS_DATE1)) {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_FEE_EFFDT_GT_EXPDT;
            WS_FLD_NO = BPB1103_AWA_1103.END_DATE_NO;
            S000_ERR_MSG_PROC();
        }
        if (BPB1103_AWA_1103.STR_DATE != 0) {
            IBS.init(SCCGWA, SCCCKDT);
            SCCCKDT.DATE = BPB1103_AWA_1103.STR_DATE;
        ...
        if (BPB1103_AWA_1103.END_DATE != 0) {
            IBS.init(SCCGWA, SCCCKDT);
            SCCCKDT.DATE = BPB1103_AWA_1103.END_DATE;
        ...
        CEP.TRC(SCCGWA, BPB1103_AWA_1103.DWN_AMT);
        CEP.TRC(SCCGWA, BPB1103_AWA_1103.UP_AMT);
        if ((BPB1103_AWA_1103.DWN_AMT != 0) 
            && (BPB1103_AWA_1103.UP_AMT != 0) 
            && (BPB1103_AWA_1103.UP_AMT < BPB1103_AWA_1103.DWN_AMT)) {
    ...
    public void R000_TRANS_DATA_PARAMETER() throws IOException,SQLException,Exception {
        BPCOFBAS.KEY.FEE_CODE = BPB1103_AWA_1103.FEE_CODE;
        BPCOFBAS.VAL.FEE_NO = 0;
        BPCOFBAS.VAL.FEE_DESC = BPB1103_AWA_1103.FEE_DESC;
        BPCOFBAS.VAL.FEE_TYPE = "001";
        BPCOFBAS.VAL.UP_AMT = BPB1103_AWA_1103.UP_AMT;
        BPCOFBAS.VAL.DWN_AMT = BPB1103_AWA_1103.DWN_AMT;
        ...
        BPCOFBAS.VAL.FEE_EXG_TYP = BPB1103_AWA_1103.EXG_TYP;
        BPCOFBAS.VAL.FEE_OWN_FLG = BPB1103_AWA_1103.OWN_FLG;
        BPCOFBAS.VAL.TRN_BR_PCT = BPB1103_AWA_1103.TX_BR_PE;
        BPCOFBAS.VAL.AC_BR1_PCT = BPB1103_AWA_1103.AC_BR_PE;
        BPCOFBAS.VAL.AC_BR2_PCT = BPB1103_AWA_1103.AC2_BR_P;
        BPCOFBAS.VAL.FEE_TX_MMO = BPB1103_AWA_1103.TX_MMO;
        BPCOFBAS.VAL.FEE_CHG_TYPE = BPB1103_AWA_1103.CHG_TYPE;
        BPCOFBAS.VAL.FEE_GTH_METH = '0';
        BPCOFBAS.VAL.FEE_CYC_METH = '0';
        BPCOFBAS.VAL.FEE_DIS_METH = '0';
        BPCOFBAS.VAL.FEE_AMOT_FLG = BPB1103_AWA_1103.AMOT_FLG;
        BPCOFBAS.VAL.AMOT_CODE = " ";
        BPCOFBAS.VAL.FEE_REB_FLG = ' ';
        BPCOFBAS.VAL.REB_CODE = BPB1103_AWA_1103.REB_CODE;
        ...
        BPCOFBAS.VAL.DEBT_METH = BPB1103_AWA_1103.DEBT_MTH;
        BPCOFBAS.VAL.RECH_METH = BPB1103_AWA_1103.RECH_MTH;
        BPCOFBAS.VAL.MAX_RECH_CNT = BPB1103_AWA_1103.MRECH_CN;
        BPCOFBAS.VAL.ADV_FLG = '1';
        if (BPB1103_AWA_1103.STR_DATE == 0) {
            BPCOFBAS.VAL.FEE_EFF_DATE = SCCGWA.COMM_AREA.AC_DATE;
        } else {
            BPCOFBAS.VAL.FEE_EFF_DATE = BPB1103_AWA_1103.STR_DATE;
        }
        if (BPB1103_AWA_1103.END_DATE == 0) {
            BPCOFBAS.VAL.FEE_EXP_DATE = 99991231;
        } else {
            BPCOFBAS.VAL.FEE_EXP_DATE = BPB1103_AWA_1103.END_DATE;
        }
    ...
    public void S000_CALL_BPZFSBAS() throws IOException,SQLException,Exception {
        ...
        SCCCALL.ERR_FLDNO = BPB1103_AWA_1103.FEE_CODE;
    ...
    public void S000_CALL_BPZSGSEQ() throws IOException,SQLException,Exception {
        ...
        SCCCALL.ERR_FLDNO = BPB1103_AWA_1103.FEE_CODE_NO;
        IBS.CALL(SCCGWA, SCCCALL);
