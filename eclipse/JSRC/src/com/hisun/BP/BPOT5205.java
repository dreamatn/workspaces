...
public class BPOT5205 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT5205 return!");
        Z_RET();
    }
    ...
    public void B100_CHECK_INPUT() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, BPB5205_AWA_5205.BR);
        ...
        BPB5205_AWA_5205.DT = SCCGWA.COMM_AREA.AC_DATE;
    ...
    public void B200_SET_NXT_TXN() throws IOException,SQLException,Exception {
        ...
        if (BPB5205_AWA_5205.CCY.trim().length() == 0 
            || BPB5205_AWA_5205.CCY.equalsIgnoreCase("0")) {
            CEP.TRC(SCCGWA, "CCYISSPACEORZERO");
            IBS.init(SCCGWA, SCCSUBS);
            SCCSUBS.AP_CODE = 999;
            SCCSUBS.TR_CODE = 5216;
            S020_SET_SUBS_TRN();
        } else {
            CEP.TRC(SCCGWA, "CCY IS NOT SPACE AND ZERO");
            CEP.TRC(SCCGWA, "5205BASE-TPE");
            CEP.TRC(SCCGWA, BPB5205_AWA_5205.BASE_TPE);
