...
public class BPOT6212 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "BPOT6212 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    ...
    public void B020_MODIFY_CITY_CODE() throws IOException,SQLException,Exception {
    ...
    public void S000_CALL_BPZSMCIT() throws IOException,SQLException,Exception {
        IBS.CALLCPN(SCCGWA, CPN_MAINTAIN_CITY_CODE, BPCSMCIT);
    }
