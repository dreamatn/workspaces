...
public class BPOT9232 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT9232 return!");
        Z_RET();
    }
    ...
    public void B100_CHECK_INPUT() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, BPB9230_AWA_9230.CURRENCY);
        CEP.TRC(SCCGWA, BPB9230_AWA_9230.TENOR_CD);
    ...
    public void S010_CALL_BPZSCCY() throws IOException,SQLException,Exception {
