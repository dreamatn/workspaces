...
public class BPCSLTHL {
    public BPCSLTHL_RC RC = new BPCSLTHL_RC();
    public BPCSLTHL_INFO INFO = new BPCSLTHL_INFO();
    public char OUTPUT_FLG = ' ';
    public char RETURN_INFO = ' ';
    public char EXIST_FLG = ' ';
    public String CLEAR_HOLD_TYPE = " ";
    public String CCY = " ";
