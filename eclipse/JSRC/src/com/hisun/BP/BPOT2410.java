...
public class BPOT2410 {
    int JIBS_tmp_int;
    String JIBS_tmp_str[] = new String[10];
    String K_OUTPUT_FMT = "BP141";
    char K_STSW_FLG_Y = '1';
    char K_STSW_FLG_Z = '2';
    int K_MAX_CCY_CNT = 5;
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT2410 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        for (WS_CCY_CNT = 1; WS_CCY_CNT <= K_MAX_CCY_CNT; WS_CCY_CNT += 1) {
            if (BPB2400_AWA_2400.CCY_INFO[WS_CCY_CNT-1].CCY.trim().length() > 0 
                ...
                CEP.TRC(SCCGWA, BPB2400_AWA_2400.CCY_INFO[WS_CCY_CNT-1].CCY_AMT);
    ...
    public void B020_TRANSFER_CASH_TO_ATM() throws IOException,SQLException,Exception {
        ...
        BPCSATMI.FUNC = '0';
        BPCSATMI.FROM_TLR = BPB2400_AWA_2400.ATM;
        BPCSATMI.FROM_TYP = '4';
        BPCSATMI.TO_TLR = BPB2400_AWA_2400.TLR;
        BPCSATMI.TO_TYP = '3';
        BPCSATMI.CS_KIND = '0';
        for (WS_CCY_CNT = 1; WS_CCY_CNT <= K_MAX_CCY_CNT; WS_CCY_CNT += 1) {
            if (BPB2400_AWA_2400.CCY_INFO[WS_CCY_CNT-1].CCY.trim().length() > 0 
