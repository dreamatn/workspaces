...
public class BPOT3220 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT3220 return!");
        Z_RET();
    }
    ...
    public void B020_TLR_BV_OUT() throws IOException,SQLException,Exception {
        ...
        S000_CALL_BPZSBLMO();
        BPB3210_AWA_3210.MOV_DT = BPCSBLMO.MOV_DT;
        BPB3210_AWA_3210.CNF_NO = BPCSBLMO.CNF_NO;
        BPB3210_AWA_3210.TX_BR = SCCGWA.COMM_AREA.BR_DP.TR_BRANCH;
        BPB3210_AWA_3210.TX_TLR = SCCGWA.COMM_AREA.TL_ID;
    }
