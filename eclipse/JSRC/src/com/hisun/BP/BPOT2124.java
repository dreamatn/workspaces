...
public class BPOT2124 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT2124 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        BPRALIB.KEY.APP_NO = BPB2122_AWA_2122.APP_NO;
        S000_READ_BPTALIB();
        CEP.TRC(SCCGWA, BPRALIB.APP_TYPE);
        if (BPB2122_AWA_2122.APP_NO == 0 
            || BPB2122_AWA_2122.APP_BR == 0) {
            CEP.ERR(SCCGWA, BPCMSG_ERROR_MSG.BP_INPUT_ERROR33);
        }
        if (!SCCGWA.COMM_AREA.TL_ID.equalsIgnoreCase(BPRALIB.APP_TLR)) {
