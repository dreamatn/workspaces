...
public class BPOT5071 {
    ...
    short WS_TR_CODE = 0;
    String WS_MSGID = " ";
    BPOT5071_WS_OLD_DATA WS_OLD_DATA = new BPOT5071_WS_OLD_DATA();
    BPOT5071_WS_NEW_DATA WS_NEW_DATA = new BPOT5071_WS_NEW_DATA();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROCESS();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "BPOT5071 return!");
        Z_RET();
        if (pgmRtn) return;
        JIBS_RETURN();
    }
