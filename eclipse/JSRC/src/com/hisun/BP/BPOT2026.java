...
public class BPOT2026 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT2026 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        B010_CHECK_INPUT();
        B020_DEL_CDTL_RECORD();
    }
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        if (BPB2020_AWA_2020.SDT < SCCGWA.COMM_AREA.AC_DATE 
            && BPB2020_AWA_2020.EXP_DATE >= SCCGWA.COMM_AREA.AC_DATE) {
        ...
        BPRCLBI.KEY.CCY = BPB2020_AWA_2020.CCY;
        BPRCLBI.KEY.PAR_VAL = BPB2020_AWA_2020.PAR_VAL;
        BPRCLBI.KEY.M_FLG = BPB2020_AWA_2020.M_FLG;
        BPCTLBIB.INFO.FUNC = '9';
        ...
        BPCTLBIB.LEN = 222;
        S000_CALL_BPZTLBIB();
        if (BPCTLBIB.RETURN_INFO == 'F') {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_THIS_DEL_PVAL_INUSE;
            S000_ERR_MSG_PROC();
        }
    }
    public void B020_DEL_CDTL_RECORD() throws IOException,SQLException,Exception {
