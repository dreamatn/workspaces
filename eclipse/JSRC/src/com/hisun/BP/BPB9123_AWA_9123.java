...
public class BPB9123_AWA_9123 {
    ...
    public BPB9123_REF_FEED[] REF_FEED = new BPB9123_REF_FEED[5];
    ...
    public BPB9123_TXN_OICD[] TXN_OICD = new BPB9123_TXN_OICD[5];
    public char CT_STS = ' ';
    ...
    public BPB9123_AWA_9123() {
        for (int i=0;i<5;i++) REF_FEED[i] = new BPB9123_REF_FEED();
        for (int i=0;i<5;i++) TXN_OICD[i] = new BPB9123_TXN_OICD();
    }
}
