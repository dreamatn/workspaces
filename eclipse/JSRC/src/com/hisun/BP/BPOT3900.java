...
public class BPOT3900 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT3900 return!");
        Z_RET();
    }
    ...
    public void B020_ADD_TBV_RECORD() throws IOException,SQLException,Exception {
    ...
    public void R000_TRANS_DATA_PARAMETER() throws IOException,SQLException,Exception {
        BPCSMTBV.FUNC = BPB3900_AWA_3900.FUNC;
        CEP.TRC(SCCGWA, BPCSMTBV.FUNC);
