...
public class BPCOFEEO_BAS {
    public String FEE_CODE = " ";
    public char FEE_FUNC = ' ';
    ...
    public char ADV_FLG = ' ';
    public int FEE_STR_DATE = 0;
    public int FEE_END_DATE = 0;
    public String FEE_FEE_TYPE = " ";
    public short FEE_FEE_NO = 0;
    public double FEE_UP_AMT = 0;
    public char FILLER40 = 0X01;
    public double FEE_DWN_AMT = 0;
    public char FILLER42 = 0X01;
    public double FEE_UP_PCT = 0;
    public double FEE_DWN_PCT = 0;
