...
public class BPOT4540 {
    String JIBS_tmp_str[] = new String[10];
    String K_OUTPUT_FMT = "BP411";
    String K_PUBCD_ORGRT = "ORGRT";
    ...
    String WS_ERR_MSG = " ";
    short WS_FLD_NO = 0;
    BPOT4540_WS_BR_LELVEL WS_BR_LELVEL = new BPOT4540_WS_BR_LELVEL();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4540 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (BPCPQORG.RC.RC_CODE != 0) {
            ...
            WS_BR_LELVEL.WS_BR_LEVEL = BPCPQORG.LVL;
        }
        ...
        CEP.TRC(SCCGWA, BPB4540_AWA_4540.REL_BR);
        ...
        if (BPB4540_AWA_4540.EFF_DT < SCCGWA.COMM_AREA.AC_DATE) {
        ...
        BPCOQPCD.INPUT_DATA.TYPE = K_PUBCD_ORGRT;
        BPCOQPCD.INPUT_DATA.CODE = BPB4540_AWA_4540.TYP;
        S000_CALL_BPZPQPCD();
        if (BPB4540_AWA_4540.TYP.equalsIgnoreCase("01") 
            || BPB4540_AWA_4540.TYP.equalsIgnoreCase("02") 
            || BPB4540_AWA_4540.TYP.equalsIgnoreCase("03")) {
            if (WS_BR_LELVEL.WS_REL_BR_LEVEL < WS_BR_LELVEL.WS_BR_LEVEL) {
                CEP.ERR(SCCGWA, BPCMSG_ERROR_MSG.BP_REL_BR_LEVEL_SMALL);
            }
        }
    }
