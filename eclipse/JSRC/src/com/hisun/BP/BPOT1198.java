...
public class BPOT1198 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT1198 return!");
        Z_RET();
    }
    ...
    public void B024_ACCOUNT_BR_PROC() throws IOException,SQLException,Exception {
        ...
        if (BPB1107_AWA_1107.BR != 0) {
            IBS.init(SCCGWA, BPCPQORG);
            BPCPQORG.BNK = SCCGWA.COMM_AREA.TR_BANK;
            BPCPQORG.BR = BPB1107_AWA_1107.BR;
            S000_CALL_BPZPQORG();
            CEP.TRC(SCCGWA, BPCPQORG.ATTR);
        }
        if (BPCPQORG.ATTR != '2' 
            && BPB1107_AWA_1107.BR != 0 
            && CICACCU.DATA.BBR != 0) {
            BPB1107_AWA_1107.BR = CICACCU.DATA.BBR;
        }
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.BR);
        WS_TS_FLG = "02";
        S000_TRC_WS_TS();
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        if (BPB1107_AWA_1107.FEE_CODE.trim().length() == 0) {
    ...
    public void B010_CHECK_INPUT_CN() throws IOException,SQLException,Exception {
        ...
        if (BPB1107_AWA_1107.AMO_FLG == 'Y' 
            ...
            if (BPB1107_AWA_1107.AMO_STDT < SCCGWA.COMM_AREA.AC_DATE) {
                WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_START_DATE_LESS;
                S000_ERR_MSG_PROC_CONTINUE();
            }
            if (BPB1107_AWA_1107.AMO_EDDT < SCCGWA.COMM_AREA.AC_DATE) {
                WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_MATUR_DT_ERR;
                S000_ERR_MSG_PROC_CONTINUE();
            }
            if (BPB1107_AWA_1107.AMO_EDDT < BPB1107_AWA_1107.AMO_STDT) {
                WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_MATUR_DATE_LESS;
                S000_ERR_MSG_PROC_CONTINUE();
            }
            if (BPB1107_AWA_1107.AMO_EDDT > 20991231) {
                WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_MATUR_DT_ERR;
                S000_ERR_MSG_PROC_CONTINUE();
            }
        }
        if (BPB1107_AWA_1107.AC_TYP == '2') {
            ...
            IBCQINF.INPUT_DATA.NOSTRO_CD = BPB1107_AWA_1107.FEE_AC;
            IBCQINF.INPUT_DATA.CCY = BPB1107_AWA_1107.CHG_CCY;
            S000_CALL_IBZQINF();
        }
        if (BPB1107_AWA_1107.AC_TYP == '3') {
            IBS.init(SCCGWA, AICPQMIB);
            AICPQMIB.INPUT_DATA.AC = BPB1107_AWA_1107.FEE_AC;
            S000_CALL_AIZPQMIB();
        }
        if (BPB1107_AWA_1107.AC_TYP == '4' 
            || BPB1107_AWA_1107.AC_TYP == '5') {
            IBS.init(SCCGWA, CICQACAC);
            if (BPB1107_AWA_1107.C_P_NO.trim().length() == 0) {
                BPB1107_AWA_1107.C_P_NO = BPB1107_AWA_1107.FEE_AC;
            }
            CICQACAC.DATA.AGR_NO = BPB1107_AWA_1107.C_P_NO;
            CICQACAC.DATA.CCY_ACAC = BPB1107_AWA_1107.CHG_CCY;
            CICQACAC.DATA.CR_FLG = BPB1107_AWA_1107.CCY_TYPE;
            CICQACAC.FUNC = 'R';
            S000_CALL_CIZQACAC();
        }
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.AC_TYP);
        if (BPB1107_AWA_1107.CHQ_NO.trim().length() > 0) {
            if (BPB1107_AWA_1107.AC_TYP == '6' 
                || BPB1107_AWA_1107.AC_TYP == '7') {
            } else {
                WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_CHQ_TYPE_EER;
                S000_ERR_MSG_PROC_CONTINUE();
            }
            IBS.init(SCCGWA, CICQACAC);
            CICQACAC.DATA.AGR_NO = BPB1107_AWA_1107.FEE_AC;
            CICQACAC.DATA.CCY_ACAC = BPB1107_AWA_1107.CHG_CCY;
            CICQACAC.DATA.CR_FLG = BPB1107_AWA_1107.CCY_TYPE;
            CICQACAC.FUNC = 'R';
            S000_CALL_CIZQACAC();
            IBS.init(SCCGWA, DDCSBCHQ);
            DDCSBCHQ.AC_NO = BPB1107_AWA_1107.FEE_AC;
            DDCSBCHQ.CHQ_NO = BPB1107_AWA_1107.CHQ_NO;
            S000_CALL_DDZSBCHQ();
            IBS.init(SCCGWA, DDCSQCHQ);
            DDCSQCHQ.AC_NO = BPB1107_AWA_1107.FEE_AC;
            DDCSQCHQ.STR_CHQ_NO = BPB1107_AWA_1107.CHQ_NO;
            DDCSQCHQ.END_CHQ_NO = BPB1107_AWA_1107.CHQ_NO;
            S000_CALL_DDZSQCHQ();
        ...
        if ((BPB1107_AWA_1107.AC_TYP == '0' 
            || BPB1107_AWA_1107.AC_TYP == '4' 
            || BPB1107_AWA_1107.AC_TYP == '5' 
            || BPB1107_AWA_1107.AC_TYP == '6' 
            || BPB1107_AWA_1107.AC_TYP == '7') 
            && BPB1107_AWA_1107.CHG_MOD == '1') {
            if (!BPB1107_AWA_1107.CHG_CCY.equalsIgnoreCase("156")) {
                IBS.init(SCCGWA, DDCIMCCY);
                DDCIMCCY.DATA[1-1].AC = BPB1107_AWA_1107.FEE_AC;
                if (BPB1107_AWA_1107.AC_TYP == '0') {
                    DDCIMCCY.DATA[1-1].AC = BPB1107_AWA_1107.FEE_AC;
                }
                if ((BPB1107_AWA_1107.AC_TYP == '4' 
                    || BPB1107_AWA_1107.AC_TYP == '5')) {
                    DDCIMCCY.DATA[1-1].AC = BPB1107_AWA_1107.C_P_NO;
                }
                if ((BPB1107_AWA_1107.AC_TYP == '6' 
                    || BPB1107_AWA_1107.AC_TYP == '7')) {
                    DDCIMCCY.DATA[1-1].AC = BPB1107_AWA_1107.CHQ_NO;
                }
                DDCIMCCY.DATA[1-1].CCY = BPB1107_AWA_1107.CHG_CCY;
                DDCIMCCY.DATA[1-1].CCY_TYPE = BPB1107_AWA_1107.CCY_TYPE;
                S000_CALL_DDZIMCCY();
            }
        }
        if (SCCGWA.COMM_AREA.CANCEL_IND != 'Y') {
            if (BPB1107_AWA_1107.AC_TYP == '0' 
                || BPB1107_AWA_1107.AC_TYP == '4' 
                || BPB1107_AWA_1107.AC_TYP == '5' 
                || BPB1107_AWA_1107.AC_TYP == '2' 
                || BPB1107_AWA_1107.AC_TYP == '6' 
                || BPB1107_AWA_1107.AC_TYP == '7') {
                if (BPB1107_AWA_1107.BR == ' ' 
                    || BPB1107_AWA_1107.BR == 0) {
                    IBS.init(SCCGWA, CICACCU);
                    CICACCU.DATA.ENTY_TYP = '1';
                    CICACCU.DATA.AGR_NO = BPB1107_AWA_1107.FEE_AC;
                    if (BPB1107_AWA_1107.AC_TYP == '2') {
                        CICACCU.DATA.AGR_NO = IBCQINF.INPUT_DATA.AC_NO;
                    }
                    if (BPB1107_AWA_1107.AC_TYP == '4' 
                        || BPB1107_AWA_1107.AC_TYP == '5') {
                        CICACCU.DATA.AGR_NO = BPB1107_AWA_1107.C_P_NO;
                    }
                    ...
                    if (((SCCGWA.COMM_AREA.CHNL.equalsIgnoreCase("101") 
                        ...
                        || BPB1107_AWA_1107.CI_NO.trim().length() > 0) 
                        && !CICACCU.DATA.CI_NO.equalsIgnoreCase(BPB1107_AWA_1107.CI_NO)) {
                    ...
                    if (((!SCCGWA.COMM_AREA.CHNL.equalsIgnoreCase("101") 
                        ...
                        && !SCCGWA.COMM_AREA.CHNL.equalsIgnoreCase("10102"))) 
                        && BPB1107_AWA_1107.CI_NO.trim().length() == 0) {
                        BPB1107_AWA_1107.CI_NO = CICACCU.DATA.CI_NO;
                    }
    ...
    public void B015_SET_FEE_INFO_CN() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.CHG_FLG);
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.AC_TYP);
        if (BPB1107_AWA_1107.AC_TYP == '1') {
        ...
        BPCFFTXI.TX_DATA.CARD_PSBK_NO = BPB1107_AWA_1107.C_P_NO;
        BPCFFTXI.TX_DATA.CHG_AC_INFO.CHQ_NO = BPB1107_AWA_1107.CHQ_NO;
        BPCFFTXI.TX_DATA.SALE_DATE = BPB1107_AWA_1107.SALE_DT;
        ...
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.C_P_NO);
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.CHQ_NO);
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.SALE_DT);
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.FEE_CTRT);
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.FEE_DPTM);
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.FEE_CONT);
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.FEE_ADVI);
        BPCFFTXI.TX_DATA.FEE_CTRT = BPB1107_AWA_1107.FEE_CTRT;
        BPCFFTXI.TX_DATA.FEE_DPTM = BPB1107_AWA_1107.FEE_DPTM;
        BPCFFTXI.TX_DATA.FEE_CONT = BPB1107_AWA_1107.FEE_CONT;
        BPCFFTXI.TX_DATA.FEE_ADVICE = BPB1107_AWA_1107.FEE_ADVI;
        BPCFFTXI.TX_DATA.CCY_TYPE = BPB1107_AWA_1107.CCY_TYPE;
        BPCFFTXI.TX_DATA.BSNS_NO = BPB1107_AWA_1107.BSNS_NO;
        BPCFFTXI.TX_DATA.CREV_NO = BPB1107_AWA_1107.CREV_NO;
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.CREV_NO);
        if (BPB1107_AWA_1107.CHG_MOD == '1') {
    ...
    public void B020_GET_FEE_BASIC_INFO() throws IOException,SQLException,Exception {
        ...
        BPRFBAS.KEY.FEE_CODE = BPB1107_AWA_1107.FEE_CODE;
    ...
    public void B045_CHG_FEE_PROC() throws IOException,SQLException,Exception {
        ...
        BPCFFCON.FEE_INFO.FEE_INFO1[1-1].FEE_CODE = BPB1107_AWA_1107.FEE_CODE;
        BPCFFCON.FEE_INFO.PROD_CODE1 = BPB1107_AWA_1107.PRD_CODE;
        if (BPB1107_AWA_1107.ADJ_AMT == 0) {
            BPB1107_AWA_1107.CFEE_CCY = BPB1107_AWA_1107.CHG_CCY;
            BPB1107_AWA_1107.ADJ_AMT = BPB1107_AWA_1107.CHG_AMT;
        }
        BPCFFCON.FEE_INFO.FEE_INFO1[1-1].FEE_CCY = BPB1107_AWA_1107.CFEE_CCY;
        BPCFFCON.FEE_INFO.FEE_INFO1[1-1].FEE_BAS = BPB1107_AWA_1107.FEE_BAS;
        BPCFFCON.FEE_INFO.FEE_INFO1[1-1].FEE_AMT = BPB1107_AWA_1107.ADJ_AMT;
        BPCFFCON.FEE_INFO.ACCOUNT_BR = BPB1107_AWA_1107.BR;
        BPCFFCON.FEE_INFO.EX_RATE = BPB1107_AWA_1107.RATE;
        BPCFFCON.FEE_INFO.TICKET_NO = BPB1107_AWA_1107.TICKET;
        BPCFFCON.FEE_INFO.REMARK = BPB1107_AWA_1107.REMK;
        BPCFFCON.FEE_INFO.FEE_INFO1[1-1].CHG_AC_TY = BPB1107_AWA_1107.AC_TYP;
        BPCFFCON.FEE_INFO.FEE_INFO1[1-1].CHG_AC = BPCFFTXI.TX_DATA.CHG_AC_INFO.CHG_AC;
        BPCFFCON.FEE_INFO.FEE_INFO1[1-1].CHG_CCY = BPB1107_AWA_1107.CHG_CCY;
        BPCFFCON.FEE_INFO.FEE_INFO1[1-1].CHG_BAS = BPB1107_AWA_1107.FEE_BAS;
        BPCFFCON.FEE_INFO.FEE_INFO1[1-1].CHG_AMT = BPB1107_AWA_1107.CHG_AMT;
        BPCFFCON.FEE_INFO.FEE_INFO1[1-1].ADJ_AMT = BPB1107_AWA_1107.CHG_AMT;
        if (SCCGWA.COMM_AREA.TR_BANK.equalsIgnoreCase("043")) {
            BPCFFCON.FEE_INFO.FEE_INFO1[1-1].AMO_FLG = BPB1107_AWA_1107.AMO_FLG;
            BPCFFCON.FEE_INFO.FEE_INFO1[1-1].AMO_STDT = BPB1107_AWA_1107.AMO_STDT;
            BPCFFCON.FEE_INFO.FEE_INFO1[1-1].AMO_EDDT = BPB1107_AWA_1107.AMO_EDDT;
        }
        if (BPB1107_AWA_1107.ACCT_CD == 999999999999) {
            BPCFFCON.FEE_INFO.FEE_INFO1[1-1].DIFF_FLG = 'Y';
        } else {
            BPCFFCON.FEE_INFO.FEE_INFO1[1-1].DIFF_FLG = 'N';
        }
        WS_TS_FLG = "07";
        S000_TRC_WS_TS();
        S000_CALL_BPZFFCON();
    ...
    public void B090_OUTPUT_INFO_CN() throws IOException,SQLException,Exception {
        ...
        if (BPB1107_AWA_1107.AC_TYP == '0') {
            CIRACR.KEY.AGR_NO = BPB1107_AWA_1107.FEE_AC;
            CEP.TRC(SCCGWA, CIRACR.KEY.AGR_NO);
        }
        if (BPB1107_AWA_1107.CI_NO.trim().length() > 0) {
            IBS.init(SCCGWA, CICCUST);
            CICCUST.DATA.CI_NO = BPB1107_AWA_1107.CI_NO;
        ...
        BPCOCHGF.SVR_CD = BPB1107_AWA_1107.SVR_CD;
        BPCOCHGF.CHNL = BPB1107_AWA_1107.CHNL;
        BPCOCHGF.RGN_NO = BPB1107_AWA_1107.RGN_NO;
        BPCOCHGF.PRD_CODE = BPB1107_AWA_1107.PRD_CODE;
        BPCOCHGF.FREE_FMT = BPB1107_AWA_1107.FREE_FMT;
        BPCOCHGF.CFEE_CCY = BPB1107_AWA_1107.FFEE_CCY;
        BPCOCHGF.CI_NO = BPB1107_AWA_1107.CI_NO;
        BPCOCHGF.AC_NO = BPB1107_AWA_1107.AC_NO;
        BPCOCHGF.INFO[1-1].FEE_CODE = BPB1107_AWA_1107.FEE_CODE;
        BPCOCHGF.FEE_DESC = BPRFBAS.FEE_DESC;
        BPCOCHGF.TX_MMO = BPRFBAS.TX_MMO;
        BPCOCHGF.INFO[1-1].FEE_AMT = BPB1107_AWA_1107.FEE_AMT;
        BPCOCHGF.ACC_CNT = BPB1107_AWA_1107.ACC_CNT;
        BPCOCHGF.TOT_AMT = BPB1107_AWA_1107.TOT_AMT;
        BPCOCHGF.CHG_FLG = BPB1107_AWA_1107.AC_TYP;
        BPCOCHGF.CHG_CCY = BPB1107_AWA_1107.CHG_CCY;
        BPCOCHGF.CHG_AMT = BPCFFCON.FEE_INFO.FEE_INFO1[1-1].ADJ_AMT;
        BPCOCHGF.FEE_AC = BPB1107_AWA_1107.FEE_AC;
        BPCOCHGF.CHQ_NO = BPB1107_AWA_1107.CHQ_NO;
        BPCOCHGF.CR_BANK = BPB1107_AWA_1107.CR_BANK;
        BPCOCHGF.DR_BANK = BPB1107_AWA_1107.DR_BANK;
        BPCOCHGF.ACCT_CD = BPB1107_AWA_1107.ACCT_CD;
        BPCOCHGF.RMK = BPB1107_AWA_1107.RMK;
        BPCOCHGF.BR = BPB1107_AWA_1107.BR;
        BPCOCHGF.REMK = BPB1107_AWA_1107.REMK;
        BPCOCHGF.CARD_NO = BPB1107_AWA_1107.C_P_NO;
        BPCOCHGF.FEE_CTRT = BPB1107_AWA_1107.FEE_CTRT;
        BPCOCHGF.FEE_DPTM = BPB1107_AWA_1107.FEE_DPTM;
        BPCOCHGF.FEE_CONT = BPB1107_AWA_1107.FEE_CONT;
        BPCOCHGF.FEE_ADVICE = BPB1107_AWA_1107.FEE_ADVI;
        BPCOCHGF.CCY_TYPE = BPB1107_AWA_1107.CCY_TYPE;
        BPCOCHGF.BSNS_NO = BPB1107_AWA_1107.BSNS_NO;
        BPCOCHGF.CREV_NO = BPB1107_AWA_1107.CREV_NO;
    ...
    public void R010_GET_CHK_GLMST_CN() throws IOException,SQLException,Exception {
        ...
        if (BPB1107_AWA_1107.BR != 0) {
            BPCQCNGL.DAT.INPUT.BR = BPB1107_AWA_1107.BR;
        }
        BPCICNGL.PROD_TYPE = BPB1107_AWA_1107.FEE_CODE;
    ...
    public void S000_CALL_IBZQINF() throws IOException,SQLException,Exception {
        ...
        if (IBCQINF.RC.RC_CODE != 0) {
            ...
            WS_FLD_NO = BPB1107_AWA_1107.FEE_AC_NO;
            S000_ERR_MSG_PROC_CONTINUE();
        }
    }
    public void S000_CALL_DCZPACTY() throws IOException,SQLException,Exception {
        ...
        if (DCCPACTY.RC.RC_CODE != 0) {
            ...
            WS_FLD_NO = BPB1107_AWA_1107.C_P_NO_NO;
            S000_ERR_MSG_PROC_CONTINUE();
        }
    }
