...
public class BPOT3110 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT3110 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB3010_AWA_3010.FLG);
        CEP.TRC(SCCGWA, BPB3010_AWA_3010.FEE_BVTY);
        CEP.TRC(SCCGWA, BPB3010_AWA_3010);
    ...
    public void B030_LINK_BVSO_COMPONENT() throws IOException,SQLException,Exception {
        ...
        BPCSBVSO.FLG = BPB3010_AWA_3010.FLG;
        BPCSBVSO.OUTPUT_FMT = K_OUTPUT_FMT;
        BPCSBVSO.FEE_BVTY = BPB3010_AWA_3010.FEE_BVTY;
        CEP.TRC(SCCGWA, BPCSBVSO.CODE);
        S00_CALL_BPZSBVSO();
    }
