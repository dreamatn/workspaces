...
public class BPOT5521 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT5521 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (BPB5520_AWA_5520.EXP_DT <= SCCGWA.COMM_AREA.AC_DATE 
            || BPB5520_AWA_5520.EXP_DT < BPB5520_AWA_5520.EFF_DT) {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_PARM_INV_EXP_DT;
            WS_FLD_NO = BPB5520_AWA_5520.EXP_DT_NO;
            S000_ERR_MSG_PROC();
        }
        CEP.TRC(SCCGWA, BPB5520_AWA_5520.CMP_FLG);
        if (BPB5520_AWA_5520.CMP_FLG != '0' 
            && BPB5520_AWA_5520.CMP_FLG != '1') {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_COM_FLG_ERR;
            WS_FLD_NO = BPB5520_AWA_5520.CMP_FLG_NO;
            S000_ERR_MSG_PROC();
        }
    }
    public void B020_ADD_REC_PROC() throws IOException,SQLException,Exception {
        ...
        BPCICPF.CI_ENM = BPB5520_AWA_5520.CI_ENM;
        BPCICPF.CI_CNM = BPB5520_AWA_5520.CI_CNM;
        BPCICPF.EXR_TYP = BPB5520_AWA_5520.EXR_TYP;
        BPCICPF.CCY = BPB5520_AWA_5520.CCY;
        BPCICPF.EFF_DT = BPB5520_AWA_5520.EFF_DT;
        BPCICPF.EXP_DT = BPB5520_AWA_5520.EXP_DT;
        BPCICPF.CMP_FLG = BPB5520_AWA_5520.CMP_FLG;
        BPCICPF.CS_BUY_P = BPB5520_AWA_5520.CS_BUY_P;
        BPCICPF.FX_BUY_P = BPB5520_AWA_5520.FX_BUY_P;
        BPCICPF.CS_SELL_P = BPB5520_AWA_5520.CS_SEL_P;
        BPCICPF.FX_SELL_P = BPB5520_AWA_5520.FX_SEL_P;
        S000_CALL_BPZICPF();
    }
