...
public class BPOT1512 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT1512 return!");
        Z_RET();
    }
    ...
    public void B020_ADD_RECORD() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, "&&&&&");
        CEP.TRC(SCCGWA, BPB1510_AWA_1510.BR);
        CEP.TRC(SCCGWA, BPB1510_AWA_1510.CCY);
        CEP.TRC(SCCGWA, BPB1510_AWA_1510.UPP_AMT);
        CEP.TRC(SCCGWA, BPB1510_AWA_1510.LOW_AMT);
