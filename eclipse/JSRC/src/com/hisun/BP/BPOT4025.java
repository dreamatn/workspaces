...
public class BPOT4025 {
    ...
    short WS_J = 0;
    int WS_CHK_DATE = 0;
    BPOT4025_WS_CASE_SEQ[] WS_CASE_SEQ = new BPOT4025_WS_CASE_SEQ[99];
    char WS_SORT_IND = ' ';
    char WS_SEQ_FND_FLG = ' ';
    char WS_SEQ_DUP_FLG = ' ';
    ...
    public BPOT4025() {
        for (int i=0;i<99;i++) WS_CASE_SEQ[i] = new BPOT4025_WS_CASE_SEQ();
    }
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4025 return!");
        Z_RET();
    }
    ...
    public void B100_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB4000_AWA_4000.DESC);
        CEP.TRC(SCCGWA, BPB4000_AWA_4000.SORT_IND);
        CEP.TRC(SCCGWA, BPB4000_AWA_4000.CNT);
