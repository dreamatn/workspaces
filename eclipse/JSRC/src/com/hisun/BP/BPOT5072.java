...
public class BPOT5072 {
    ...
    short WS_TR_CODE = 0;
    String WS_MSGID = " ";
    BPOT5072_WS_OLD_DATA WS_OLD_DATA = new BPOT5072_WS_OLD_DATA();
    BPOT5072_WS_NEW_DATA WS_NEW_DATA = new BPOT5072_WS_NEW_DATA();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROCESS();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "BPOT5072 return!");
        Z_RET();
        if (pgmRtn) return;
        JIBS_RETURN();
    }
    ...
    public void B100_GET_PROPERTY() throws IOException,SQLException,Exception {
        ...
        if (BPCRMPRP.RETURN_INFO == 'N') {
            CEP.ERR(SCCGWA, BPCMSG_ERROR_MSG.BP_TYPEPRO_NOTFND);
        }
    }
