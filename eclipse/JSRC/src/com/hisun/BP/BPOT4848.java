...
public class BPOT4848 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4848 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, BPB4840_AWA_4840.ASS_TYP);
        CEP.TRC(SCCGWA, BPB4840_AWA_4840.ASS_ID);
        CEP.TRC(SCCGWA, BPB4840_AWA_4840.AUTH_TYP);
        CEP.TRC(SCCGWA, BPB4840_AWA_4840.ROLE_CD);
        CEP.TRC(SCCGWA, BPB4840_AWA_4840.ROLE_NO);
        B010_CHECK_INPUT();
        B020_ENQ_REC_PROC();
    }
    ...
    public void B020_ENQ_REC_PROC() throws IOException,SQLException,Exception {
        ...
        BPCSMGRL.AUTH_TYP = BPB4840_AWA_4840.AUTH_TYP;
