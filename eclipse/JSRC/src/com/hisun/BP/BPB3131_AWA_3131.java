...
public class BPB3131_AWA_3131 {
    public char VB_FLG = ' ';
    public short VB_FLG_NO = 0;
    public BPB3131_BV_INFO[] BV_INFO = new BPB3131_BV_INFO[99];
    public char CK_TYP = ' ';
    ...
    public BPB3131_AWA_3131() {
        for (int i=0;i<99;i++) BV_INFO[i] = new BPB3131_BV_INFO();
    }
}
