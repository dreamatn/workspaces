...
public class BPOT4862 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4862 return!");
        Z_RET();
    }
    ...
    public void B020_UPGRADE_PROC() throws IOException,SQLException,Exception {
        ...
        BPCSTMUP.PRIV_TYP = BPB4862_AWA_4862.PRIV_TYP;
        BPCSTMUP.ATTR = BPB4862_AWA_4862.ATTR;
        BPCSTMUP.MOV_DATE = SCCGWA.COMM_AREA.AC_DATE;
        BPCSTMUP.MOV_EXP_DATE = BPB4862_AWA_4862.M_EXP_DT;
