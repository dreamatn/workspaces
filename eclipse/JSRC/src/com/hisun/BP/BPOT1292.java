...
public class BPOT1292 {
    ...
    SCCGMSG SCCGMSG;
    SCCAWAC SCCAWAC;
    BPB1292_AWA_1292 BPB1292_AWA_1292;
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        this.SCCGWA = SCCGWA;
        CEP.TRC(SCCGWA);
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT1292 return!");
        Z_RET();
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        ...
        SCCGWA.COMM_AREA.AWA_AREA_PTR = SCCGWA.COMM_AREA.AWA_AREA_PTR.replaceAll("BODY>", "BPB1292_AWA_1292>");
        BPB1292_AWA_1292 = (BPB1292_AWA_1292) XStreamUtil.xmlToBean(SCCGWA.COMM_AREA.AWA_AREA_PTR);
        SCCAWAC = new SCCAWAC();
    ...
    public void B020_DEL_RECORD() throws IOException,SQLException,Exception {
        ...
        BPCSFEAG.PRDT_CODE = BPB1292_AWA_1292.PRDT_CD;
        BPCSFEAG.CLT_TYPE = BPB1292_AWA_1292.CLT_TYPE;
        BPCSFEAG.EFF_DATE = BPB1292_AWA_1292.EFF_DATE;
        BPCSFEAG.FUNC = 'D';
        S000_CALL_BPZSFEAG();
    }
