...
public class BPCSFECT {
    public BPCSFECT_RC RC = new BPCSFECT_RC();
    ...
    public BPCSFECT_REF_FEE_DATA[] REF_FEE_DATA = new BPCSFECT_REF_FEE_DATA[5];
    ...
    public BPCSFECT_TXN_OIC_DATA[] TXN_OIC_DATA = new BPCSFECT_TXN_OIC_DATA[5];
    public char CT_STS = ' ';
    ...
    public BPCSFECT() {
        for (int i=0;i<5;i++) REF_FEE_DATA[i] = new BPCSFECT_REF_FEE_DATA();
        for (int i=0;i<5;i++) TXN_OIC_DATA[i] = new BPCSFECT_TXN_OIC_DATA();
    }
}
