...
public class BPB1120_AWA_1120 {
    ...
    public BPB1120_RAT_INFO[] RAT_INFO = new BPB1120_RAT_INFO[10];
    public BPB1120_AWA_1120() {
        for (int i=0;i<10;i++) RAT_INFO[i] = new BPB1120_RAT_INFO();
    }
}
