...
public class BPOT5051 {
    ...
    short WS_TR_CODE = 0;
    String WS_MSGID = " ";
    BPOT5051_WS_OLD_DATA WS_OLD_DATA = new BPOT5051_WS_OLD_DATA();
    BPOT5051_WS_NEW_DATA WS_NEW_DATA = new BPOT5051_WS_NEW_DATA();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROCESS();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "BPOT5051 return!");
        Z_RET();
        if (pgmRtn) return;
        JIBS_RETURN();
    }
    ...
    public void B100_GET_PROPERTY() throws IOException,SQLException,Exception {
        BPB1410_AWA_1410.FUNC = 'A';
        BPB1410_AWA_1410.TYPE = "EXRT";
        BPCRMPRP.FUNC = 'Q';
