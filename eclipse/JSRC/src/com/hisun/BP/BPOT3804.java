...
public class BPOT3804 {
    String JIBS_tmp_str[] = new String[10];
    String CPN_S_BL_ON_WAY_INQ = "BP-S-BL-ON-WAY-INQ ";
    ...
    BPCSBLOW BPCSBLOW = new BPCSBLOW();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT3804 return!");
        Z_RET();
    }
    ...
    public void B020_BROWSE_BMOV_RECORD() throws IOException,SQLException,Exception {
        ...
        IBS.init(SCCGWA, BPCSBLOW);
        BPCSBLOW.BR = BPB3800_AWA_3800.BR;
        BPCSBLOW.TLR = BPB3800_AWA_3800.TLR;
        BPCSBLOW.CODE = BPB3800_AWA_3800.BV_CODE;
        BPCSBLOW.MOV_STS = BPB3800_AWA_3800.MOV_STS;
        BPCSBLOW.FUNC = 'B';
        S000_CALL_BPZSBLOW();
    }
    ...
    public void S000_CALL_BPZSBLOW() throws IOException,SQLException,Exception {
        IBS.CALLCPN(SCCGWA, CPN_S_BL_ON_WAY_INQ, BPCSBLOW);
    }
