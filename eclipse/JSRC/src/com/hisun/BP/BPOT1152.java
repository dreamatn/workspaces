...
public class BPOT1152 {
    ...
    char WS_SKPCHG_FLG = ' ';
    char WS_SKPALL_FLG = ' ';
    BPOT1152_WS_FEE_CDS[] WS_FEE_CDS = new BPOT1152_WS_FEE_CDS[20];
    short WS_I = 0;
    char WS_URMT_FLG = ' ';
    ...
    public BPOT1152() {
        for (int i=0;i<20;i++) WS_FEE_CDS[i] = new BPOT1152_WS_FEE_CDS();
    }
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT1152 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (BPB1107_AWA_1107.AC_NO.trim().length() > 0) {
            ...
            CICQACRL.FUNC = 'I';
            CICQACRL.DATA.AC_NO = BPB1107_AWA_1107.AC_NO;
            ...
            if (CICQACRL.O_DATA.O_AC_REL.equalsIgnoreCase("04") 
                ...
                BPB1107_AWA_1107.AC_NO = CICQACRL.O_DATA.O_REL_AC_NO;
                IBS.init(SCCGWA, CICQACRI);
                CICQACRI.FUNC = 'A';
                CICQACRI.DATA.AGR_NO = BPB1107_AWA_1107.AC_NO;
                S000_CALL_CIZQACRI();
                CEP.TRC(SCCGWA, CICQACRI.O_DATA.O_PROD_CD);
                BPB1107_AWA_1107.PRD_CODE = CICQACRI.O_DATA.O_PROD_CD;
            }
            CEP.TRC(SCCGWA, BPB1107_AWA_1107.AC_NO);
    ...
    public void B030_GET_BASIC_FEE() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.CFEE_CCY);
        if (BPB1107_AWA_1107.FEE_AMT != 0) {
            BPVFSTD.KEY.FEE_CODE = WS_FEE_CODE;
            BPVFSTD.KEY.REG_CODE = " ";
            BPVFSTD.KEY.CHN_NO = " ";
            BPVFSTD.KEY.FREE_FMT = " ";
            BPVFSTD.KEY.REF_CCY = BPB1107_AWA_1107.CFEE_CCY;
            ...
            if (BPCFPARM.RETURN_INFO == 'N') {
                ...
                if (BPCFPARM.RETURN_INFO == 'N') {
                    ...
                    CEP.TRC(SCCGWA, BPB1107_AWA_1107.CFEE_CCY);
                    if (!BPVFSTD.VAL.FEE_CCY.equalsIgnoreCase(BPB1107_AWA_1107.CFEE_CCY)) {
                        ...
                        BPCFX.SELL_AMT = BPB1107_AWA_1107.FEE_AMT;
                        BPCFX.SELL_CCY = BPB1107_AWA_1107.CFEE_CCY;
                        CEP.TRC(SCCGWA, BPB1107_AWA_1107.AC_TYP);
                ...
                CEP.TRC(SCCGWA, BPB1107_AWA_1107.FEE_AMT);
                CEP.TRC(SCCGWA, BPVFSTD.VAL.START_AMT);
                if (BPB1107_AWA_1107.FEE_AMT < BPVFSTD.VAL.START_AMT) {
                    WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_TX_LESS_START_AMT;
                    S000_ERR_MSG_PROC();
                }
            }
        ...
        BPCFFCAL.DATA.CHNL_NO = BPB1107_AWA_1107.CHNL;
        BPCFFCAL.DATA.CNT_CCY = BPB1107_AWA_1107.CFEE_CCY;
        BPCFFCAL.DATA.TX_AMT = BPB1107_AWA_1107.FEE_AMT;
        BPCFFCAL.DATA.TX_CNT = BPB1107_AWA_1107.ACC_CNT;
        BPCFFCAL.DATA.CHG_CCY = BPB1107_AWA_1107.CHG_CCY;
        BPCFFCAL.DATA.FEE_CCY = BPB1107_AWA_1107.CFEE_CCY;
    ...
    public void B035_GET_FAV_INFO() throws IOException,SQLException,Exception {
        ...
        BPCTIFAV.INPUT_AREA.FEE_CODE = BPB1107_AWA_1107.FEE_CODE;
        ...
        BPCTIFAV.INPUT_AREA.FAV_CCY = BPB1107_AWA_1107.CFEE_CCY;
        BPCTIFAV.INPUT_AREA.PROD_CODE = BPB1107_AWA_1107.PRD_CODE;
        BPCTIFAV.INPUT_AREA.TX_AC = BPB1107_AWA_1107.AC_NO;
        BPCTIFAV.INPUT_AREA.TX_CI = BPB1107_AWA_1107.CI_NO;
        BPCTIFAV.INPUT_AREA.TX_AMT = BPB1107_AWA_1107.FEE_AMT;
        BPCTIFAV.INPUT_AREA.TX_CNT = BPB1107_AWA_1107.ACC_CNT;
        S000_CALL_BPZFIFAV();
    ...
    public void B045_CAL_URGENT_FEE_AMT_CN() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, BPB1107_AWA_1107.URMT_FLG);
        if (BPB1107_AWA_1107.URMT_FLG == 'Y') {
            WS_URMT_FLG = 'Y';
            B035_GET_FAV_INFO_CN();
            if (BPCTIFAV.OUTPUT_AREA.FAV_PCT != 0) {
                if (BPCTIFAV.OUTPUT_AREA.ADJ_TYP != '2') {
                    ...
                    bigD = new BigDecimal(WS_FEE_AMT);
                    WS_FEE_AMT = bigD.setScale(2, RoundingMode.HALF_UP).doubleValue();
                    CEP.TRC(SCCGWA, "WS-FEE-AMT3");
                } else {
                    WS_FEE_AMT = BPCFFCAL.DATA.TX_AMT * BPCTIFAV.OUTPUT_AREA.FAV_PCT / 100;
                    bigD = new BigDecimal(WS_FEE_AMT);
                    WS_FEE_AMT = bigD.setScale(2, RoundingMode.HALF_UP).doubleValue();
                    CEP.TRC(SCCGWA, "WS-FEE-AMT4");
                }
    ...
    public void B055_01_FEE_CMZ_INFO() throws IOException,SQLException,Exception {
        ...
        if (BPB1107_AWA_1107.CI_NO.trim().length() == 0) {
            ...
            BPCPQCMZ.CI_NO = BPB1107_AWA_1107.CI_NO;
        }
        BPCPQCMZ.FEE_CODE = BPB1107_AWA_1107.FEE_CODE;
        BPCPQCMZ.INQ_DT = SCCGWA.COMM_AREA.AC_DATE;
        BPCPQCMZ.CMZ_AC = BPB1107_AWA_1107.AC_NO;
        BPCPQCMZ.CMZ_CARD = BPB1107_AWA_1107.AC_NO;
        CEP.TRC(SCCGWA, "ZXC");
        S000_CALL_BPZPQCMZ();
    ...
    public void B089_COLLECTION_INFO() throws IOException,SQLException,Exception {
        ...
        if (WS_SGN_CINO.trim().length() > 0) {
            ...
            T000_ENDBR_BPTFEAG();
            if (WS_SKPCHG_FLG != 'Y') {
                WS_PROD_CD = BPB1107_AWA_1107.PRD_CODE;
            ...
            if (WS_SKPCHG_FLG == 'Y') {
                ...
                if (BPRFEAG.CLT_RANGE != 'A') {
                    for (WS_I = 1; WS_I <= 20 
                        ...
                        if (BPB1107_AWA_1107.FEE_CODE.equalsIgnoreCase(WS_FEE_CDS[WS_I-1].WS_FEE_CD1)) {
    ...
    public void B090_OUTPUT_INFO() throws IOException,SQLException,Exception {
        ...
        BPCONESF.CHG_AC = BPB1107_AWA_1107.AC_NO;
        CEP.TRC(SCCGWA, "BBBBBBBBBBB");
        BPCONESF.TICKET_NO = BPB1107_AWA_1107.TICKET;
        CEP.TRC(SCCGWA, "AAAAAAAAAAA");
        BPCONESF.CHG_AC_TY = BPB1107_AWA_1107.AC_TYP;
        R000_GET_RESULT_AMT();
    ...
    public void R000_GET_RESULT_AMT() throws IOException,SQLException,Exception {
        ...
        BPCRDAMT.CCY = BPCONESF.FEEE_CCY;
        BPCRDAMT.AMT = BPCONESF.FEE_BAS;
        CEP.TRC(SCCGWA, BPCONESF.FEE_BAS);
        S000_CALL_BPZRDAMT();
        CEP.TRC(SCCGWA, BPCRDAMT.RESULT_AMT);
        BPCONESF.FEE_BAS = BPCRDAMT.RESULT_AMT;
        CEP.TRC(SCCGWA, BPCONESF.FEE_BAS);
        IBS.init(SCCGWA, BPCRDAMT);
        BPCRDAMT.CCY = BPCONESF.FEEE_CCY;
        BPCRDAMT.AMT = BPCONESF.FEE_AMT;
        CEP.TRC(SCCGWA, BPCONESF.FEE_AMT);
        S000_CALL_BPZRDAMT();
        CEP.TRC(SCCGWA, BPCRDAMT.RESULT_AMT);
        BPCONESF.FEE_AMT = BPCRDAMT.RESULT_AMT;
        CEP.TRC(SCCGWA, BPCONESF.FEE_AMT);
        IBS.init(SCCGWA, BPCRDAMT);
        BPCRDAMT.CCY = BPCONESF.CHG_CCY;
        BPCRDAMT.AMT = BPCONESF.CHG_BAS;
        CEP.TRC(SCCGWA, BPCONESF.CHG_BAS);
        S000_CALL_BPZRDAMT();
        CEP.TRC(SCCGWA, BPCRDAMT.RESULT_AMT);
        BPCONESF.CHG_BAS = BPCRDAMT.RESULT_AMT;
        CEP.TRC(SCCGWA, BPCONESF.CHG_BAS);
        IBS.init(SCCGWA, BPCRDAMT);
        BPCRDAMT.CCY = BPCONESF.CHG_CCY;
        BPCRDAMT.AMT = BPCONESF.CHG_AMT;
        CEP.TRC(SCCGWA, BPCONESF.CHG_AMT);
        S000_CALL_BPZRDAMT();
        CEP.TRC(SCCGWA, BPCRDAMT.RESULT_AMT);
        BPCONESF.CHG_AMT = BPCRDAMT.RESULT_AMT;
        CEP.TRC(SCCGWA, BPCONESF.CHG_AMT);
    }
    public void B050_CAL_BVF_FEE_CN() throws IOException,SQLException,Exception {
        ...
        if (BPVFSTD.VAL.FEE_DATA[1-1].AGG_MTH == '2') {
            if (BPB1107_AWA_1107.ACC_CNT != 0) {
                WS_FEE_AMT = WS_FEE_AMT * BPB1107_AWA_1107.ACC_CNT;
                BPCFFCAL.DATA.FEE_AMT = BPCFFCAL.DATA.FEE_AMT * BPB1107_AWA_1107.ACC_CNT;
                BPCONESF.FEE_AMT = BPCONESF.FEE_AMT * BPB1107_AWA_1107.ACC_CNT;
            }
        }
        CEP.TRC(SCCGWA, BPCFFCAL.DATA.FEE_AMT);
        CEP.TRC(SCCGWA, BPCONESF.FEE_AMT);
    ...
    public void B060_EXCHANGE_CURRENCY_CN() throws IOException,SQLException,Exception {
        ...
        BPCONESF.FEE_CODE = BPB1107_AWA_1107.FEE_CODE;
        BPCONESF.FEE_BAS = BPCFFCAL.DATA.FEE_AMT;
    ...
    public void S000_CMZ_CCY_FOR_AMT() throws IOException,SQLException,Exception {
        ...
        if (BPCPQCMZ.CCY_RULE == '1') {
            if (BPCPQCMZ.CMZ_CCY.equalsIgnoreCase(BPB1107_AWA_1107.CHG_CCY) 
                || BPCPQCMZ.CMZ_AMT == 0) {
                WS_CMZ_AMT = BPCPQCMZ.CMZ_AMT;
            } else {
                WS_USING_CMZ_FLAG = 'Y';
