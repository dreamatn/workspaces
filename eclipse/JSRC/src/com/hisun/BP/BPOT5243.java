...
public class BPOT5243 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT5243 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        BPCSMBRT.UPD_DATA[1-1].NEFF_DT = BPB5240_AWA_5240.BRT_TBL[1-1].NEFF_DT;
        BPCSMBRT.UPD_DATA[1-1].NRATE = BPB5240_AWA_5240.BRT_TBL[1-1].NRATE;
        S010_CALL_BPZSMBRT();
    }
    public void B100_CHECK_INPUT() throws IOException,SQLException,Exception {
        if (BPB5240_AWA_5240.BRT_TBL[1-1].OEFF_DT > SCCGWA.COMM_AREA.AC_DATE) {
            if (BPB5240_AWA_5240.BRT_TBL[1-1].NEFF_DT <= SCCGWA.COMM_AREA.AC_DATE) {
                WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_EFF_DATE_ERR;
                WS_FLD_NO = BPB5240_AWA_5240.BRT_TBL[1-1].NEFF_DT_NO;
                S000_ERR_MSG_PROC();
            }
        } else {
            if (BPB5240_AWA_5240.BRT_TBL[1-1].NEFF_DT > SCCGWA.COMM_AREA.AC_DATE) {
