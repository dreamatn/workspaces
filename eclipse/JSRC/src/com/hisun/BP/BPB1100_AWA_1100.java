...
public class BPB1100_AWA_1100 {
    ...
    public BPB1100_RAT_INFO[] RAT_INFO = new BPB1100_RAT_INFO[5];
    public String DESC = " ";
    ...
    public BPB1100_FAVINFO[] FAVINFO = new BPB1100_FAVINFO[10];
    public BPB1100_PRD_FEE[] PRD_FEE = new BPB1100_PRD_FEE[20];
    public char ADJ_TYP = ' ';
    public short ADJ_TYP_NO = 0;
    public String DIF_VAL = " ";
    public short DIF_VAL_NO = 0;
    public BPB1100_AWA_1100() {
        for (int i=0;i<5;i++) RAT_INFO[i] = new BPB1100_RAT_INFO();
        for (int i=0;i<10;i++) FAVINFO[i] = new BPB1100_FAVINFO();
        for (int i=0;i<20;i++) PRD_FEE[i] = new BPB1100_PRD_FEE();
    }
}
