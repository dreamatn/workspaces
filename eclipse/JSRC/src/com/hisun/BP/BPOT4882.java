...
public class BPOT4882 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4882 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        for (WS_I = 1; WS_I <= 6; WS_I += 1) {
            ...
            if (BPB4880_AWA_4880.TAMT_ARR[WS_I-1].LIMIT == 0) {
                ...
                BPRMSG.KEY.TYP = "MSG";
                BPRMSG.KEY.CD = BPB4880_AWA_4880.TAMT_ARR[WS_I-1].REASON;
    ...
    public void B020_UPD_REC_PROC() throws IOException,SQLException,Exception {
        ...
        for (WS_I = 1; WS_I <= WS_CNT2; WS_I += 1) {
            CEP.TRC(SCCGWA, BPB4880_AWA_4880.TAMT_ARR[WS_I-1].U_LIMIT);
