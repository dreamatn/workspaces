...
public class BPOT4733 {
    String JIBS_tmp_str[] = new String[10];
    String K_CMP_CAL_MAINTAIN = "BP-S-MAINT-CALENDER";
    String PGM_SCSSCKDT = "SCSSCKDT";
    BPOT4733_WS_ERR_MSG WS_ERR_MSG = new BPOT4733_WS_ERR_MSG();
    short WS_FLD_NO = 0;
    int WS_DATE = 0;
    short WS_DATE_NO = 0;
    int WS_AC_DATE = 0;
    BPOT4733_REDEFINES8 REDEFINES8 = new BPOT4733_REDEFINES8();
    short WS_I = 0;
    short WS_II = 0;
    short WS_III = 0;
    BPOT4733_WS_MON WS_MON = new BPOT4733_WS_MON();
    char WS_DT_TYP_FLG = ' ';
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4733 return!");
        Z_RET();
    }
    ...
    public void B200_MAIN_PROCESS() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB4730_AWA_4730.EFF_DATE);
        CEP.TRC(SCCGWA, BPB4730_AWA_4730.EXP_DATE);
