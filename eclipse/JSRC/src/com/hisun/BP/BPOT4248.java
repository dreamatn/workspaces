...
public class BPOT4248 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4248 return!");
        Z_RET();
    }
    ...
    public void B200_MAIN_PROCESS() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB4240_AWA_4240.PBCD_KND);
        BPCSMACD.OUTPUT_FLG = 'Y';
        BPCSMACD.FUNC = 'Q';
        S000_CALL_BPZSMACD();
        B210_SET_SUB_TRN();
    }
    public void B210_SET_SUB_TRN() throws IOException,SQLException,Exception {
        IBS.init(SCCGWA, SCCSUBS);
        SCCSUBS.AP_CODE = 999;
        if (BPB4240_AWA_4240.FUNC == 'I') {
            SCCSUBS.TR_CODE = 4248;
        } else if (BPB4240_AWA_4240.FUNC == 'M') {
            SCCSUBS.TR_CODE = 4243;
        } else if (BPB4240_AWA_4240.FUNC == 'D') {
            SCCSUBS.TR_CODE = 4244;
        } else {
            SCCSUBS.TR_CODE = 4248;
        }
        S000_SET_SUBS_TRN();
