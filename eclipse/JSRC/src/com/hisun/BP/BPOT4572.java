...
public class BPOT4572 {
    ...
    short WS_TR_CODE = 0;
    String WS_MSGID = " ";
    BPOT4572_WS_OLD_DATA WS_OLD_DATA = new BPOT4572_WS_OLD_DATA();
    BPOT4572_WS_NEW_DATA WS_NEW_DATA = new BPOT4572_WS_NEW_DATA();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROCESS();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "BPOT4572 return!");
        Z_RET();
        if (pgmRtn) return;
        JIBS_RETURN();
    }
    ...
    public void B400_SET_SUB() throws IOException,SQLException,Exception {
        ...
        if ("9994577".trim().length() == 0) SCCSUBS.TR_CODE = 0;
        else SCCSUBS.TR_CODE = Short.parseShort("9994577");
        S000_CALL_SCZSUBS();
        if (pgmRtn) return;
    }
