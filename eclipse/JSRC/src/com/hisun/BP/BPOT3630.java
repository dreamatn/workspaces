...
public class BPOT3630 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT3630 return!");
        Z_RET();
    }
    ...
    public void B020_QUR_RECORD() throws IOException,SQLException,Exception {
        ...
        S000_CALL_BPZSSCMO();
        BPB3601_AWA_3601.MOV_DT = BPCSSCMO.MOV_DT;
        BPB3601_AWA_3601.CONF_NO = BPCSSCMO.CONF_NO;
        CEP.TRC(SCCGWA, BPCSSCMO.MOV_DT);
        CEP.TRC(SCCGWA, BPCSSCMO.CONF_NO);
        CEP.TRC(SCCGWA, BPB3601_AWA_3601.MOV_DT);
        CEP.TRC(SCCGWA, BPB3601_AWA_3601.CONF_NO);
    }
