...
public class BPOT2800 {
    boolean pgmRtn = false;
    String K_OUTPUT_FMT = "BP280";
    ...
    SCCGWA SCCGWA;
    BPB2800_AWA_2800 BPB2800_AWA_2800;
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "BPOT2800 return!");
        Z_RET();
        if (pgmRtn) return;
        JIBS_RETURN();
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        SCCGWA.COMM_AREA.AWA_AREA_PTR = SCCGWA.COMM_AREA.AWA_AREA_PTR.replaceAll("BODY>", "BPB2800_AWA_2800>");
        BPB2800_AWA_2800 = (BPB2800_AWA_2800) XStreamUtil.xmlToBean(SCCGWA.COMM_AREA.AWA_AREA_PTR);
    ...
    public void B010_01_CHECK_INVNTY() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB2800_AWA_2800.INVNTY1);
        CEP.TRC(SCCGWA, BPB2800_AWA_2800.INVNTY2);
