...
public class BPOT5242 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT5242 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (BPB5200_AWA_5200.VAL_TYP == ' ') {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_MUST_INPUT_VAL_TYP;
            S000_ERR_MSG_PROC();
        }
    ...
    public void B020_ADD_RECORD() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB5200_AWA_5200.TAX_VAL);
        ...
        BPCSTAXR.TAX_NAME = BPB5200_AWA_5200.TAX_NAME;
        BPCSTAXR.KEY.EFF_DT = BPB5200_AWA_5200.EFF_DT;
        BPCSTAXR.EXP_DT = BPB5200_AWA_5200.EXP_DT;
        BPCSTAXR.KEY.RESIDENT = BPB5200_AWA_5200.RESIDENT;
        BPCSTAXR.TAX_VAL = BPB5200_AWA_5200.TAX_VAL;
        BPCSTAXR.CREATE_DATE = SCCGWA.COMM_AREA.AC_DATE;
        BPCSTAXR.CREATE_TELL = SCCGWA.COMM_AREA.TL_ID;
        BPCSTAXR.UPDTBL_DATE = SCCGWA.COMM_AREA.AC_DATE;
        BPCSTAXR.LAST_TELL = SCCGWA.COMM_AREA.TL_ID;
        BPCSTAXR.SUP_TEL1 = SCCGMSG.SUP1_ID;
        BPCSTAXR.SUP_TEL2 = SCCGMSG.SUP2_ID;
        BPCSTAXR.FUNC = 'A';
        S000_CALL_BPZSTAXR();
    }
