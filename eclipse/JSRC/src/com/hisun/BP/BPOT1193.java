...
public class BPOT1193 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT1193 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        if (BPB1188_AWA_1188.CHG_AC.trim().length() == 0) {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_CHG_AC_MUST_INPUT;
            WS_FLD_NO = BPB1188_AWA_1188.CHG_AC_NO;
            S000_ERR_MSG_PROC();
        }
    }
    public void B020_QUERY_AGR_PROT() throws IOException,SQLException,Exception {
