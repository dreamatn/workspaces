...
public class BPOT1213 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT1213 return!");
        Z_RET();
    }
    ...
    public void B020_MOD_REC_PROC() throws IOException,SQLException,Exception {
        ...
        BPCSFSAF.CI_CNM = BPB1210_AWA_1210.CI_CNM;
        BPCSFSAF.FEE_CODE = BPB1210_AWA_1210.FEE_CD;
        BPCSFSAF.FREB_PER = BPB1210_AWA_1210.FREB_PER;
        BPCSFSAF.FREB_AC = BPB1210_AWA_1210.FREB_AC;
        BPCSFSAF.GL_MST1 = BPB1210_AWA_1210.GL_MST1;
        BPCSFSAF.FUNC = 'U';
        S00_CALL_BPZSFSAF();
    }
