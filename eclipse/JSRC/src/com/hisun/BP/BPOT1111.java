...
public class BPOT1111 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT1111 return!");
        Z_RET();
    }
    ...
    public void B020_CREATE_COM_INFO() throws IOException,SQLException,Exception {
    ...
    public void R000_TRANS_DATA_PARAMETER() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, "MOVE AWA-FERR-FMT");
        ...
        if (BPB1000_AWA_1000.EFF_DATE == 0) {
            BPCOFCOM.EFF_DATE = SCCGWA.COMM_AREA.AC_DATE;
        } else {
            BPCOFCOM.EFF_DATE = BPB1000_AWA_1000.EFF_DATE;
        }
        if (BPB1000_AWA_1000.EXP_DATE == 0) {
            BPCOFCOM.EXP_DATE = 99991231;
        } else {
