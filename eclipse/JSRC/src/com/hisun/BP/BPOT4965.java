...
public class BPOT4965 {
    ...
    char K_ERROR = 'E';
    BPOT4965_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new BPOT4965_WS_TEMP_VARIABLE();
    int WS_EFF_DATE = 0;
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROCESS();
        B000_MAIN_PROCESS();
        CEP.TRC(SCCGWA, "BPOT4965 return!");
        Z_RET();
    }
    ...
    public void B200_INQ_PROCESS() throws IOException,SQLException,Exception {
    ...
    public void B300_SET_SUB_TRN() throws IOException,SQLException,Exception {
        IBS.init(SCCGWA, SCCSUBS);
        SCCSUBS.AP_CODE = 999;
        if (BPB4960_AWA_4960.FUNC == 'I') {
            SCCSUBS.TR_CODE = 4961;
        } else if (BPB4960_AWA_4960.FUNC == 'A') {
            SCCSUBS.TR_CODE = 4962;
        } else if (BPB4960_AWA_4960.FUNC == 'M') {
            SCCSUBS.TR_CODE = 4963;
        } else if (BPB4960_AWA_4960.FUNC == 'D') {
            SCCSUBS.TR_CODE = 4964;
        } else {
            SCCSUBS.TR_CODE = 4961;
        }
        S000_SET_SUBS_TRN();
