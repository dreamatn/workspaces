...
public class BPOT7771 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT7771 return!");
        Z_RET();
    }
    ...
    public void B015_SET_FEE_INFO() throws IOException,SQLException,Exception {
        ...
        BPCFFTXI.TX_DATA.CHG_AC_INFO.CHG_AC = "520200900000";
    ...
    public void B020_CALL_FEE() throws IOException,SQLException,Exception {
        ...
        BPCTCALF.INPUT_AREA.PROD_CODE = "DDCRD001";
        CEP.TRC(SCCGWA, BPCTCALF.INPUT_AREA.PROD_CODE);
        BPCTCALF.INPUT_AREA.CPN_ID = "BP-F-F-CAL-STD-FEE";
