...
public class BPB1140_AWA_1140 {
    ...
    public BPB1140_REB_INFO[] REB_INFO = new BPB1140_REB_INFO[5];
    public BPB1140_AWA_1140() {
        for (int i=0;i<5;i++) REB_INFO[i] = new BPB1140_REB_INFO();
    }
}
