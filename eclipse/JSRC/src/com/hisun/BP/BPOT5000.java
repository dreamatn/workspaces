...
public class BPOT5000 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT5000 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        BPCSBENT.CLIENT_NO = BPB5000_AWA_5000.CI_NO;
        BPCSBENT.D_STATUS = BPB5000_AWA_5000.ENT_STS;
        BPCSBENT.START_DT = BPB5000_AWA_5000.STR_DT;
        BPCSBENT.END_DT = BPB5000_AWA_5000.END_DT;
        BPCSBENT.HOL_FLG = BPB5000_AWA_5000.HOL_FLG;
        CEP.TRC(SCCGWA, BPB5000_AWA_5000.CONT_NO);
        CEP.TRC(SCCGWA, BPB5000_AWA_5000.CI_NO);
        CEP.TRC(SCCGWA, BPB5000_AWA_5000.ENT_STS);
        CEP.TRC(SCCGWA, BPB5000_AWA_5000.STR_DT);
        CEP.TRC(SCCGWA, BPB5000_AWA_5000.END_DT);
        CEP.TRC(SCCGWA, BPB5000_AWA_5000.HOL_FLG);
        S010_CALL_BPZSBENT();
    }
    public void B100_CHECK_INPUT() throws IOException,SQLException,Exception {
        if (BPB5000_AWA_5000.CONT_NO.trim().length() == 0 
            && BPB5000_AWA_5000.CI_NO.trim().length() == 0) {
