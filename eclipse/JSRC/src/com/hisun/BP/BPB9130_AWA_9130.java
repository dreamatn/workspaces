...
public class BPB9130_AWA_9130 {
    ...
    public String CTRT_TYP = " ";
    public short CTRT_TYP_NO = 0;
    ...
    public BPB9130_REF_DATA[] REF_DATA = new BPB9130_REF_DATA[5];
    ...
    public BPB9130_OIC_DATA[] OIC_DATA = new BPB9130_OIC_DATA[3];
    public char FEE_STS = ' ';
    ...
    public BPB9130_AWA_9130() {
        for (int i=0;i<5;i++) REF_DATA[i] = new BPB9130_REF_DATA();
        for (int i=0;i<3;i++) OIC_DATA[i] = new BPB9130_OIC_DATA();
    }
}
