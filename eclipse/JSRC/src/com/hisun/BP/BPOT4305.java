...
public class BPOT4305 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "BPOT4305 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    ...
    public void B020_QUERY_CCY() throws IOException,SQLException,Exception {
        T000_CALL_BPZMCCY();
        if (pgmRtn) return;
    }
    public void B030_TRANS_MCCY_OUTPUT() throws IOException,SQLException,Exception {
