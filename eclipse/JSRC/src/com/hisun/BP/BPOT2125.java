...
public class BPOT2125 {
    String JIBS_tmp_str[] = new String[10];
    DBParm BPTALIB_RD;
    int JIBS_tmp_int;
    String K_OUTPUT_FMT = "BP118";
    String CPN_S_CSHAPP_MAINTAIN = "BP-S-CSHAPP-MAINTAIN";
    String CPN_F_TLR_INF_QUERY = "BP-F-TLR-INF-QUERY";
    String WS_ERR_MSG = " ";
    short WS_FLD_NO = 0;
    BPOT2125_WS_APP_INFO WS_APP_INFO = new BPOT2125_WS_APP_INFO();
    int WS_APP_NO = 0;
    int WS_CNT = 0;
    int WS_CNT1 = 0;
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        for (WS_CNT = 1; WS_CNT <= 2 
            ...
            CEP.TRC(SCCGWA, WS_APP_INFO.WS_APP_G[WS_CNT-1]);
        }
        CEP.TRC(SCCGWA, WS_CNT);
        if (WS_CNT == 1) {
        ...
        CEP.TRC(SCCGWA, "BPOT2125 return!");
        Z_RET();
    }
    public void A000_REDF_AWA() throws IOException,SQLException,Exception {
        IBS.init(SCCGWA, BPRALIB);
        CEP.TRC(SCCGWA, WS_CNT1);
        CEP.TRC(SCCGWA, WS_APP_INFO.WS_APP_G[WS_CNT1-1].WS_APP_N);
        BPRALIB.KEY.APP_NO = WS_APP_INFO.WS_APP_G[WS_CNT1-1].WS_APP_N;
