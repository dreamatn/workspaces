...
public class BPOT1408 {
    BPOT1408_WS_TEMP_VARIABLE WS_TEMP_VARIABLE = new BPOT1408_WS_TEMP_VARIABLE();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROCESS();
        B000_MAIN_PROCESS();
        CEP.TRC(SCCGWA, "BPOT1408 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROCESS() throws IOException,SQLException,Exception {
        B100_CHECK_INPUT();
        B200_ENQ_PARR_PROCESS();
    }
    public void B100_CHECK_INPUT() throws IOException,SQLException,Exception {
    }
    public void B200_ENQ_PARR_PROCESS() throws IOException,SQLException,Exception {
