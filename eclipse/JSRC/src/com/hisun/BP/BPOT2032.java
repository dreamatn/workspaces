...
public class BPOT2032 {
    ...
    String WS_ERR_MSG = " ";
    short WS_FLD_NO = 0;
    BPOT2032_WS_IBAC_KEY WS_IBAC_KEY = new BPOT2032_WS_IBAC_KEY();
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT2032 return!");
        Z_RET();
    }
    ...
    public void B020_MODIFY_IBAC_RECORD() throws IOException,SQLException,Exception {
