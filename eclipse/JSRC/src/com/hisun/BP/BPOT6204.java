...
public class BPOT6204 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT6204 return!");
        Z_RET();
    }
    ...
    public void B100_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, "JIJ6204");
        CEP.TRC(SCCGWA, BPB6200_AWA_6200.CALR_CD);
        if (BPB6200_AWA_6200.CALR_CD.trim().length() == 0) {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_CALR_CD_M_INPUT;
            WS_FLD_NO = BPB6200_AWA_6200.CALR_CD_NO;
            S000_ERR_MSG_PROC();
        }
        if (SCCGWA.COMM_AREA.AC_DATE > BPB6200_AWA_6200.EFF_DATE) {
        ...
        CEP.TRC(SCCGWA, BPB6200_AWA_6200.EXP_DATE);
        CEP.TRC(SCCGWA, BPB6200_AWA_6200.EFF_DATE);
    ...
    public void R000_INPUT_DATA_PROCESS() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPB6200_AWA_6200.LANG_CD);
    }
