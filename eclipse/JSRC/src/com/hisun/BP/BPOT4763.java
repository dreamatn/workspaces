...
public class BPOT4763 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4763 return!");
        Z_RET();
    }
    ...
    public void B010_01_CHK_PARM_VALID() throws IOException,SQLException,Exception {
        ...
        if (BPCQCNCI.RC.RC_CODE > 0) {
            ...
            if (WS_CHECK_CD_NO == '1') {
                WS_FLD_NO = BPB4760_AWA_4760.CITY_CD1_NO;
            } else if (WS_CHECK_CD_NO == '2') {
                WS_FLD_NO = BPB4760_AWA_4760.CITY_CD2_NO;
            } else if (WS_CHECK_CD_NO == '3') {
                WS_FLD_NO = BPB4760_AWA_4760.CITY_CD3_NO;
            } else if (WS_CHECK_CD_NO == '4') {
                WS_FLD_NO = BPB4760_AWA_4760.CITY_CD4_NO;
            } else {
            }
            S000_ERR_MSG_PROC();
        }
    }
    public void B020_MODIFY_HCHK_RECORD() throws IOException,SQLException,Exception {
    ...
    public void S000_CALL_BPZCQCNT() throws IOException,SQLException,Exception {
