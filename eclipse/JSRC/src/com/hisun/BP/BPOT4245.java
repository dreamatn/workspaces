...
public class BPOT4245 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4245 return!");
        Z_RET();
    }
    ...
    public void B200_MAIN_PROCESS() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, BPCSMACD.PARM_DATA.FLD_DESCE);
        CEP.TRC(SCCGWA, BPCSMACD.PARM_DATA.FLD_DESC);
        CEP.TRC(SCCGWA, BPCSMACD.PARM_DATA.FLD_TYPE);
        CEP.TRC(SCCGWA, BPCSMACD.PARM_DATA.FLD_LEN);
        CEP.TRC(SCCGWA, BPCSMACD.PARM_DATA.DEC_LEN);
        CEP.TRC(SCCGWA, BPCSMACD.PARM_DATA.SG_FLG);
        CEP.TRC(SCCGWA, BPCSMACD.PARM_DATA.FLD_IPT_FLG);
        CEP.TRC(SCCGWA, BPCSMACD.PARM_DATA.PBCD_TYPE);
        CEP.TRC(SCCGWA, BPCSMACD.PARM_DATA.OPEN_DATE);
        CEP.TRC(SCCGWA, BPCSMACD.PARM_DATA.LST_DATE);
        CEP.TRC(SCCGWA, BPCSMACD.PARM_DATA.LST_TLT);
        CEP.TRC(SCCGWA, BPCSMACD.PARM_DATA.FLD_MAX_LEN);
        CEP.TRC(SCCGWA, BPB4240_AWA_4240.IPT_FLG);
