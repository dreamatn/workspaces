...
public class BPOT4971 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT4971 return!");
        Z_RET();
    }
    ...
    public void B030_OUTPUT_PROC() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, BPB4970_AWA_4970.FUNC);
        IBS.init(SCCGWA, SCCSUBS);
        SCCSUBS.AP_CODE = 999;
        if (BPB4970_AWA_4970.FUNC == 'Q') {
            SCCSUBS.TR_CODE = 4972;
        } else if (BPB4970_AWA_4970.FUNC == 'M') {
            SCCSUBS.TR_CODE = 4973;
        } else if (BPB4970_AWA_4970.FUNC == 'D') {
            SCCSUBS.TR_CODE = 4974;
        } else {
            WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_FUNC_ERROR;
            WS_FLD_NO = BPB4970_AWA_4970.FUNC_NO;
            S000_ERR_MSG_PROC();
        }
        S000_CALL_SCZSUBS();
    }
