...
public class BPOT5140 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT5140 return!");
        Z_RET();
    }
    ...
    public void B020_PRE_ADD_PROC() throws IOException,SQLException,Exception {
        IBS.init(SCCGWA, BPCMSQ);
        BPCMSQ.FUNC = 'X';
        BPCMSQ.EXR_TYP = BPB5140_AWA_5140.EXR_TYPE;
        BPCMSQ.QTP_DATA.DATA[1-1].CCY = BPB5140_AWA_5140.QTP_DATA[1-1].CCY;
        ...
        CEP.TRC(SCCGWA, BPB5140_AWA_5140.QTP_DATA[1-1].CCY);
        S00_CALL_BPZMSQ();
    }
