...
public class BPZUAOBL {
    ...
    char ERROR = 'E';
    BPZUAOBL_WS_VARIABLES WS_VARIABLES = new BPZUAOBL_WS_VARIABLES();
    BPZUAOBL_WS_COND_FLG WS_COND_FLG = new BPZUAOBL_WS_COND_FLG();
    ...
    public void MP(SCCGWA SCCGWA, BPCUAOBL BPCUAOBL) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "BPZUAOBL return!");
        Z_RET();
        if (pgmRtn) return;
    }
