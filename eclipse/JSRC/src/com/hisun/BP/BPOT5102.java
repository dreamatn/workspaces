...
public class BPOT5102 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT5102 return!");
        Z_RET();
    }
    ...
    public void B020_MOD_REC_PROC() throws IOException,SQLException,Exception {
        ...
        BPCMBDA.INP_DATA.CMP_FLG = BPB5100_AWA_5100.CMP_FLG;
        for (WS_I = 1; WS_I <= K_MAX_ARRAY; WS_I += 1) {
            BPCMBDA.INP_DATA.AUTH_SET[WS_I-1].FLT_LMT = BPB5100_AWA_5100.AUTH_SET[WS_I-1].FLT_LMT;
            BPCMBDA.INP_DATA.AUTH_SET[WS_I-1].ATH_LVL = BPB5100_AWA_5100.AUTH_SET[WS_I-1].ATH_LVL;
        }
