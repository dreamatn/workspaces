...
public class BPOT3600 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "BPOT3600 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (BPB3600_AWA_3600.SC_TYPE == K_SC_TYPE) {
            WS_CODE_LENGTH = BPB3600_AWA_3600.CODE_NO.trim().length();
            CEP.TRC(SCCGWA, WS_CODE_LENGTH);
            if (WS_CODE_LENGTH < K_CREDIT_CARD_LENGTH
                || WS_CODE_LENGTH > K_MORE_CARD_LENGTH) {
                WS_ERR_MSG = BPCMSG_ERROR_MSG.BP_CARD_NUM_INVALID;
                S000_ERR_MSG_PROC();
            } else if (WS_CODE_LENGTH > K_CREDIT_CARD_LENGTH) {
                IBS.init(SCCGWA, DCCUCINF);
                DCCUCINF.CARD_NO = BPB3600_AWA_3600.CODE_NO;
                S000_CALL_DCZUCINF();
            } else {
            }
        }
    ...
    public void R000_TRANS_DATA_PARAMETER() throws IOException,SQLException,Exception {
        ...
        BPCSTLSC.BK_NM = BPB3600_AWA_3600.BK_NM;
        BPCSTLSC.CD_CNM = BPB3600_AWA_3600.CD_CNM;
        BPCSTLSC.SC_RES = BPB3600_AWA_3600.SC_RES;
    }
