...
public class BPB2100_AWA_2100 {
    ...
    public BPB2100_CCY_INFO[] CCY_INFO = new BPB2100_CCY_INFO[5];
    public BPB2100_P_INFO[] P_INFO = new BPB2100_P_INFO[60];
    public String CCY_AC = " ";
    public short CCY_AC_NO = 0;
    public BPB2100_CCY_INF1[] CCY_INF1 = new BPB2100_CCY_INF1[5];
    public char FLG = ' ';
    ...
    public BPB2100_AWA_2100() {
        for (int i=0;i<5;i++) CCY_INFO[i] = new BPB2100_CCY_INFO();
        for (int i=0;i<60;i++) P_INFO[i] = new BPB2100_P_INFO();
        for (int i=0;i<5;i++) CCY_INF1[i] = new BPB2100_CCY_INF1();
    }
}
