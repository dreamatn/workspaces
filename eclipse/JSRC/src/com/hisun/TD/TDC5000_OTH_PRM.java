...
public class TDC5000_OTH_PRM {
    ...
    public String REFR_CCY = " ";
    public TDC5000_AVA_CCY_ARRY[] AVA_CCY_ARRY = new TDC5000_AVA_CCY_ARRY[16];
    public TDC5000_CCY_INF[] CCY_INF = new TDC5000_CCY_INF[24];
    ...
    public char FRZ_FLG = ' ';
    public TDC5000_OTH_PRM() {
        for (int i=0;i<16;i++) AVA_CCY_ARRY[i] = new TDC5000_AVA_CCY_ARRY();
        for (int i=0;i<24;i++) CCY_INF[i] = new TDC5000_CCY_INF();
    }
}
