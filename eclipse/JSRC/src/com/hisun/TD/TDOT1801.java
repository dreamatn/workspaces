...
public class TDOT1801 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "TDOT1801 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (TDB1800_AWA_1800.EFF_DATE > TDB1800_AWA_1800.EXP_DATE) {
            WS_CNT = WS_CNT + 1;
            WS_ERR_MSG = TDCMSG_ERROR_MSG.TD_EXPDT_LESS_EFFDT;
            WS_FLD_NO = (short) TDB1800_AWA_1800.EFF_DATE;
            S000_ERR_MSG_PROC_CONTINUE();
        }
        if (TDB1800_AWA_1800.AGT_TNUM <= 0) {
            WS_CNT = WS_CNT + 1;
            WS_ERR_MSG = TDCMSG_ERROR_MSG.TD_AGT_IS_CANCEL;
            WS_FLD_NO = TDB1800_AWA_1800.AGT_TNUM;
            S000_ERR_MSG_PROC_CONTINUE();
        }
        if (WS_CNT > 0) {
    ...
    public void B020_ADD_INT_WIN_PROC() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, TDB1800_AWA_1800.AGT_TYP);
        ...
        if (TDB1800_AWA_1800.EFF_DATE != 0) {
            TDCSMAGT.EFF_DATE = TDB1800_AWA_1800.EFF_DATE;
        } else {
            TDCSMAGT.EFF_DATE = SCCGWA.COMM_AREA.AC_DATE;
        }
        if (TDB1800_AWA_1800.EXP_DATE != 0) {
            TDCSMAGT.EXP_DATE = TDB1800_AWA_1800.EXP_DATE;
        } else {
            TDCSMAGT.EXP_DATE = 99991231;
        }
