...
public class TDCQPRD_OTH_PRM {
    ...
    public TDCQPRD_AVA_CCY_ARRY[] AVA_CCY_ARRY = new TDCQPRD_AVA_CCY_ARRY[16];
    public TDCQPRD_CCY_INF[] CCY_INF = new TDCQPRD_CCY_INF[25];
    ...
    public char FRZ_FLG = ' ';
    public TDCQPRD_OTH_PRM() {
        for (int i=0;i<16;i++) AVA_CCY_ARRY[i] = new TDCQPRD_AVA_CCY_ARRY();
        for (int i=0;i<25;i++) CCY_INF[i] = new TDCQPRD_CCY_INF();
    }
}
