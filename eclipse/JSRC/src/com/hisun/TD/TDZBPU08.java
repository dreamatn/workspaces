...
public class TDZBPU08 {
    DBParm TDTBSP08_RD;
    boolean pgmRtn = false;
    TDCMSG_ERROR_MSG TDCMSG_ERROR_MSG = new TDCMSG_ERROR_MSG();
    SCCEXCP SCCEXCP = new SCCEXCP();
    TDRBSP08 TDRBSP08 = new TDRBSP08();
    SCCGWA SCCGWA;
    SCCRWBSP SCCRWBSP;
    TDRBSP08 TDRBSP18;
    public void MP(SCCGWA SCCGWA, SCCRWBSP SCCRWBSP) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "TDZBPU08 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        TDRBSP18 = (PSRBSP01) SCCRWBSP.INFO.PTR;
        IBS.init(SCCGWA, TDRBSP08);
        IBS.CLONE(SCCGWA, TDRBSP18, TDRBSP08);
        SCCRWBSP.RC.RC_MMO = "TD";
        SCCRWBSP.RC.RC_CODE = 0;
        SCCRWBSP.RETURN_INFO = 'F';
    }
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, TDRBSP08.KEY.AP_TYPE);
        CEP.TRC(SCCGWA, TDRBSP08.KEY.AP_BATNO);
        CEP.TRC(SCCGWA, TDRBSP08.KEY.BAT_NO);
        ...
        IBS.CLONE(SCCGWA, TDRBSP08, TDRBSP18);
    }
    ...
    public void T000_READ_BSP() throws IOException,SQLException,Exception {
        TDTBSP08_RD = new DBParm();
        TDTBSP08_RD.TableName = "TDTBSP08";
        IBS.READ(SCCGWA, TDRBSP08, TDTBSP08_RD);
    ...
    public void T000_WRITE_BSP() throws IOException,SQLException,Exception {
        TDTBSP08_RD = new DBParm();
        TDTBSP08_RD.TableName = "TDTBSP08";
        TDTBSP08_RD.errhdl = true;
        IBS.WRITE(SCCGWA, TDRBSP08, TDTBSP08_RD);
    ...
    public void T000_REWRITE_BSP() throws IOException,SQLException,Exception {
        TDTBSP08_RD = new DBParm();
        TDTBSP08_RD.TableName = "TDTBSP08";
        IBS.REWRITE(SCCGWA, TDRBSP08, TDTBSP08_RD);
    }
    public void T000_DELETE_BSP() throws IOException,SQLException,Exception {
        TDTBSP08_RD = new DBParm();
        TDTBSP08_RD.TableName = "TDTBSP08";
        IBS.DELETE(SCCGWA, TDRBSP08, TDTBSP08_RD);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '1') {
            IBS.CPY2CLS(SCCGWA, TDCMSG_ERROR_MSG.TD_BSP_REC_NOTFND, SCCRWBSP.RC);
            SCCRWBSP.RETURN_INFO = 'N';
            Z_RET();
