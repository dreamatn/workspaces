...
public class TDCPROD_OTH_PRM {
    ...
    public TDCPROD_AVA_CCY_ARRY[] AVA_CCY_ARRY = new TDCPROD_AVA_CCY_ARRY[16];
    public TDCPROD_CCY_INF[] CCY_INF = new TDCPROD_CCY_INF[30];
    ...
    public char FRZ_FLG = ' ';
    public TDCPROD_OTH_PRM() {
        for (int i=0;i<16;i++) AVA_CCY_ARRY[i] = new TDCPROD_AVA_CCY_ARRY();
        for (int i=0;i<30;i++) CCY_INF[i] = new TDCPROD_CCY_INF();
    }
}
