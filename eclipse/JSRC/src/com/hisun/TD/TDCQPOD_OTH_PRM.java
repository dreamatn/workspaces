...
public class TDCQPOD_OTH_PRM {
    ...
    public TDCQPOD_CCY_INF[] CCY_INF = new TDCQPOD_CCY_INF[20];
    public char BAL_FLG = ' ';
    public char MID_FLG = ' ';
    ...
    public char FRZ_FLG = ' ';
    public TDCQPOD_OTH_PRM() {
        for (int i=0;i<20;i++) CCY_INF[i] = new TDCQPOD_CCY_INF();
    }
}
