...
public class TDCF500_OTH_PRM {
    ...
    public TDCF500_CCY_INF[] CCY_INF = new TDCF500_CCY_INF[20];
    public char BAL_FLG = ' ';
    public char MID_FLG = ' ';
    ...
    public char FRZ_FLG = ' ';
    public TDCF500_OTH_PRM() {
        for (int i=0;i<20;i++) CCY_INF[i] = new TDCF500_CCY_INF();
    }
}
