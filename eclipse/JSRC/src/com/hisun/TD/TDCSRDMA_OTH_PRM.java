...
public class TDCSRDMA_OTH_PRM {
    ...
    public char CCY_TYP = ' ';
    public TDCSRDMA_CCY_INF[] CCY_INF = new TDCSRDMA_CCY_INF[20];
    public char MID_FLG = ' ';
    public char DELA_FLG = ' ';
    public TDCSRDMA_OTH_PRM() {
        for (int i=0;i<20;i++) CCY_INF[i] = new TDCSRDMA_CCY_INF();
    }
}
