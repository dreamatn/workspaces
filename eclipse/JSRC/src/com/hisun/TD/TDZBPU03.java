...
public class TDZBPU03 {
    DBParm TDTBSP03_RD;
    boolean pgmRtn = false;
    TDCMSG_ERROR_MSG TDCMSG_ERROR_MSG = new TDCMSG_ERROR_MSG();
    SCCEXCP SCCEXCP = new SCCEXCP();
    TDRBSP03 TDRBSP03 = new TDRBSP03();
    SCCGWA SCCGWA;
    SCCRWBSP SCCRWBSP;
    TDRBSP03 TDRBSP13;
    public void MP(SCCGWA SCCGWA, SCCRWBSP SCCRWBSP) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "TDZBPU03 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        TDRBSP13 = (PSRBSP01) SCCRWBSP.INFO.PTR;
        IBS.init(SCCGWA, TDRBSP03);
        IBS.CLONE(SCCGWA, TDRBSP13, TDRBSP03);
        SCCRWBSP.RC.RC_MMO = "TD";
        SCCRWBSP.RC.RC_CODE = 0;
        SCCRWBSP.RETURN_INFO = 'F';
    }
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, TDRBSP03.KEY.AP_TYPE);
        CEP.TRC(SCCGWA, TDRBSP03.KEY.AP_BATNO);
        CEP.TRC(SCCGWA, TDRBSP03.KEY.BAT_NO);
        ...
        IBS.CLONE(SCCGWA, TDRBSP03, TDRBSP13);
    }
    ...
    public void T000_READ_BSP() throws IOException,SQLException,Exception {
        TDTBSP03_RD = new DBParm();
        TDTBSP03_RD.TableName = "TDTBSP03";
        IBS.READ(SCCGWA, TDRBSP03, TDTBSP03_RD);
    ...
    public void T000_REWRITE_BSP() throws IOException,SQLException,Exception {
        TDTBSP03_RD = new DBParm();
        TDTBSP03_RD.TableName = "TDTBSP03";
        IBS.REWRITE(SCCGWA, TDRBSP03, TDTBSP03_RD);
    }
    public void T000_DELETE_BSP() throws IOException,SQLException,Exception {
        TDTBSP03_RD = new DBParm();
        TDTBSP03_RD.TableName = "TDTBSP03";
        IBS.DELETE(SCCGWA, TDRBSP03, TDTBSP03_RD);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '1') {
            IBS.CPY2CLS(SCCGWA, TDCMSG_ERROR_MSG.TD_BSP_REC_NOTFND, SCCRWBSP.RC);
            SCCRWBSP.RETURN_INFO = 'N';
            Z_RET();
