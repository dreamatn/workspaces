...
public class CIOT5653 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "CIOT5653 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, CIB5650_AWA_5650.STC_SEQ);
        CEP.TRC(SCCGWA, CIB5650_AWA_5650.CI_NO);
        CEP.TRC(SCCGWA, CIB5650_AWA_5650.CI_NM);
        CEP.TRC(SCCGWA, CIB5650_AWA_5650.STC_TYPE);
        CEP.TRC(SCCGWA, CIB5650_AWA_5650.FIN_FLG);
        CEP.TRC(SCCGWA, CIB5650_AWA_5650.SEND_TYP);
        CEP.TRC(SCCGWA, CIB5650_AWA_5650.ADR_NM);
        CEP.TRC(SCCGWA, CIB5650_AWA_5650.CNT_INF);
        CEP.TRC(SCCGWA, CIB5650_AWA_5650.STC_AC);
        CICSSTC.FUNC = 'M';
        S000_LINK_CIZSSTC();
    ...
    public void B010_CHECK_INPUT_DATA() throws IOException,SQLException,Exception {
        ...
        if (CIB5650_AWA_5650.STC_TYPE == 'C' 
            && CIB5650_AWA_5650.STC_AC.trim().length() > 0) {
            WS_ERR_MSG = CICMSG_ERROR_MSG.CI_C_SCA_NOT_ACCEPT;
            WS_FLD_NO = CIB5650_AWA_5650.STC_AC_NO;
            S000_ERR_MSG_PROC_CONTINUE();
        }
        CEP.TRC(SCCGWA, CIB5650_AWA_5650.SEND_TYP);
        CEP.TRC(SCCGWA, CIB5650_AWA_5650.ADR_TYPE);
        CEP.TRC(SCCGWA, CIB5650_AWA_5650.CNT_TYPE);
