...
public class CICOSQCC_DATA {
    ...
    public CICOSQCC_CRS_AREA[] CRS_AREA = new CICOSQCC_CRS_AREA[25];
    public CICOSQCC_DATA() {
        for (int i=0;i<25;i++) CRS_AREA[i] = new CICOSQCC_CRS_AREA();
    }
}
