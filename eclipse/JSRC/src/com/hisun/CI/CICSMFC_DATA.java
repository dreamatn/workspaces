...
public class CICSMFC_DATA {
    ...
    public int SCH_DT = 0;
    public CICSMFC_CRS_AREA[] CRS_AREA = new CICSMFC_CRS_AREA[25];
    public String CTL_TYPE = " ";
    public String CTL_CRTP = " ";
    public String CTL_DESC = " ";
    public int CTL_PRDT = 0;
    public char CTL_PRCH = ' ';
    public CICSMFC_CTL_AREA[] CTL_AREA = new CICSMFC_CTL_AREA[25];
    public CICSMFC_DATA() {
        for (int i=0;i<25;i++) CRS_AREA[i] = new CICSMFC_CRS_AREA();
        for (int i=0;i<25;i++) CTL_AREA[i] = new CICSMFC_CTL_AREA();
    }
}
