...
public class CIOT5450 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "CIOT5450 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        B020_BROWSE_COMB_CI_CIRBAS();
    }
    public void B010_CHECK_INPUT_DATA() throws IOException,SQLException,Exception {
        if (CIB5450_AWA_5450.CI_NO.trim().length() == 0) {
            CEP.ERR(SCCGWA, CICMSG_ERROR_MSG.CI_MUST_INPUT);
        }
    }
    public void B020_BROWSE_COMB_CI_CIRBAS() throws IOException,SQLException,Exception {
        IBS.init(SCCGWA, CICMHIS);
        CICMHIS.DATA.CI_NO = CIB5450_AWA_5450.CI_NO;
        CICMHIS.FUNC = 'A';
        S000_CALL_CIZMHIS();
    }
