...
public class CIOT5421 {
    String K_STS_TABLE_APP = "CI";
    String WS_ERR_MSG = " ";
    short WS_FLD_NO = 0;
    CIOT5421_WS_T_CTL WS_T_CTL = new CIOT5421_WS_T_CTL();
    int WS_T_ID = 0;
    char WS_END_FLAG = ' ';
    char WS_ADR_FLAG = ' ';
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "CIOT5421 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, CICMADR.LANG_CD);
        CEP.TRC(SCCGWA, CICMADR.STD_FLG);
        CEP.TRC(SCCGWA, CICMADR.STD_CD);
        CICMADR.FUNC = 'A';
        S000_LINK_CIZMADR();
