...
public class CIOT5453 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "CIOT5453 return!");
        Z_RET();
    }
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        CICUHIS.CTR_TYP = CIB5450_AWA_5450.CTR_TYP;
        CICUHIS.SEQ = CIB5450_AWA_5450.SEQ;
        B020_LINK_CIZUHIS_PROC();
    }
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
    }
    public void B020_LINK_CIZUHIS_PROC() throws IOException,SQLException,Exception {
