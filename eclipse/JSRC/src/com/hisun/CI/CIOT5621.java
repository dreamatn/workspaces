...
public class CIOT5621 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "CIOT5621 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT_DATA() throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, CIB5620_AWA_5620.ALT_TYP);
        CEP.TRC(SCCGWA, CIB5620_AWA_5620.MSG_CHNL);
        CEP.TRC(SCCGWA, CIB5620_AWA_5620.ALT_LVL);
        ...
        if (CIB5620_AWA_5620.ALT_TYP.equalsIgnoreCase("0020")) {
            CEP.ERRC(SCCGWA, CICMSG_ERROR_MSG.CI_NOT_ADD_TAX_SURVER);
        }
