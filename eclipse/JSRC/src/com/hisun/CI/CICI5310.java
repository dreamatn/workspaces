...
public class CICI5310 {
    ...
    public CICI5310_ID_AREA[] ID_AREA = new CICI5310_ID_AREA[4];
    public CICI5310_ADR_AREA[] ADR_AREA = new CICI5310_ADR_AREA[4];
    public CICI5310_CNT_AREA[] CNT_AREA = new CICI5310_CNT_AREA[4];
    public CICI5310_REL_AREA[] REL_AREA = new CICI5310_REL_AREA[4];
    ...
    public CICI5310_CRS_AREA[] CRS_AREA = new CICI5310_CRS_AREA[25];
    public CICI5310() {
        for (int i=0;i<4;i++) ID_AREA[i] = new CICI5310_ID_AREA();
        for (int i=0;i<4;i++) ADR_AREA[i] = new CICI5310_ADR_AREA();
        for (int i=0;i<4;i++) CNT_AREA[i] = new CICI5310_CNT_AREA();
        for (int i=0;i<4;i++) REL_AREA[i] = new CICI5310_REL_AREA();
        for (int i=0;i<25;i++) CRS_AREA[i] = new CICI5310_CRS_AREA();
    }
}
