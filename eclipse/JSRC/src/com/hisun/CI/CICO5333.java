...
public class CICO5333 {
    ...
    public CICO5333_ID_GS[] ID_GS = new CICO5333_ID_GS[9];
    public char RS_TYP = ' ';
    public char BLK_TYP = ' ';
    ...
    public char SIZE = ' ';
    public char INSIZE = ' ';
    public CICO5333_ADR_GS[] ADR_GS = new CICO5333_ADR_GS[6];
    public CICO5333_CNT_GS[] CNT_GS = new CICO5333_CNT_GS[6];
    public CICO5333_REL_GS[] REL_GS = new CICO5333_REL_GS[3];
    public CICO5333() {
        for (int i=0;i<9;i++) ID_GS[i] = new CICO5333_ID_GS();
        for (int i=0;i<6;i++) ADR_GS[i] = new CICO5333_ADR_GS();
        for (int i=0;i<6;i++) CNT_GS[i] = new CICO5333_CNT_GS();
        for (int i=0;i<3;i++) REL_GS[i] = new CICO5333_REL_GS();
    }
}
