...
public class EQOT8300 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "EQOT8300 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    ...
    public void B020_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        EQCMPPLG.DATA.ID_TYP = EQB0003_AWA_0003.ID_TYP;
        EQCMPPLG.DATA.ID_NO = EQB0003_AWA_0003.ID_NO;
        ...
        EQCMPPLG.DATA.PLG_STS = EQB0003_AWA_0003.PLG_STS;
        EQCMPPLG.FUNC = 'I';
