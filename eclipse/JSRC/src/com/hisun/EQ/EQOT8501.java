...
public class EQOT8501 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "EQOT8501 return!");
        Z_RET();
        if (pgmRtn) return;
    }
    ...
    public void B020_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        EQCSINFO.DATA.DIV_AC = EQB1100_AWA_1100.DIV_AC;
        EQCSINFO.DATA.EQ_ADDR = EQB1100_AWA_1100.EQ_ADDR;
        EQCSINFO.DATA.TEL_NO = EQB1100_AWA_1100.TEL_NO;
