...
public class FXOT1316 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "FXOT1316 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        ...
        if (FXB1310_AWA_1310.STATUS != 'R') {
            CEP.ERR(SCCGWA, FXCMSG_ERROR_MSG.FX_TIK_STS_INVALID);
        }
    }
    public void B020_DELETE_APRV_RECORD() throws IOException,SQLException,Exception {
        IBS.init(SCCGWA, FXCSBFXT);
        FXCSBFXT.KEY.TIK_NO = FXB1310_AWA_1310.TIK_NO;
        CEP.TRC(SCCGWA, FXB1310_AWA_1310.RMK);
