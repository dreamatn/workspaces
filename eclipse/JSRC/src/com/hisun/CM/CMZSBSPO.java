...
public class CMZSBSPO {
    ...
    String WS_BV_NO_I = " ";
    int WS_I = 0;
    CMZSBSPO_WS_BATH_PARM WS_BATH_PARM = new CMZSBSPO_WS_BATH_PARM();
    char WS_END_FLG = ' ';
    CMZSBSPO_WS_OUTPUT WS_OUTPUT = new CMZSBSPO_WS_OUTPUT();
    String WS_TS = " ";
    int WS_CNT_ORD = 0;
    int WS_CNT_BIN = 0;
    int WS_CNT_BIN2 = 0;
    ...
    public void MP(SCCGWA SCCGWA, CMCSBSPI CMCSBSPI) throws IOException,SQLException,Exception {
        ...
        CEP.TRC(SCCGWA, "CMZSBSPO return!");
        Z_RET();
        if (pgmRtn) return;
        JIBS_RETURN();
    }
