...
public class CMZBSP12 {
    boolean pgmRtn = false;
    String WS_TEMP_RECORD = " ";
    char WS_TBL_FARM_FLAG = ' ';
    CMCMSG_ERROR_MSG CMCMSG_ERROR_MSG = new CMCMSG_ERROR_MSG();
    SCCEXCP SCCEXCP = new SCCEXCP();
    CMRBSP12 CMRBSP12 = new CMRBSP12();
    SCCGWA SCCGWA;
    SCCRBBSP SCCRBBSP;
    ...
    public void MP(SCCGWA SCCGWA, SCCRBBSP SCCRBBSP) throws IOException,SQLException,Exception {
        ...
        B000_MAIN_PROC();
        if (pgmRtn) return;
        CEP.TRC(SCCGWA, "CMZBSP12 return!");
        Z_RET();
        if (pgmRtn) return;
        JIBS_RETURN();
    }
    public void A000_INIT_PROC() throws IOException,SQLException,Exception {
        CMRLSP12 = (PSRBSP01) SCCRBBSP.INFO.PTR;
        GWA_BP_AREA = (SCCGBPA_BP_AREA) SCCGWA.BP_AREA_PTR;
        GWA_SC_AREA = (SCCGSCA_SC_AREA) SCCGWA.SC_AREA_PTR;
        IBS.init(SCCGWA, CMRBSP12);
        IBS.CLONE(SCCGWA, CMRLSP12, CMRBSP12);
    ...
    public void B000_MAIN_PROC() throws IOException,SQLException,Exception {
        ...
        IBS.CLONE(SCCGWA, CMRBSP12, CMRLSP12);
    }
    public void T000_STARTBR_BSP() throws IOException,SQLException,Exception {
        CMTBSP12_BR.rp = new DBParm();
        CMTBSP12_BR.rp.TableName = "CMTBSP12";
        CMTBSP12_BR.rp.upd = true;
        IBS.STARTBR(SCCGWA, CMRBSP12, CMTBSP12_BR);
    ...
    public void T000_READNEXT_BSP() throws IOException,SQLException,Exception {
        IBS.READNEXT(SCCGWA, CMRBSP12, this, CMTBSP12_BR);
        if (SCCGWA.COMM_AREA.DBIO_FLG == '0') {
            SCCRBBSP.RETURN_INFO = 'F';
        ...
        CEP.TRC(SCCGWA, CMRBSP12.STATUS);
