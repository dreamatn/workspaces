...
public class CMB3030_AWA_3030 {
    ...
    public CMB3030_FEE_DATA[] FEE_DATA = new CMB3030_FEE_DATA[3];
    ...
    public CMB3030_AWA_3030() {
        for (int i=0;i<3;i++) FEE_DATA[i] = new CMB3030_FEE_DATA();
    }
}
