...
public class IBOT5060 {
    ...
    public void MP(SCCGWA SCCGWA) throws IOException,SQLException,Exception {
        ...
        A000_INIT_PROC();
        B000_MAIN_PROC();
        CEP.TRC(SCCGWA, "IBOT5060 return!");
        Z_RET();
    }
    ...
    public void B010_CHECK_INPUT() throws IOException,SQLException,Exception {
        CEP.TRC(SCCGWA, IBB5060_AWA_5060.FUNC);
        if (IBB5060_AWA_5060.FUNC == ' ') {
            WS_CNT = (short) (WS_CNT + 1);
            CEP.ERRC(SCCGWA, IBCMSG_ERROR_MSG.FCN_MUST_INPUT, IBB5060_AWA_5060.FUNC_NO);
        }
        CEP.TRC(SCCGWA, IBB5060_AWA_5060.AC_DATE);
        if (IBB5060_AWA_5060.AC_DATE == 0) {
            WS_CNT = (short) (WS_CNT + 1);
            CEP.ERRC(SCCGWA, IBCMSG_ERROR_MSG.AC_DATE_M, IBB5060_AWA_5060.AC_DATE_NO);
        }
        CEP.TRC(SCCGWA, IBB5060_AWA_5060.JRNNO);
        if (IBB5060_AWA_5060.JRNNO == 0) {
            WS_CNT = (short) (WS_CNT + 1);
            CEP.ERRC(SCCGWA, IBCMSG_ERROR_MSG.JRNNO_M, IBB5060_AWA_5060.JRNNO_NO);
        }
        CEP.TRC(SCCGWA, IBB5060_AWA_5060.IPT_TLR);
        if (IBB5060_AWA_5060.IPT_TLR.trim().length() == 0) {
            WS_CNT = (short) (WS_CNT + 1);
            CEP.ERRC(SCCGWA, IBCMSG_ERROR_MSG.IPT_TLR_M, IBB5060_AWA_5060.IPT_TLR_NO);
        }
    ...
    public void B020_TRANS_DATA_PROC() throws IOException,SQLException,Exception {
        ...
        IBCMANAC.FUNC = IBB5060_AWA_5060.FUNC;
        IBCMANAC.AC_DATE = IBB5060_AWA_5060.AC_DATE;
        IBCMANAC.JRN_NO = IBB5060_AWA_5060.JRNNO;
        IBCMANAC.IPT_TLR = IBB5060_AWA_5060.IPT_TLR;
        IBCMANAC.AUTH_TLR = IBB5060_AWA_5060.AUTH_TLR;
    ...
    public void S000_CALL_IBZMANAC() throws IOException,SQLException,Exception {
        IBS.CALLCPN(SCCGWA, "IB-MANUAL-DRCR", IBCMANAC);
    }
